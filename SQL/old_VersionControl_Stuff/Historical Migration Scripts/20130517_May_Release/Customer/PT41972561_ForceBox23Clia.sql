  ...
  <xsl:template match="/formData/page">
    ...
    <formData formId="CMS1500">
      <page pageId="CMS1500.1">
        ...
        <xsl:if test="(data[@id=''CMS1500.1.PlaceOfService1''] != 12) or (data[@id=''CMS1500.1.ForceBox32Flag1''] = 1) or
				((data[@id=''CMS1500.1.PayerState1''] = ''NV'') and (data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MC''))">
          <data id="CMS1500.1.3_2Name">
            <xsl:choose>
              <xsl:when test="((data[@id=''CMS1500.1.PlaceOfService1''] = 41) or (data[@id=''CMS1500.1.PlaceOfService1''] = 42)) and
                        (data[@id=''CMS1500.1.ForceDropOffLocationInBox321''] != ''1'') ">
        ...
        <data id="CMS1500.1.eDiag1">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer11'']) &gt; 0 and 
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer21'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer31'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer41'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
        ...
        <data id="CMS1500.1.SupplementalInfo1">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode1''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and 
					  data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or 
					  data[@id=''CMS1500.1.TypeOfServiceCode1''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or 
					  data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 8678) ">
        ...
        <data id="CMS1500.1.eDiag2">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode2''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer12'']) &gt; 0 and 
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer22'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer32'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer42'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
        ...
        <data id="CMS1500.1.eDiag3">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode3''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer13'']) &gt; 0 and
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer23'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer33'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer43'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
        ...
        <data id="CMS1500.1.eDiag4">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode4''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer14'']) &gt; 0 and
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer24'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer34'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer44'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
        ...
        <data id="CMS1500.1.eDiag5">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode5''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer15'']) &gt; 0 and
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer25'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer35'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer45'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
        ...
        <data id="CMS1500.1.eDiag6">
          ...
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode6''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer16'']) &gt; 0 and
                    (string-length(data[@id=''CMS1500.1.DiagnosisPointer26'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer36'']) &gt; 0
                    or string-length(data[@id=''CMS1500.1.DiagnosisPointer46'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
