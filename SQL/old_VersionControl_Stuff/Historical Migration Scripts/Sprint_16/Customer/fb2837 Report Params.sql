...
'<parameters csv="false">
  ...
  <extendedParameters>
    ...
    <extendedParameter type="ComboBox" parameterName="SummaryType" text="Summary Type:" description="Choose subtotal calculation type." default="A">
      <value displayText="Average" value="A" />
      <value displayText="Total" value="T" />
    </extendedParameter>
  </extendedParameters>
</parameters>'
...
WHERE NAME = 'Contract Management Detail'