/*
-- P34093297
USE superbill_4701_dev;
GO
USE superbill_4701_prod;
GO
      ...
      <page pageId="CMS1500.1">
        ...
        <xsl:if test="(data[@id=''CMS1500.1.PlaceOfService1''] != 12) or (data[@id=''CMS1500.1.ForceBox32Flag1''] = 1) or     ((data[@id=''CMS1500.1.PayerState1''] = ''NV'') and (data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MC''))">
          <data id="CMS1500.1.3_2Name">
            <xsl:choose>
              <xsl:when test="data[@id=''CMS1500.1.PlaceOfService1''] = 41 or data[@id=''CMS1500.1.PlaceOfService1''] = 42">
...
/*
SELECT  * ,
        CAST(Transform AS XML)
FROM    dbo.BillingForm AS BF WITH ( NOLOCK )
WHERE   FormType = 'HCFA'
        AND PrintingFormID = 19
        AND BF.BillingFormID = 13;
*/