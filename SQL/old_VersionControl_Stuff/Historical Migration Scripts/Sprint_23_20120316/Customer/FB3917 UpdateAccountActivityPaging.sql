update report set ReportParameters = '<parameters paging="false" pageColumnCount="0" extraHeaderLength="0" pageCharacterCount="650000" headerExtractCharacterCount="100000" csv="false">
  <basicParameters>
  ...
  <extendedParameters>
    ...
    <extendedParameter type="ComboBox" parameterName="Groupby" text="Group By:" description="Select the grouping." default="1">
      ...
      <value displayText="Insurance Company" value="7" />
    </extendedParameter>
    <extendedParameter type="ComboBox" parameterName="SortBy" text="Order By:" description="Select the ordering." default="P">
      ...
      <value displayText="Date of Service" value="DOS" />
    </extendedParameter>
  </extendedParameters>
</parameters>'
where ReportID = 29