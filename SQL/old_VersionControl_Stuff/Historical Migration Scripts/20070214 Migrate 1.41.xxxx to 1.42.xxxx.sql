...
GO
------------------------------------------------------------------
-- case 19791 Enforce Closing Date
------------------------------------------------------------------
...
GO
alter table ENCOUNTER add overrideClosingDate BIT NOT NULL
		CONSTRAINT [DF_Encounter_overrideClosingDate] DEFAULT ((0))
GO
	...
	<xsl:template match="/formData/page">
        ...
        <xsl:if test="data[@id=''CMS1500.1.PlaceOfService1''] != 12">
          ...
          <data id="CMS1500.1.3_2FacilityInfo" />
				...
				<data id="CMS1500.1.aStartYY1">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate1''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM1">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY1">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate1'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate1''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate1''], 7, 4)" />
						</xsl:otherwise>
				...
				<data id="CMS1500.1.aStartYY2">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate2''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM2">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY2">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate2'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate2''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate2''], 7, 4)" />
						</xsl:otherwise>
				...
				<data id="CMS1500.1.aStartYY3">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate3''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM3">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY3">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate3'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate3''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate3''], 7, 4)" />
						</xsl:otherwise>
				...
				<data id="CMS1500.1.aStartYY4">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate4''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM4">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY4">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate4'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate4''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate4''], 7, 4)" />
						</xsl:otherwise>
				...
				<data id="CMS1500.1.aStartYY5">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate5''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM5">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY5">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate5'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate5''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate5''], 7, 4)" />
						</xsl:otherwise>
				...
				<data id="CMS1500.1.aStartYY6">
					<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate6''], 7, 4)" />
				</data>
				<data id="CMS1500.1.aEndMM6">
					<xsl:text xml:space="preserve"> </xsl:text>
					<xsl:choose>
				...
				<data id="CMS1500.1.aEndYY6">
					<xsl:choose>
						<xsl:when test="string-length(data[@id=''CMS1500.1.ServiceEndDate6'']) &gt; 0">
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceEndDate6''], 7, 4)" />
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring(data[@id=''CMS1500.1.ServiceBeginDate6''], 7, 4)" />
						</xsl:otherwise>
...
--ClaimAccounting_ClaimPeriod index changes to remove deadlocking issue

DROP INDEX ClaimAccounting_ClaimPeriod.CI_ClaimAccounting_ClaimPeriod
GO

CREATE CLUSTERED INDEX CI_ClaimAccounting_ClaimPeriod 
ON ClaimAccounting_ClaimPeriod (ClaimID, DKInitialPostingDateID)
