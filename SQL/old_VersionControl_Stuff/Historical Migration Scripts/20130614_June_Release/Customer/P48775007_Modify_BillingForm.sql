...
/*
USE superbill_14271_dev;
GO
*/

BEGIN TRANSACTION;

UPDATE  dbo.BillingForm
  ...
  <xsl:template match="/formData/page">
    <formData formId="CMS1500">
      <page pageId="CMS1500.1">
        ...
        <data id="CMS1500.1.1_GroupHealthPlan" />
        <data id="CMS1500.1.1_Feca" />
        ...
        <data id="CMS1500.1.2_2Code" />
        <data id="CMS1500.1.2_2Number" />
        ...
        <xsl:if test="data[@id=''CMS1500.1.PlaceOfService1''] != 12">
          ...
          <data id="CMS1500.1.3_2CityStateZip">
            ...
            <xsl:if test="string-length(data[@id=''CMS1500.1.FacilityState1'']) &gt; 0">
              <xsl:text>, </xsl:text>
        ...
        <data id="CMS1500.1.hEPSDT1" />
        <data id="CMS1500.1.iEMG1" />
        <data id="CMS1500.1.jCOB1" />
        ...
        <data id="CMS1500.1.hEPSDT2" />
        <data id="CMS1500.1.iEMG2" />
        <data id="CMS1500.1.jCOB2" />
        ...
        <data id="CMS1500.1.hEPSDT3" />
        <data id="CMS1500.1.iEMG3" />
        <data id="CMS1500.1.jCOB3" />
        ...
        <data id="CMS1500.1.hEPSDT4" />
        <data id="CMS1500.1.iEMG4" />
        <data id="CMS1500.1.jCOB4" />
        ...
        <data id="CMS1500.1.hEPSDT5" />
        <data id="CMS1500.1.iEMG5" />
        <data id="CMS1500.1.jCOB5" />
        ...
        <data id="CMS1500.1.hEPSDT6" />
        <data id="CMS1500.1.iEMG6" />
        <data id="CMS1500.1.jCOB6" />
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/formData/page">
    <formData formId="CMS1500">
      <page pageId="CMS1500.1">
        <data id="CMS1500.1.HACK_MC_MD">
          <xsl:value-of select="data[@id=''CMS1500.1.HACK_MC_MD1'']" />
        </data>
        <data id="CMS1500.1.HACK_MEDICARE_SECONDARY">
          <xsl:value-of select="data[@id=''CMS1500.1.HACK_MEDICARE_SECONDARY1'']" />
        </data>
        <BillID>
          <xsl:value-of select="data[@id=''CMS1500.1.BillID1'']" />
        </BillID>
        <data id="CMS1500.1.1_Medicare">
          <xsl:if test="data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MB'' or data[@id=''CMS1500.1.MediCalSecondary1''] = 1">
            <xsl:text>X</xsl:text>
          </xsl:if>
        </data>
        ...
        <xsl:choose>
          <xsl:when test="(data[@id=''CMS1500.1.EightDigitDates1''] = 1)">
            <data id="CMS1500.1.3_MM">
              <xsl:value-of select="substring(data[@id=''CMS1500.1.PatientBirthDate1''], 1, 2)" />
            </data>
            <data id="CMS1500.1.3_DD">
        ...
        <xsl:if test="data[@id=''CMS1500.1.SuppressBox91''] = 0">
          <data id="CMS1500.1.9_OtherName">
            <xsl:if test="data[@id=''CMS1500.1.OtherPayerFlag1''] = ''1'' and not(data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] = ''M'' and data[@id=''CMS1500.1.CustomerID1''] = ''3436'' and data[@id=''CMS1500.1.InsuranceCompanyID1''] = ''3'')">
              <xsl:choose>
                <xsl:when test="data[@id=''CMS1500.1.OtherSubscriberDifferentFlag1''] = ''1''">
                  <xsl:value-of select="data[@id=''CMS1500.1.OtherSubscriberLastName1'']" />
                  <xsl:if test="string-length(data[@id=''CMS1500.1.OtherSubscriberSuffix1'']) &gt; 0">
          ...
          <data id="CMS1500.1.9_aGrpNumber">
            <xsl:choose>
              <xsl:when test="data[@id=''CMS1500.1.MediCalSecondary1''] = 1">
                <xsl:value-of select="data[@id=''CMS1500.1.PolicyNumber1'']" />
              </xsl:when>
              <xsl:when test="not(data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] = ''M'' and data[@id=''CMS1500.1.CustomerID1''] = ''3436'' and data[@id=''CMS1500.1.InsuranceCompanyID1''] = ''3'')">
          ...
          <data id="CMS1500.1.9_dPlanName">
            <xsl:if test="not(data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] = ''M'' and data[@id=''CMS1500.1.CustomerID1''] = ''3436'' and data[@id=''CMS1500.1.InsuranceCompanyID1''] = ''3'')">
              <xsl:value-of select="data[@id=''CMS1500.1.OtherPayerName1'']" />
            </xsl:if>
          </data>
        </xsl:if>
        ...
        <data id="CMS1500.1.1_1GroupNumber">
          <xsl:choose>
            ...
            <xsl:when test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] = ''M'' and data[@id=''CMS1500.1.PayerPrecedence1''] != 1">
              <xsl:value-of select="data[@id=''CMS1500.1.OtherGroupNumber1'']" />
            </xsl:when>
            <xsl:when test="data[@id=''CMS1500.1.ForcePrimaryInfoToBox111''] =''1''">
              <xsl:value-of select="data[@id=''CMS1500.1.OtherGroupNumber1'']" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="data[@id=''CMS1500.1.GroupNumber1'']" />
        ...
        <xsl:if test="data[@id=''CMS1500.1.Suppress11aDate1''] = 0">
          <data id="CMS1500.1.1_1aMM">
            <xsl:if test="not(data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] = ''M'' and data[@id=''CMS1500.1.PayerPrecedence1''] = 1)">
              <xsl:choose>
                <xsl:when test="data[@id = ''CMS1500.1.ForcePrimaryInfoToBox111''] = ''1'' and data[@id=''CMS1500.1.OtherSubscriberDifferentFlag1''] = ''1''">
                  <xsl:value-of select="substring(data[@id=''CMS1500.1.OtherSubscriberBirthDate1''], 1, 2)" />
                </xsl:when>
                <xsl:when test="data[@id=''CMS1500.1.SubscriberDifferentFlag1''] = ''1''">
                  <xsl:value-of select="substring(data[@id=''CMS1500.1.SubscriberBirthDate1''], 1, 2)" />
        ...
        <data id="CMS1500.1.1_1bEmployer">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
              <xsl:value-of select="data[@id=''CMS1500.1.SubscriberEmployerName1'']" />
            </xsl:when>
            <xsl:when test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
              <xsl:value-of select="data[@id=''CMS1500.1.SubscriberEmployerName1'']" />
        ...
        <xsl:if test="data[@id=''CMS1500.1.Suppress11cPlanName1''] = 0">
          <data id="CMS1500.1.1_1cPlanName">
            <xsl:choose>
              <!-- we don''t populate 11C for Medicare if it is primary (SF99612) -->
              <xsl:when test="data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MB'' and data[@id=''CMS1500.1.PayerPrecedence1''] = 1">
                <xsl:text />
              </xsl:when>
              <xsl:when test="data[@id = ''CMS1500.1.ForcePrimaryInfoToBox111''] = ''1''">
                <xsl:value-of select="data[@id=''CMS1500.1.OtherPayerName1'']" />
        ...
        <xsl:if test="data[@id=''CMS1500.1.Suppress11dHealthBenefit1''] = 0">
          <data id="CMS1500.1.1_1dYes">
            <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
              <xsl:if test="data[@id=''CMS1500.1.OtherPayerFlag1''] = ''1''">X</xsl:if>
            </xsl:if>
        ...
        <xsl:choose>
          <xsl:when test="data[@id=''CMS1500.1.PatientsSignatureOnFileFlagBox121''] = 1">
            <data id="CMS1500.1.1_2Signature">Signature on File</data>
          </xsl:when>
        </xsl:choose>
        <data id="CMS1500.1.1_2Date">
          <xsl:choose>
            <xsl:when test="(data[@id=''CMS1500.1.EightDigitDates1''] = 1)">
              ...
              <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 4, 2)" />
              <xsl:text>/</xsl:text>
              <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 7, 4)" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 1, 2)" />
              <xsl:text>/</xsl:text>
        ...
        <data id="CMS1500.1.1_8StartYY">
          <xsl:choose>
            <xsl:when test="(data[@id=''CMS1500.1.EightDigitDates1''] = 1)">
              <xsl:value-of select="substring(data[@id=''CMS1500.1.HospitalizationBeginDate1''], 7, 4)" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="substring(data[@id=''CMS1500.1.HospitalizationBeginDate1''], 9, 2)" />
            </xsl:otherwise>
        ...
        <data id="CMS1500.1.1_8EndYY">
          <xsl:choose>
            <xsl:when test="(data[@id=''CMS1500.1.EightDigitDates1''] = 1)">
              <xsl:value-of select="substring(data[@id=''CMS1500.1.HospitalizationEndDate1''], 7, 4)" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="substring(data[@id=''CMS1500.1.HospitalizationEndDate1''], 9, 2)" />
            </xsl:otherwise>
        ...
        <data id="CMS1500.1.2_0Yes">
          <xsl:if test="data[@id=''CMS1500.1.OutsideLab1''] = 1">X</xsl:if>
        </data>
        <data id="CMS1500.1.2_0No">
          <xsl:if test="data[@id=''CMS1500.1.OutsideLab1''] = 0">X</xsl:if>
        </data>
        <data id="CMS1500.1.2_0Dollars">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.OutsideLab1''] = 1">
              <xsl:variable name="outside-lab-amt" select="substring-before(format-number(data[@id=''CMS1500.1.OutsideLabAmt1''], ''#0.00'', ''default-format''), ''.'')" />
              <xsl:value-of select="substring(''        '', 1, 8 - string-length($outside-lab-amt))" />
              <xsl:value-of select="$outside-lab-amt" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:text />
            </xsl:otherwise>
        ...
        <data id="CMS1500.1.2_0Cents">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.OutsideLab1''] = 1">
              <xsl:variable name="outside-lab-amt-cents" select="substring-after(format-number(data[@id=''CMS1500.1.OutsideLabAmt1''], ''#0.00'', ''default-format''), ''.'')" />
              <xsl:text>.</xsl:text>
              <xsl:value-of select="$outside-lab-amt-cents" />
            </xsl:when>
            <xsl:otherwise>
              <xsl:text />
            </xsl:otherwise>
        ...
        <data id="CMS1500.1.2_2Code">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.SubmitReason1''] = ''6'' or data[@id=''CMS1500.1.SubmitReason1''] = ''7'' or data[@id=''CMS1500.1.SubmitReason1''] = ''8''">
              <xsl:value-of select="data[@id=''CMS1500.1.SubmitReason1'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.2_2Number">
          <xsl:value-of select="data[@id=''CMS1500.1.DocumentCtrlNumber1'']" />
        </data>
        <data id="CMS1500.1.2_3PriorAuth">
          <xsl:choose>
        ...
        <!-- if HACK_MEDICARE_SECONDARY is in force - we don''t populate Boxes 29 (Paid) and 30 (Balance) -->
        <xsl:if test="data[@id=''CMS1500.1.HACK_MEDICARE_SECONDARY1''] != 1">
          <data id="CMS1500.1.2_9Dollars">
            <xsl:choose>
              <xsl:when test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
                <xsl:variable name="paid-dollars" select="substring-before(format-number(data[@id=''CMS1500.1.TotalPaidAmount1''], ''#0.00'', ''default-format''), ''.'')" />
              ...
              <xsl:otherwise>
                <xsl:variable name="paid-dollars" select="substring-before(format-number(data[@id=''CMS1500.1.TotalPatientPaidAmount1''], ''#0.00'', ''default-format''), ''.'')" />
                <xsl:value-of select="substring(''      '', 1, 6 - string-length($paid-dollars))" />
                <xsl:value-of select="$paid-dollars" />
              </xsl:otherwise>
            </xsl:choose>
          ...
          <data id="CMS1500.1.2_9Cents">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:variable name="paid-cents" select="substring-after(format-number(data[@id=''CMS1500.1.TotalPatientPaidAmount1''], ''#0.00'', ''default-format''), ''.'')" />
                <xsl:text>.</xsl:text>
                <xsl:value-of select="$paid-cents" />
              </xsl:otherwise>
            </xsl:choose>
        ...
        <xsl:choose>
          <xsl:when test="data[@id=''CMS1500.1.RenderingProviderSignatureOnFileFlag1''] = 0">
            <data id="CMS1500.1.3_1Signature" />
            <data id="CMS1500.1.3_1License" />
            <data id="CMS1500.1.3_1ProviderName" />
            <data id="CMS1500.1.3_1Date" />
          </xsl:when>
          <xsl:otherwise>
            <!-- FB4956. Used by PrintingFormDetails, PrintingFormID = 22 AND PrintingFormDetailsID = 80 -->
            <data id="CMS1500.1.3_1Signature">
              <xsl:choose>
                <xsl:when test="string-length(data[@id=''CMS1500.1.3_1License'']) = 0">
                  <xsl:text xml:space="preserve">Signature on File</xsl:text>
                </xsl:when>
              </xsl:choose>
            </data>
            <data id="CMS1500.1.3_1License">
              <xsl:choose>
                <xsl:when test="string-length(data[@id=''CMS1500.1.RenderingProviderBox31Value1'']) &gt; 0">
                  <xsl:text xml:space="preserve">LICENSE NO </xsl:text>
                  <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderBox31Value1'']" />
                </xsl:when>
                <xsl:when test="(data[@id=''CMS1500.1.HideSignatureOnFileBox311''] = 1)" />
                <xsl:when test="string-length(data[@id=''CMS1500.1.3_1Signature'']) = 0">
                  <xsl:text xml:space="preserve">Signature on File</xsl:text>
                </xsl:when>
              </xsl:choose>
            </data>
            <data id="CMS1500.1.3_1ProviderName">
              <xsl:choose>
                <xsl:when test="(data[@id=''CMS1500.1.HideProviderNameBox311''] = 1)" />
                <xsl:when test="data[@id=''CMS1500.1.HasSupervisingProvider1''] != 1">
                  <!-- When there isn''t a supervising provider display the rendering provider -->
                  <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderFirstName1'']" />
                  <xsl:text xml:space="preserve"> </xsl:text>
            ...
            <data id="CMS1500.1.3_1Date">
              <xsl:choose>
                <xsl:when test="(data[@id=''CMS1500.1.RemoveDateSlashes1''] = 1)">
                  <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 1, 2)" />
                  <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 4, 2)" />
                  <xsl:value-of select="substring(data[@id=''CMS1500.1.CurrentDate1''], 9, 2)" />
                </xsl:when>
        ...
        <xsl:if test="(data[@id=''CMS1500.1.PlaceOfService1''] != 12) or (data[@id=''CMS1500.1.ForceBox32Flag1''] = 1) or     ((data[@id=''CMS1500.1.PayerState1''] = ''NV'') and (data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MC''))">
          <data id="CMS1500.1.3_2Name">
            <xsl:choose>
              <xsl:when test="((data[@id=''CMS1500.1.PlaceOfService1''] = 41) or (data[@id=''CMS1500.1.PlaceOfService1''] = 42)) and                         (data[@id=''CMS1500.1.ForceDropOffLocationInBox321''] != ''1'') ">
        ...
        <xsl:if test="data[@id=''CMS1500.1.IndividualBilling1''] = 0">
          <data id="CMS1500.1.3_3Provider">
            <xsl:if test="string-length(data[@id=''CMS1500.1.RenderingProviderPrefix1'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderPrefix1'']" />
              <xsl:text xml:space="preserve"> </xsl:text>
        ...
        <!-- Individual Billing Enabled -->
        <xsl:if test="data[@id=''CMS1500.1.IndividualBilling1''] = 1">
          <data id="CMS1500.1.3_3Name">
            <xsl:if test="string-length(data[@id=''CMS1500.1.RenderingProviderPrefix1'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderPrefix1'']" />
              <xsl:text xml:space="preserve"> </xsl:text>
          ...
          <data id="CMS1500.1.3_3Area">
            <xsl:value-of select="substring(data[@id=''CMS1500.1.RenderingProviderPhone1''], 1, 3)" />
          </data>
          <data id="CMS1500.1.3_3Phone">
            <xsl:value-of select="substring(data[@id=''CMS1500.1.RenderingProviderPhone1''], 4, 3)" />
            <xsl:text>-</xsl:text>
            <xsl:value-of select="substring(data[@id=''CMS1500.1.RenderingProviderPhone1''], 7, 4)" />
          </data>
          <data id="CMS1500.1.3_3Name">
            <xsl:value-of select="data[@id=''CMS1500.1.PracticeName1'']" />
          </data>
          <data id="CMS1500.1.3_3Street">
            <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderStreet11'']" />
            <xsl:if test="string-length(data[@id=''CMS1500.1.RenderingProviderStreet21'']) &gt; 0">
              <xsl:text>, </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderStreet21'']" />
            </xsl:if>
          </data>
          <data id="CMS1500.1.3_3CityStateZip">
            <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderCity1'']" />
            <xsl:text>, </xsl:text>
            <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderState1'']" />
            <xsl:text xml:space="preserve"> </xsl:text>
            <xsl:choose>
              <xsl:when test="string-length(data[@id=''CMS1500.1.RenderingProviderZip1'']) = 9">
                <xsl:value-of select="substring(data[@id=''CMS1500.1.RenderingProviderZip1''], 1, 5)" />
                <xsl:text>-</xsl:text>
                <xsl:value-of select="substring(data[@id=''CMS1500.1.RenderingProviderZip1''], 6, 4)" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderZip1'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.3_3PIN">
            <xsl:value-of select="data[@id=''CMS1500.1.RenderingProviderNPI1'']" />
          </data>
          <data id="CMS1500.1.3_3GRP">
            <xsl:value-of select="data[@id=''CMS1500.1.IndividualBillingTaxID1'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.CarrierName">
          <xsl:value-of select="data[@id=''CMS1500.1.PayerName1'']" />
        ...
        <data id="CMS1500.1.CarrierCityStateZip">
          <xsl:value-of select="data[@id=''CMS1500.1.PayerCity1'']" />
          <xsl:if test="string-length(data[@id=''CMS1500.1.PayerCity1'']) &gt; 0 and string-length(data[@id=''CMS1500.1.PayerState1'']) &gt; 0">
            <xsl:text>, </xsl:text>
          </xsl:if>
          <xsl:value-of select="data[@id=''CMS1500.1.PayerState1'']" />
          <xsl:text xml:space="preserve"> </xsl:text>
        ...
        <data id="CMS1500.1.eDiag1">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer11'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode1''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer11'']) &gt; 0 and                      (string-length(data[@id=''CMS1500.1.DiagnosisPointer21'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer31'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer41'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer21'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer21'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer31'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer41'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer31'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount1''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits1">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits1'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
        </xsl:if>
        <data id="CMS1500.1.hEPSDT1">
          <xsl:value-of select="data[@id=''CMS1500.1.EPSDT1'']" />
        </data>
        ...
        <data id="CMS1500.1.jNPI1">
          <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI1'']" />
        </data>
        <data id="CMS1500.1.SupplementalInfo1">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode1''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and         data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or         data[@id=''CMS1500.1.TypeOfServiceCode1''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or         data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 8678 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode1'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime1'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime1'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime1'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime1'']" />
              </xsl:if>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote1'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote1'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote1">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote1'']" />
        </data>
        <!-- Procedure 2 -->
        <ClaimID>
        ...
        <data id="CMS1500.1.eDiag2">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer12'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode2''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer12'']) &gt; 0 and                      (string-length(data[@id=''CMS1500.1.DiagnosisPointer22'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer32'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer42'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer22'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer22'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer32'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer42'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer32'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount2''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits2">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits2'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.hEPSDT2">
            <xsl:value-of select="data[@id=''CMS1500.1.EPSDT2'']" />
          </data>
          ...
          <data id="CMS1500.1.jNPI2">
            <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI2'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.SupplementalInfo2">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode2''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or data[@id=''CMS1500.1.TypeOfServiceCode2''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode2'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime2'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime2'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime2'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime2'']" />
              </xsl:if>
              <xsl:text> Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaMinutes2'']" />
              <xsl:text> Minutes</xsl:text>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote2'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote2'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote2">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote2'']" />
        </data>
        <!-- Procedure 3 -->
        <ClaimID>
        ...
        <data id="CMS1500.1.eDiag3">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer13'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode3''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer13'']) &gt; 0 and                     (string-length(data[@id=''CMS1500.1.DiagnosisPointer23'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer33'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer43'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer23'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer23'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer33'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer43'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer33'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount3''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits3">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits3'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.hEPSDT3">
            <xsl:value-of select="data[@id=''CMS1500.1.EPSDT3'']" />
          </data>
          ...
          <data id="CMS1500.1.jNPI3">
            <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI3'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.SupplementalInfo3">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode3''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or data[@id=''CMS1500.1.TypeOfServiceCode3''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode3'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime3'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime3'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime3'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime3'']" />
              </xsl:if>
              <xsl:text> Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaMinutes3'']" />
              <xsl:text> Minutes</xsl:text>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote3'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote3'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote3">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote3'']" />
        </data>
        <!-- Procedure 4 -->
        <ClaimID>
        ...
        <data id="CMS1500.1.eDiag4">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer14'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode4''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer14'']) &gt; 0 and                     (string-length(data[@id=''CMS1500.1.DiagnosisPointer24'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer34'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer44'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer24'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer24'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer34'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer44'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer34'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount4''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits4">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits4'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.hEPSDT4">
            <xsl:value-of select="data[@id=''CMS1500.1.EPSDT4'']" />
          </data>
          ...
          <data id="CMS1500.1.jNPI4">
            <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI4'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.SupplementalInfo4">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode4''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or data[@id=''CMS1500.1.TypeOfServiceCode4''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode4'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime4'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime4'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime4'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime4'']" />
              </xsl:if>
              <xsl:text> Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaMinutes4'']" />
              <xsl:text> Minutes</xsl:text>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote4'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote4'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote4">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote4'']" />
        </data>
        <!-- Procedure 5 -->
        <ClaimID>
        ...
        <data id="CMS1500.1.eDiag5">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer15'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode5''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer15'']) &gt; 0 and                     (string-length(data[@id=''CMS1500.1.DiagnosisPointer25'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer35'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer45'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer25'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer25'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer35'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer45'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer35'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount5''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits5">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits5'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.hEPSDT5">
            <xsl:value-of select="data[@id=''CMS1500.1.EPSDT5'']" />
          </data>
          ...
          <data id="CMS1500.1.jNPI5">
            <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI5'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.SupplementalInfo5">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode5''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or data[@id=''CMS1500.1.TypeOfServiceCode5''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode5'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime5'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime5'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime5'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime5'']" />
              </xsl:if>
              <xsl:text> Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaMinutes5'']" />
              <xsl:text> Minutes</xsl:text>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote5'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote5'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote5">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote5'']" />
        </data>
        <!-- Procedure 6 -->
        <ClaimID>
        ...
        <data id="CMS1500.1.eDiag6">
          <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer16'']" />
          <xsl:if test="data[@id=''CMS1500.1.HCFASameAsInsuredFormatCode6''] != ''M''">
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer16'']) &gt; 0 and                     (string-length(data[@id=''CMS1500.1.DiagnosisPointer26'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer36'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer46'']) &gt; 0)">
              <xsl:text>,</xsl:text>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer26'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.DiagnosisPointer26'']" />
              <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer36'']) &gt; 0                     or string-length(data[@id=''CMS1500.1.DiagnosisPointer46'']) &gt; 0">
                <xsl:text>,</xsl:text>
              </xsl:if>
            </xsl:if>
            <xsl:if test="string-length(data[@id=''CMS1500.1.DiagnosisPointer36'']) &gt; 0">
        ...
        <xsl:if test="format-number(data[@id=''CMS1500.1.ServiceUnitCount6''], ''0.0'', ''default-format'') &gt; 0">
          ...
          <data id="CMS1500.1.gUnits6">
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthUnits6'']" />
              </xsl:otherwise>
            </xsl:choose>
          </data>
          <data id="CMS1500.1.hEPSDT6">
            <xsl:value-of select="data[@id=''CMS1500.1.EPSDT6'']" />
          </data>
          ...
          <data id="CMS1500.1.jNPI6">
            <xsl:value-of select="data[@id=''CMS1500.1.ProviderIndividualNPI6'']" />
          </data>
        </xsl:if>
        <data id="CMS1500.1.SupplementalInfo6">
          <xsl:choose>
            <xsl:when test="((data[@id=''CMS1500.1.TypeOfServiceCode6''] = 1) and data[@id=''CMS1500.1.CustomerID1''] = 4701 and data[@id=''CMS1500.1.InsuranceCompanyID1''] = 249 and data[@id=''CMS1500.1.PracticeID1''] = 25) or data[@id=''CMS1500.1.TypeOfServiceCode6''] = 7 and (data[@id=''CMS1500.1.PayerAnesthesiaType1''] != ''M'' or data[@id=''CMS1500.1.CustomerID1''] = 5075 or data[@id=''CMS1500.1.CustomerID1''] = 4701 or data[@id=''CMS1500.1.CustomerID1''] = 14780) ">
              <xsl:value-of select="data[@id=''CMS1500.1.TypeOfServiceCode6'']" />
              <!-- Display the start and end time if exists -->
              <xsl:if test="string-length(data[@id=''CMS1500.1.AnesthesiaStartTime6'']) &gt; 0 and string-length(data[@id=''CMS1500.1.AnesthesiaEndTime6'']) &gt; 0">
                <xsl:text> Begin </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaStartTime6'']" />
                <xsl:text> End </xsl:text>
                <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaEndTime6'']" />
              </xsl:if>
              <xsl:text> Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnesthesiaMinutes6'']" />
              <xsl:text> Minutes</xsl:text>
            ...
            <xsl:when test="string-length(data[@id=''CMS1500.1.EDIServiceNote6'']) &gt; 0">
              <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote6'']" />
            </xsl:when>
          </xsl:choose>
        </data>
        <data id="CMS1500.1.EdiServiceNote6">
          <xsl:value-of select="data[@id=''CMS1500.1.EDIServiceNote6'']" />
        </data>
      </page>
    </formData>
...
/*
SELECT  * ,
        CAST(BF.Transform AS XML)
FROM    dbo.BillingForm AS BF
WHERE   BF.BillingFormID IN (4, 13);
*/
