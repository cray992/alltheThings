-- Case 22768 - Anesthesia related configurable payer specific changes.
--				Allow different types of anesthesia HCFA printing. 
--				An AnesthesiaType of U will display Units in 24g and M will display Minutes.
ALTER TABLE dbo.InsuranceCompany ADD
	[AnesthesiaType] varchar(1) NOT NULL CONSTRAINT DF_InsuranceCompany_AnesthesiaType DEFAULT 'U'

-- Case 23133 - Add a field for Box10d
ALTER TABLE dbo.Encounter ADD
	[Box10d] varchar(40) NULL 

-- Update the billing form to use Box 10d and handle the Anesthesia changes for minutes
UPDATE	BillingForm
