		...
		<formData formId="MASSM7">
			<page pageId="MASSM7.1">
				...
				<data id="MASSM7.1.1_ProviderName">
					<xsl:value-of select="data[@id=''MASSM7.1.PracticeName1'']"/>
				</data>
				...
				<data id="MASSM7.1.2_ProviderNumber">
					<xsl:value-of select="data[@id=''MASSM7.1.RenderingProviderIndividualNumber1'']"/>
				</data>
				...
				<data id="MASSM7.1.28_SignatureSecondLine">
					 Signature on File
				</data>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="MASSM7" pageId="MASSM7.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
  ...
  <g>
    <text x="0.32in" y="1.69in" width="3.62in" height="0.10in" valueSource="MASSM7.1.1_ProviderName" />
    <text x="0.32in" y="1.93in" width="3.62in" height="0.10in" valueSource="MASSM7.1.1_ProviderAddress" />
    <text x="0.32in" y="2.16in" width="3.62in" height="0.10in" valueSource="MASSM7.1.1_ProviderCityStateZip" />
    <text x="0.32in" y="2.41in" width="3.62in" height="0.10in" valueSource="MASSM7.1.1_ProviderTelephone" />
    <text x="4.17in" y="1.69in" width="1.90in" height="0.10in" valueSource="MASSM7.1.1A_BillingProviderNPI" />
    <text x="4.17in" y="2.17in" width="1.90in" height="0.10in" valueSource="MASSM7.1.1B_BillingProviderTaxonomy" />
    <text x="4.17in" y="2.55in" width="1.31in" height="0.10in" valueSource="MASSM7.1.2_ProviderNumber" />
    <text x="5.69in" y="2.55in" width="1.31in" height="0.10in" valueSource="MASSM7.1.3_BillingAgentNumber" />
    <text x="0.32in" y="2.94in" width="2.33in" height="0.10in" valueSource="MASSM7.1.4_MemberName" />
    <text x="3.14in" y="2.94in" width="1.89in" height="0.10in" valueSource="MASSM7.1.5_MemberIDNumber" />
    <text x="5.17in" y="2.94in" width="1.40in" height="0.10in" valueSource="MASSM7.1.6_PatientAccountNumber" />
    <text x="6.76in" y="2.94in" width="1.39in" height="0.10in" valueSource="MASSM7.1.7_PriorAuthorizationNumber" />
    <text x="0.32in" y="3.34in" width="2.33in" height="0.10in" valueSource="MASSM7.1.8_PrescribingProviderName" />
    <text x="2.77in" y="3.34in" width="1.32in" height="0.10in" valueSource="MASSM7.1.9_PrescribingProviderNumber" />
    <text x="4.7in" y="3.34in" width="0.53in" height="0.10in" valueSource="MASSM7.1.10_StartTime" />
    <text x="5.29in" y="3.34in" width="0.11in" height="0.10in" valueSource="MASSM7.1.10_StartTimeAM" />
    <text x="5.76in" y="3.34in" width="0.11in" height="0.10in" valueSource="MASSM7.1.10_StartTimePM" />
    <text x="6.7in" y="3.34in" width="0.53in" height="0.10in" valueSource="MASSM7.1.10_StopTime" />
    <text x="7.29in" y="3.34in" width="0.11in" height="0.10in" valueSource="MASSM7.1.10_StopTimeAM" />
    <text x="7.78in" y="3.34in" width="0.11in" height="0.10in" valueSource="MASSM7.1.10_StopTimePM" />
    <text x="0.66in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.11A_AccidentRelated_NO" />
    <text x="1.32in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.11A_AccidentRelated_YES" />
    <text x="2.4in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.11B_AccidentRelatedReason" />
    <text x="2.71in" y="3.79in" width="1.25in" height="0.10in" valueSource="MASSM7.1.11C_AccidentDate" />
    <text x="4.35in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.12_Emergency_NO" />
    <text x="4.99in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.12_Emergency_YES" />
    <text x="6.25in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.13_TripIndicator_OneWay" />
    <text x="6.9in" y="3.79in" width="0.19in" height="0.10in" valueSource="MASSM7.1.13_TripIndicator_RoundTrip" />
    <text x="0.32in" y="4.23in" width="3.97in" height="0.10in" valueSource="MASSM7.1.14_OriginatingLocation" />
    <text x="4.51in" y="4.23in" width="3.72in" height="0.10in" valueSource="MASSM7.1.15_DestinationLocation" />
  </g>
  <g class="smaller">
    <!--Line A-->
    <text x="0.59in" y="5.03in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate1" />
    <text x="1.78in" y="5.03in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description1" />
    <text x="3.5in" y="5.03in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier1" />
    <text x="4.61in" y="5.03in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles1" />
    <text x="5.2in" y="5.03in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting1" />
    <text x="6in" y="5.03in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService1" />
    <text x="6.33in" y="5.03in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars1" class="money" />
    <text x="7.05in" y="5.03in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents1" />
    <text x="7.41in" y="5.03in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars1" class="money" />
    <text x="8.05in" y="5.03in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents1" />
    <!--Line B-->
    <text x="0.59in" y="5.34in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate2" />
    <text x="1.78in" y="5.34in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description2" />
    <text x="3.5in" y="5.34in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier2" />
    <text x="4.57in" y="5.34in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles2" />
    <text x="5.2in" y="5.34in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting2" />
    <text x="5.96in" y="5.34in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService2" />
    <text x="6.33in" y="5.34in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars2" class="money" />
    <text x="7.05in" y="5.34in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents2" />
    <text x="7.41in" y="5.34in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars2" class="money" />
    <text x="8.05in" y="5.34in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents2" />
    <!--Line C-->
    <text x="0.59in" y="5.67in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate3" />
    <text x="1.78in" y="5.67in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description3" />
    <text x="3.5in" y="5.67in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier3" />
    <text x="4.57in" y="5.67in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles3" />
    <text x="5.2in" y="5.67in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting3" />
    <text x="5.96in" y="5.67in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService3" />
    <text x="6.33in" y="5.67in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars3" class="money" />
    <text x="7.05in" y="5.67in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents3" />
    <text x="7.41in" y="5.67in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars3" class="money" />
    <text x="8.05in" y="5.67in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents3" />
    <!--Line D-->
    <text x="0.59in" y="6in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate4" />
    <text x="1.78in" y="6in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description4" />
    <text x="3.5in" y="6in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier4" />
    <text x="4.57in" y="6in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles4" />
    <text x="5.2in" y="6in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting4" />
    <text x="5.96in" y="6in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService4" />
    <text x="6.33in" y="6in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars4" class="money" />
    <text x="7.05in" y="6in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents4" />
    <text x="7.41in" y="6in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars4" class="money" />
    <text x="8.05in" y="6in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents4" />
    <!--Line E-->
    <text x="0.59in" y="6.33in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate5" />
    <text x="1.78in" y="6.33in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description5" />
    <text x="3.5in" y="6.33in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier5" />
    <text x="4.57in" y="6.33in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles5" />
    <text x="5.2in" y="6.33in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting5" />
    <text x="5.96in" y="6.33in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService5" />
    <text x="6.33in" y="6.33in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars5" class="money" />
    <text x="7.05in" y="6.33in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents5" />
    <text x="7.41in" y="6.33in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars5" class="money" />
    <text x="8.05in" y="6.33in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents5" />
    <!--Line F-->
    <text x="0.59in" y="6.66in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate6" />
    <text x="1.78in" y="6.66in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description6" />
    <text x="3.5in" y="6.66in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier6" />
    <text x="4.57in" y="6.66in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles6" />
    <text x="5.2in" y="6.66in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting6" />
    <text x="5.96in" y="6.66in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService6" />
    <text x="6.33in" y="6.66in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars6" class="money" />
    <text x="7.05in" y="6.66in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents6" />
    <text x="7.41in" y="6.66in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars6" class="money" />
    <text x="8.05in" y="6.66in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents6" />
    <!--Line G-->
    <text x="0.59in" y="6.99in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate7" />
    <text x="1.78in" y="6.99in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description7" />
    <text x="3.5in" y="6.99in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier7" />
    <text x="4.57in" y="6.99in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles7" />
    <text x="5.2in" y="6.99in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting7" />
    <text x="5.96in" y="6.99in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService7" />
    <text x="6.33in" y="6.99in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars7" class="money" />
    <text x="7.05in" y="6.99in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents7" />
    <text x="7.41in" y="6.99in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars7" class="money" />
    <text x="8.05in" y="6.99in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents7" />
    <!--Line H-->
    <text x="0.59in" y="7.32in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate8" />
    <text x="1.78in" y="7.32in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description8" />
    <text x="3.5in" y="7.32in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier8" />
    <text x="4.57in" y="7.32in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles8" />
    <text x="5.2in" y="7.32in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting8" />
    <text x="5.96in" y="7.32in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService8" />
    <text x="6.33in" y="7.32in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars8" class="money" />
    <text x="7.05in" y="7.32in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents8" />
    <text x="7.41in" y="7.32in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars8" class="money" />
    <text x="8.05in" y="7.32in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents8" />
    <!--Line I-->
    <text x="0.59in" y="7.65in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate9" />
    <text x="1.78in" y="7.65in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description9" />
    <text x="3.5in" y="7.65in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier9" />
    <text x="4.57in" y="7.65in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles9" />
    <text x="5.2in" y="7.65in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting9" />
    <text x="5.96in" y="7.65in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService9" />
    <text x="6.33in" y="7.65in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars9" class="money" />
    <text x="7.05in" y="7.65in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents9" />
    <text x="7.41in" y="7.65in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars9" class="money" />
    <text x="8.05in" y="7.65in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents9" />
    <!--Line J-->
    <text x="0.59in" y="7.98in" width="1.11in" height="0.10in" valueSource="MASSM7.1.17_ServiceBeginDate10" />
    <text x="1.78in" y="7.98in" width="1.59in" height="0.10in" valueSource="MASSM7.1.18_Description10" />
    <text x="3.5in" y="7.98in" width="1.00in" height="0.10in" valueSource="MASSM7.1.19_ProcedureCode_Modifier10" />
    <text x="4.57in" y="7.98in" width="0.57in" height="0.10in" valueSource="MASSM7.1.20_NumberOfMiles10" />
    <text x="5.2in" y="7.98in" width="0.69in" height="0.10in" valueSource="MASSM7.1.21_NumberOfMinutesWaiting1" />
    <text x="5.96in" y="7.98in" width="0.31in" height="0.10in" valueSource="MASSM7.1.22_PlaceOfService10" />
    <text x="6.33in" y="7.98in" width="0.59in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Dollars10" class="money" />
    <text x="7.05in" y="7.98in" width="0.31in" height="0.10in" valueSource="MASSM7.1.23_UsualFee_Cents10" />
    <text x="7.41in" y="7.98in" width="0.52in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Dollars10" class="money" />
    <text x="8.05in" y="7.98in" width="0.23in" height="0.10in" valueSource="MASSM7.1.24_OtherPaidAmount_Cents10" />
  </g>
  <g>
    <text x="6.45in" y="8.33in" width="0.50in" height="0.10in" valueSource="MASSM7.1.26_TotalUsualFee_Dollars" class="money" />
    <text x="7.03in" y="8.33in" width="0.23in" height="0.10in" valueSource="MASSM7.1.26_TotalUsualFee_Cents" />
    <text x="7.44in" y="8.33in" width="0.50in" height="0.10in" valueSource="MASSM7.1.27_TotalOtherPaidAmount_Dollars" class="money" />
    <text x="8.03in" y="8.33in" width="0.23in" height="0.10in" valueSource="MASSM7.1.27_TotalOtherPaidAmount_Cents" />
    <text x="0.34in" y="10.00in" width="2.50in" height="0.10in" valueSource="MASSM7.1.28_PhysicianSignature" />
    <text x="0.34in" y="10.25in" width="2.50in" height="0.10in" valueSource="MASSM7.1.28_SignatureSecondLine" />
    <text x="3.01in" y="10.25in" width="1.25in" height="0.10in" valueSource="MASSM7.1.29_PhysicianSignatureCurrentDate" />
  </g>
</svg>'
