/* 1 - Add EmergencyRelated indicator to PatientCase ... */

BEGIN TRANSACTION
GO
ALTER TABLE dbo.PatientCase ADD
	EmergencyRelated bit NULL
GO
ALTER TABLE dbo.PatientCase ADD CONSTRAINT
	DF_PatientCase_Emergency DEFAULT 0 FOR EmergencyRelated
GO
COMMIT

UPDATE dbo.PatientCase SET
	EmergencyRelated = 0
GO

/* 2 - Update the HCFA Standard (with NPI Numbers) to include EMG data for a specific situation */
