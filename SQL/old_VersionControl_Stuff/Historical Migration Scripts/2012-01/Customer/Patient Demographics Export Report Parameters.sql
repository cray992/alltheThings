...
='<parameters defaultMessage="Please click Customize to filter this export" print="false" pdf="false" csv="true">
  ...
  <extendedParameters>
    ...
    <extendedParameter type="ProcedureCodeCategory" parameterName="ProcedureCodeCategoryID" text="Procedure Category:" default="-1" ignore="-1" />
...
WHERE ReportPath='/BusinessManagerReports/rptPatientDemographicExport'
