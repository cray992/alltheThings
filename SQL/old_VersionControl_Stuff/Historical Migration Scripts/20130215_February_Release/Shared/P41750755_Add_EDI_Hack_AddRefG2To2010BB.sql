...
SET @hack_name = 'AddRefG2To2010BB';
...
IF NOT EXISTS ( SELECT  *
    ...
    BEGIN
        ...
        VALUES  ( @hack_name ,
                  'If there is a REF*G2 claim-settings-override, then the system will add the REF*G2 segment to loop 2010BB.' ,
                  '@' + @hack_name + ' = 1' ,
                  0 ,
                  0 ,
                  0 ,
...
SET @customer_id = 12416;
SET @payer_number = '62308';
