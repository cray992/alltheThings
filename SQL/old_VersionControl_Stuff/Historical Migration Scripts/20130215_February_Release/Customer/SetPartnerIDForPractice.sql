IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS AS c WHERE c.COLUMN_NAME='PartnerID' AND c.TABLE_NAME='Practice')
ALTER TABLE Practice DROP COLUMN PartnerID
GO


IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS AS c WHERE c.COLUMN_NAME='IsLegacyEHRPartner' AND c.TABLE_NAME='Practice')
BEGIN 
ALTER TABLE Practice ADD IsLegacyEHRPartner BIT DEFAULT (0)
END
...
WHERE ISLegacyEHRPartner IS  NULL OR ISLegacyEHRPartner<>1
