-- kprod-db20
-- USE superbill_8486_prod;
-- USE superbill_8486_dev;
GO
...
SET SVGDefinition = '<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg" version="1.0">
  ...
  <xsl:template name="CreateRecentDiagnosesGridLines">
    ...
    <xsl:if test="$maximumRows = $currentRow">
      ...
      <text x="{$xLeftOffset + $codeXOffset + 2.5}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".30in" height="0.1in">Code</text>
  ...
  <xsl:template name="CreateProceduresGridLines">
    ...
    <xsl:if test="$maximumRows = $currentRow">
      ...
      <!-- Print the vertical lines -->
      <line x1="{$xLeftOffset}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + .27}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + .25}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 2.25}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 2.25}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 2.5}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 2.5}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 2.77}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 2.75}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 4.75}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 4.75}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 5}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 5}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 5.27}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 5.25}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 7.25}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 7.25}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <line x1="{$xLeftOffset + 7.5}in" y1="{$yTopOffset - $yOffset * 2}in" x2="{$xLeftOffset + 7.5}in" y2="{$yTopOffset + $yOffset * ($currentRow - 1)}in" />
      <!-- Add procedure header -->
      <rect x="{$xLeftOffset}in" y="{$yTopOffset + $headerYOffset + 0.009 - $yOffset * 3}in" width="{$lineWidth}in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt" />
  ...
  <xsl:template name="CreateProceduresColumnLayout">
    ...
    <xsl:variable name="codeWidth" select=".29" />
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="300">
      ...
      <g>
        ...
        <g>
          ...
          <text x="0.25in" y="0.70in" width="8in" height="0.1in" font-family="Arial Narrow" font-size="9pt" class="centeredtext" valueSource="EncounterForm.1.FullPracticeAddress1" /></g>
        <g>
          <!-- Patient box -->
          <!-- Header -->
          ...
          <!-- Patient fields -->
          <text x="1.20in" y="1.0390in" width="3.00in" height="0.1in" font-family="Arial Narrow" font-weight="bold" font-size="11pt" valueSource="EncounterForm.1.PatientName1" />
          <text x="4.70in" y="1.07in" width="0.75in" height="0.1in" font-family="Arial Narrow" font-size="9pt" valueSource="EncounterForm.1.PatientID1" />
          ...
          <text x="1.20in" y="1.38in" width="3.00in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.FullPhone1" />
          <text x="4.70in" y="1.38in" width="0.75in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.DOBAge1" />
          <text x="1.20in" y="1.52in" width="3.00in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.PrimaryInsWithCopay1" />
          <text x="4.70in" y="1.52in" width="0.75in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.Gender1" />
          <text x="1.20in" y="1.66in" width="2.85in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.SecondaryIns1" />
          <text x="4.70in" y="1.66in" width="0.75in" height="0.1in" font-family="Arial Narrow" font-size="7pt" valueSource="EncounterForm.1.ResponsiblePerson1" />
        </g>
        <!-- Visit box -->
        <g>
