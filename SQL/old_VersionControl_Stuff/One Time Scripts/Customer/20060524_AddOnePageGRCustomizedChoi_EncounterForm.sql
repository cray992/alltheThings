-------------------------------------------------------------------------------------------------
-- Case 10918: Implement a one page customized encounter form for G.R.M.M provider David Choi. 
-------------------------------------------------------------------------------------------------
  ...
  -->
	...
	<xsl:template match="/formData/page">
        ...
        <g id="PracticeInformation">
          ...
          <text x="3.9825in" y="0.62in" >DAVID CHOI, DC</text>
...
WHERE PrintingFormDetailsID = 36
