IF NOT EXISTS(SELECT EncounterFormTypeID FROM EncounterFormType WHERE EncounterFormTypeID = 58)
BEGIN
	...
	VALUES (58, '1-Page, 3-Column with 3 Insurances Big Font', 'Encounter form that prints on a single page', 58, 1, 86, 1, 1, 1, 1, 1)
END

IF NOT EXISTS(SELECT PrintingFormDetailsID FROM PrintingFormDetails WHERE PrintingFormDetailsID = 86)
BEGIN
	INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
	VALUES (86, 9, 73, '1-Page, 3-Column with 3 Insurances Big Font', 1)
END
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="300">
          ...
          <!--<xsl:choose>
            ...
            <xsl:otherwise>-->
              ...
              <line x1="1.395in" y1="2.075in" x2="2.939in" y2="2.075in"></line>
            <!--</xsl:otherwise>
          </xsl:choose>-->
          ...
          <text x="2.20in" y="2.21in" width="0.80in" height="0.10in" valueSource="EncounterForm.1.DOBAge1"/>
				...
				<g id="InsuranceCoverage">
					...
					<line x1="3.9in" y1="2.10in" x2="3.9in" y2="2.3583in"></line>
          ...
          <line x1="4.86in" y1="1.325in" x2="4.86in" y2="2.3583in"></line>
          ...
          <text x="6.76in" y="1.355in" font-size="5pt">DATE/TIME</text>
				...
				<g id="AccountStatus">
					...
					<line x1="0.50in" y1="2.7166in" x2="8.0in" y2="2.7166in"></line>

				</g>

				<g id="ReturnSchedule">
          <line x1="6.0in" y1="2.3583in" x2="6.0in" y2="2.7166in"></line>
