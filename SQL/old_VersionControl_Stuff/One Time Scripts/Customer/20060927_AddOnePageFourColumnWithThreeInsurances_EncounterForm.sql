--------------------------------------------------------------------------------------------------------------------------------------------------------
-- Case 14359: Implement a one page customized encounter form for Dr. Marilyn Rolluts, a provider of SSK, LLC Medical Billing Specialists(Customer 720).
--------------------------------------------------------------------------------------------------------------------------------------------------------

IF NOT EXISTS(SELECT EncounterFormTypeID FROM EncounterFormType WHERE EncounterFormTypeID = 52)
BEGIN
	INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder, NumberOfPages, PageOneDetailsID, ShowProcedures, ShowAccountStatus, ShowTertiaryInsurance, ShowLastVisitDate, ShowPatientBalance)
	VALUES (52, '1-Page, 4-Column with 3 Insurances', 'Encounter form that prints on a single page', 52, 1, 68, 1, 1, 1, 1, 1)
END

IF NOT EXISTS(SELECT PrintingFormDetailsID FROM PrintingFormDetails WHERE PrintingFormDetailsID = 68)
BEGIN
	INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
	VALUES (68, 9, 55, '1-Page, 4-Column with 3 Insurances', 1)
END
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template name="CreateProceduresGridLines">
		...
		<xsl:if test="$maximumRows = $currentRow">
			...
			<text x="{$xLeftOffset + $codeXOffset}in" y="{$yTopOffset + $headerYOffset + 0.019 - $yOffset * 3}in" font-family="Arial" font-weight="bold" font-size="7pt">PROCEDURES</text>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="CreateDiagnosesGridLines">
		...
		<xsl:variable name="xLeftOffset" select="0.50"/>
		<xsl:variable name="yTopOffset" select="10.03"/>
		<xsl:variable name="yOffset" select="0.15625"/>
		<xsl:variable name="lineWidth" select="7.50"/>
		<xsl:variable name="headerYOffset" select="0.01"/>
		<xsl:variable name="codeXOffset" select="0.02"/>
		...
		<xsl:if test="$maximumRows = $currentRow">
			...
			<!-- Add procedure header -->
			<rect x="{$xLeftOffset}in" y="{$yTopOffset + $headerYOffset + 0.019 - $yOffset * 3}in" width="{$lineWidth}in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt" />
			<text x="{$xLeftOffset + $codeXOffset}in" y="{$yTopOffset + $headerYOffset + 0.019 - $yOffset * 3}in" font-family="Arial" font-weight="bold" font-size="7pt">DIAGNOSES</text>
		</xsl:if>
	</xsl:template>
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="300">
			...
			<g>
				...
				<g id="AccountActivity">
					...
					<line x1="4.50in" y1="0.625in" x2="4.50in" y2="1.20in"></line>
					...
					<line x1="4.50in" y1="0.9125in" x2="6.0in" y2="0.9125in"></line>
					<text x="4.51in" y="0.9425in" font-size="5pt">TODAY''S CHARGES</text>
					<line x1="6.0in" y1="0.625in" x2="6.0in" y2="1.20in"></line>
				</g>
				<g id="PaymentOnAccount">
					...
					<line x1="6.80in" y1="0.625in" x2="6.80in" y2="1.20in"></line>
					<text x="6.81in" y="0.655in" font-size="5pt">BALANCE DUE</text>
					<line x1="6.80in" y1="0.815in" x2="8.0in" y2="0.815in"></line>
					<text x="6.81in" y="0.845in" font-size="5pt">CASH DISCOUNT</text>
					<line x1="6.80in" y1="1.005in" x2="8.0in" y2="1.005in"></line>
					<text x="6.81in" y="1.035in" font-size="5pt">TODAY''S PAYMENT</text>
				</g>
				<g id="PatientInformation">
					...
					<line x1="3.0in" y1="1.325in" x2="3.0in" y2="2.3583in"></line>
					...
					<line x1="0.50in" y1="2.10in" x2="8.0in" y2="2.10in"></line>
					...
					<line x1="1.33in" y1="2.10in" x2="1.33in" y2="2.3583in"></line>
					...
					<line x1="2.16in" y1="2.10in" x2="2.16in" y2="2.3583in"></line>
					...
					<line x1="0.50in" y1="2.3583in" x2="8.0in" y2="2.3583in"></line>
				</g>
				<g id="InsuranceCoverage">
					...
					<text x="3.04in" y="1.435in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.PrimaryIns1"/>
					<line x1="3.0in" y1="1.5833in" x2="8.0in" y2="1.5833in"></line>
					<text x="3.01in" y="1.6133in" font-size="5pt">SECONDARY INSURANCE</text>
					<text x="3.04in" y="1.6933in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.SecondaryIns1"/>
					<line x1="3.0in" y1="1.8416in" x2="8.0in" y2="1.8416in"></line>
					<text x="3.01in" y="1.8716in" font-size="5pt">TERTIARY INSURANCE</text>
					<text x="3.04in" y="1.9516in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.TertiaryIns1"/>
					...
					<line x1="3.625in" y1="2.10in" x2="3.625in" y2="2.3583in"></line>
					<text x="3.635in" y="2.13in" font-size="5pt">DEDUCTIBLE</text>
					<text x="3.665in" y="2.21in" width="0.595in" height="0.10in" valueSource="EncounterForm.1.Deductible1"/>
					<line x1="4.25in" y1="1.325in" x2="4.25in" y2="2.3583in"></line>
					<text x="4.26in" y="1.355in" font-size="5pt">PRIMARY POLICY NUMBER</text>
					<text x="4.30in" y="1.435in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.PolicyNumber1"/>
					<text x="4.26in" y="1.6133in" font-size="5pt">SECONDARY POLICY NUMBER</text>
					<text x="4.30in" y="1.6933in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.SecondaryPolicyNumber1"/>
					<text x="4.26in" y="1.8716in" font-size="5pt">TERTIARY POLICY NUMBER</text>
					<text x="4.30in" y="1.9516in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.TertiaryPolicyNumber1"/>
					<text x="4.26in" y="2.13in" font-size="5pt">GUARANTOR</text>
					<text x="4.30in" y="2.21in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.ResponsiblePerson1"/>
				</g>
				<g id="AppointmentInformation">
					<line x1="5.50in" y1="1.325in" x2="5.50in" y2="2.3583in"></line>
					<text x="5.52in" y="1.20in" font-weight="bold" font-size="7pt">APPOINTMENT INFORMATION</text>
					<text x="5.51in" y="1.355in" font-size="5pt">DATE/TIME</text>
					<text x="5.54in" y="1.435in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.AppDateTime1"/>
					<text x="5.51in" y="1.6133in" font-size="5pt">DATE OF LAST VISIT</text>
					<text x="5.54in" y="1.6933in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.LastVisitDate1"/>
					<text x="5.51in" y="1.8716in" font-size="5pt">PCP</text>
					<text x="5.54in" y="1.9516in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.PCP1"/>
					<text x="5.51in" y="2.13in" font-size="5pt">TREATING PHYSICIAN</text>
					<text x="5.54in" y="2.21in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.Provider1"/>
					<line x1="6.75in" y1="1.325in" x2="6.75in" y2="2.3583in"></line>
					<text x="6.76in" y="1.355in" font-size="5pt">TICKET NUMBER</text>
					<text x="6.79in" y="1.435in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.TicketNumber1"/>
					<text x="6.76in" y="1.6133in" font-size="5pt">REASON</text>
					<text x="6.79in" y="1.6933in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.Reason1"/>
					<text x="6.76in" y="1.8716in" font-size="5pt">DATE OF INJURY:</text>
					<text x="6.79in" y="1.9516in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.InjuryDate1"/>
					<text x="6.76in" y="2.13in" font-size="5pt">PLACE OF INJURY:</text>
					<text x="6.79in" y="2.21in" width="1.22in" height="0.10in" valueSource="EncounterForm.1.InjuryPlace1"/>
				</g>
				<g id="AccountStatus">
					<text x="0.51in" y="2.3883in" font-size="5pt">ACCOUNT STATUS:</text>
					<text x="0.54in" y="2.4675in" width="5.47in" height="0.10in" valueSource="EncounterForm.1.AccountStatus1" />
					<line x1="0.50in" y1="2.6166in" x2="8.0in" y2="2.6166in"></line>
				</g>
				<g id="ReturnSchedule">
					<line x1="6.0in" y1="2.3583in" x2="6.0in" y2="2.6166in"></line>
			...
			<g id="ProceduresGrid">
				<xsl:call-template name="CreateProceduresGridLines">
					<xsl:with-param name="maximumRows" select="42"/>
					<xsl:with-param name="currentRow" select="1"/>
				</xsl:call-template>
			</g>
			<g id="ProceduresDetails">
				<xsl:call-template name="CreateProceduresColumnLayout">
					<xsl:with-param name="maximumRowsInColumn" select="43"/>
...
WHERE PrintingFormDetailsID = 68