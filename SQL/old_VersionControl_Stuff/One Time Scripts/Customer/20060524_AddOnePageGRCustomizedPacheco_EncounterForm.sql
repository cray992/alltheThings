----------------------------------------------------------------------------------------------------
-- Case 10825: Implement a one page customized encounter form for G.R.M.M provider Brynilla Pacheco. 
----------------------------------------------------------------------------------------------------
  ...
  -->
	...
	<xsl:template match="/formData/page">
        ...
        <g id="PracticeInformation">
          ...
          <text x="3.7625in" y="0.62in" >BRYNILLA PACHECO, R.P.T</text>
          <text x="4.01875in" y="0.74in" >San Fernando</text>
        </g>
...
WHERE PrintingFormDetailsID = 35
