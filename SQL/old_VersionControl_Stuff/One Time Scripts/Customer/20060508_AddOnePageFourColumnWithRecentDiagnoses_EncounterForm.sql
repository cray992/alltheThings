-------------------------------------------------------------------------------------------------
-- Case 10361: Implement a one page, four column encounter form with recent and other diagnoses. 
-------------------------------------------------------------------------------------------------
/*
INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder)
VALUES (15, '1-Page, 4-Column with Recent Diagnoses', 'Encounter form that prints on a single page', 15)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(33, 9, 18, '1-Page, 4-Column with Recent Diagnoses', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
  ...
  -->
	...
	<xsl:template name="CreateDiagnosesGridLines">
		...
		<xsl:if test="$maximumRows = $currentRow">
			...
			<text x="{$xLeftOffset + $codeXOffset + 1.875}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".25in" height="0.1in">Code</text>
			<text x="{$xLeftOffset + $descriptionXOffset + 1.875}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".5in" height="0.1in">Name</text>
			<text x="{$xLeftOffset + $codeXOffset + 3.75}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".25in" height="0.1in">Code</text>
			<text x="{$xLeftOffset + $descriptionXOffset + 3.75}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".5in" height="0.1in">Name</text>
			<text x="{$xLeftOffset + $codeXOffset + 5.625}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".25in" height="0.1in">Code</text>
			<text x="{$xLeftOffset + $descriptionXOffset + 5.625}in" y="{$yTopOffset + $headerYOffset - $yOffset * 2}in" width=".5in" height="0.1in">Name</text>
		</xsl:if>
	</xsl:template>
  ...
  -->
	...
	<xsl:template name="CreateRecentDiagnosesColumnLayout">
		...
		<text x="0.79in" y="2.1775in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{1}" />
		<text x="0.51in" y="2.33375in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{2}" />
		<text x="0.79in" y="2.33375in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{2}" />
		<text x="2.385in" y="2.1775in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{3}" />
		<text x="2.665in" y="2.1775in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{3}" />
		<text x="2.385in" y="2.33375in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{4}" />
		<text x="2.665in" y="2.33375in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{4}" />
		<text x="4.26in" y="2.1775in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{5}" />
		<text x="4.54in" y="2.1775in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{5}" />
		<text x="4.26in" y="2.33375in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{6}" />
		<text x="4.54in" y="2.33375in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{6}" />
		<text x="6.135in" y="2.1775in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{7}" />
		<text x="6.415in" y="2.1775in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{7}" />
		<text x="6.135in" y="2.33375in" width="0.3in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisCode{8}" />
		<text x="6.415in" y="2.33375in" width="1.61in" height="0.1in" valueSource="EncounterForm.1.RecentDiagnosisName{8}" />
	...
	<xsl:template match="/formData/page">
      ...
      <g id="Signature">
        <rect x="6.125in" y="9.91125in" width="1.875in" height="0.46875in" fill="rgb(255, 255, 255)" stroke="black" stroke-width="0.5pt" />
        <text x="6.185in" y="10.12875in" font-family="Arial Narrow" font-size="5pt">X</text>
        <line x1="6.155in" y1="10.23875in" x2="7.97in" y2="10.23875in" stroke="black"></line>
        <text x="6.185in" y="10.26875in" font-family="Arial Narrow" font-size="5pt">PHYSICIAN''S SIGNATURE</text>
      </g>
      
		</svg>
	</xsl:template>
</xsl:stylesheet>'
WHERE PrintingFormDetailsID = 33