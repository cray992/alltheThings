-------------------------------------------------------------------------------------------------------------------
-- Case 13020: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (36, 'One Page Caduceus Psychology', 'Encounter form that prints on a single page', 36)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(52, 9, 39, 'One Page Caduceus Psychology', 1)
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
      ...
      <!-- Background image -->
	    <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://d8048d91-49a5-4a3b-9d3a-0efbdaa50501?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.Psychology.jpg" />
      -->
            ...
            <xsl:otherwise>
              ...
              <text x="0.40in" y="1.765in" width="2.32in" height="0.10in" valueSource="EncounterForm.1.FullPhone1"/>
				...
				<g id="AppointmentInformation">
					...
					<text x="4.62in" y="1.885in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.RefProvider1"/>
					<text x="4.62in" y="2.125in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.Provider1"/>
					<text x="6.18in" y="1.405in" width="1.97in" height="0.10in" valueSource="EncounterForm.1.TicketNumber1"/>
					<text x="6.18in" y="1.645in" width="1.97in" height="0.10in" valueSource="EncounterForm.1.Reason1"/>
				</g>
...
WHERE PrintingFormDetailsID = 52
