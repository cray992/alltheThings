--------------------------------------------------------------------------------------------------
-- Case 10946: Implement a one page four column customized encounter form for Caduceus. 
--------------------------------------------------------------------------------------------------
/*
INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder)
VALUES (20, 'One Page Four Column', 'Encounter form that prints on a single page', 20)

INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES (38, 9, 23, 'One Page Four Column', 1)
*/
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="300">
			...
			<g>
				...
				<g id="AccountActivity">
					...
					<line x1="4.50in" y1="0.625in" x2="4.50in" y2="1.20in" stroke="black"></line>
					...
					<line x1="4.50in" y1="0.9125in" x2="6.0in" y2="0.9125in" stroke="black"></line>
					<text x="4.51in" y="0.9425in" font-size="5pt">TODAY''S CHARGES</text>
					<line x1="6.0in" y1="0.625in" x2="6.0in" y2="1.20in" stroke="black"></line>
				...
				<g id="PaymentOnAccount">
					...
					<line x1="7.0in" y1="0.625in" x2="7.0in" y2="1.20in" stroke="black"></line>
					<text x="7.01in" y="0.655in" font-size="5pt">BALANCE DUE</text>
					<line x1="7.0in" y1="0.9125in" x2="8.0in" y2="0.9125in" stroke="black"></line>
				...
				<g id="PatientInformation">
					...
					<line x1="3.0in" y1="1.325in" x2="3.0in" y2="2.3583in" stroke="black"></line>
					...
					<line x1="0.5in" y1="2.10in" x2="8.0in" y2="2.10in" stroke="black"></line>
					...
					<line x1="0.50in" y1="2.3583in" x2="8.0in" y2="2.3583in" stroke="black"></line>
				...
				<g id="InsuranceCoverage">
					...
					<line x1="4.50in" y1="1.325in" x2="4.50in" y2="2.3583in" stroke="black"></line>
					...
					<line x1="3.0in" y1="1.5833in" x2="8.0in" y2="1.5833in" stroke="black"></line>
					...
					<line x1="3.0in" y1="1.8416in" x2="8.0in" y2="1.8416in" stroke="black"></line>
					...
					<line x1="3.75in" y1="2.10in" x2="3.75in" y2="2.3583in" stroke="black"></line>
				...
				<g id="AppointmentInformation">
					...
					<line x1="6.0in" y1="1.325in" x2="6.0in" y2="2.6166in" stroke="black"></line>
				...
				<g id="AccountStatus">
					...
					<line x1="0.50in" y1="2.6166in" x2="8.0in" y2="2.6166in" stroke="black"></line>
