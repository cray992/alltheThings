...
declare @x xml
set @x='<parameters defaultMessage="Please click on Customize to filter report." csv="false" paging="true" pageColumnCount="13" extraHeaderLength="1315" pageCharacterCount="650000" headerExtractCharacterCount="100000">
  <basicParameters>
    <basicParameter type="ShowFooter" parameterName="rpmShowFooterInfo" />
    <basicParameter type="PracticeID" parameterName="PracticeID" />
    <basicParameter type="PracticeName" parameterName="rpmPracticeName" />
...
update reportHyperlink
set ReportParameters=@x, ModifiedDate=getdate()
where Description='Charges Detail Report'
GO
