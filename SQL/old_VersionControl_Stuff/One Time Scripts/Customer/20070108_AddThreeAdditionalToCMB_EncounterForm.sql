---------------------------------------------------------------------------------------------------------------------------------------------------------
-- Case 17592: Add three additional encounter forms for Inland Pulmonary Medical Group, a practice of California Medical Billing(Customer 327).
---------------------------------------------------------------------------------------------------------------------------------------------------------

-- Make sure to only migrate the data when in customer 327
IF charindex('_0327_', db_name()) > 0
BEGIN

INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder)
VALUES (46, '1-Page, 2-Column Diagnoses', 'Encounter form that prints on a single page', 46)

INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES (62, 9, 49, '1-Page, 2-Column Diagnoses', 1)
...
INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder)
VALUES (40, 'One Page Codes with Circles', 'Encounter form that prints on a single page', 40)

INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES (56, 9, 43, 'One Page Codes with Circles', 1)
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
  ...
  <xsl:template name="CreateProceduresColumnLayout">
    ...
    <xsl:variable name="yTopOffset" select="2.63"/>
    <xsl:variable name="yOffset" select="0.15625"/>
    <xsl:variable name="codeXOffset" select="0.01"/>
    <xsl:variable name="descriptionXOffset" select="0.31"/>
    <xsl:variable name="codeYOffset" select="0.04"/>
    <xsl:variable name="descriptionYOffset" select="0.028"/>
    <xsl:variable name="codeWidth" select="0.30"/>
    <xsl:variable name="descriptionWidth" select="1.575"/>
    ...
    <xsl:if test="$totalElements >= $currentElement and $maximumColumns >= $currentColumn">
      ...
      <xsl:choose>
        ...
        <xsl:when test="$currentCategory != $CurrentCategoryIndex">
          ...
          <!-- Creates the actual category line -->
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $descriptionYOffset + $yOffset * ($currentRow + 1)}in" width="{$descriptionWidth + $codeWidth}in" height="0.1in" valueSource="EncounterForm.1.ProcedureCategoryName{$CurrentCategoryIndex}" class="bold" />

          <line x1="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset}in" y1="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 2)}in" x2="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth - 0.14}in" y2="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 2)}in"></line>

          <circle cx="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth - 0.05}in" cy="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2) + 0.06}in" r="0.03in" fill="none" stroke="black"/>
          
          <!-- Creates the detail lines -->
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2)}in" width="{$codeWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.ProcedureCode{$currentElement}" />
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset + $codeWidth - 0.02}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2)}in" width="{$descriptionWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.ProcedureName{$currentElement}" />

          <line x1="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth * 2 + $descriptionWidth}in" y1="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 2)}in" x2="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $descriptionWidth + $codeWidth * 2 + 0.16}in" y2="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 2)}in"></line>
        ...
        <xsl:otherwise>
          ...
          <line x1="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset}in" y1="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 1)}in" x2="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth - 0.14}in" y2="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 1)}in"></line>

          <circle cx="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth - 0.05}in" cy="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1) + 0.06}in" r="0.03in" fill="none" stroke="black"/>
          
          <!-- Creates the detail lines -->
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1)}in" width="{$codeWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.ProcedureCode{$currentElement}" />
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset + $codeWidth - 0.02}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1)}in" width="{$descriptionWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.ProcedureName{$currentElement}" />

          <line x1="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $codeWidth * 2 + $descriptionWidth}in" y1="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 1)}in" x2="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + $descriptionWidth + $codeWidth * 2 + 0.16}in" y2="{$yTopOffset + $codeYOffset + 0.10 + $yOffset * ($currentRow + 1)}in"></line>
	...
	<xsl:template name="CreateDiagnosesColumnLayout">
		...
		<xsl:variable name="yTopOffset" select="6.45"/>
		<xsl:variable name="yOffset" select="0.15625"/>
		<xsl:variable name="codeXOffset" select="0.01"/>
		...
		<xsl:variable name="descriptionYOffset" select="0.028"/>
		<xsl:variable name="codeWidth" select="0.30"/>
		<xsl:variable name="descriptionWidth" select="1.44"/>
		...
		<xsl:if test="$totalElements >= $currentElement and $maximumColumns >= $currentColumn">
			...
			<xsl:choose>
				...
				<xsl:when test="$currentCategory != $CurrentCategoryIndex">
					...
					<!-- Creates the actual category line -->
					<text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $descriptionYOffset + $yOffset * ($currentRow + 1)}in" width="{$descriptionWidth + $codeWidth}in" height="0.10in" valueSource="EncounterForm.1.DiagnosisCategoryName{$CurrentCategoryIndex}" class="bold" />

          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2)}in" font-size="6pt">
            <xsl:value-of select="$currentElement"/>
          </text>

          <circle cx="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + 0.12}in" cy="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2) + 0.06}in" r="0.03in" fill="none" stroke="black"/>
          
          <!-- Creates the detail lines -->
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2)}in" width="{$codeWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.DiagnosisCode{$currentElement}"/>
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset + $codeWidth - 0.02}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 2)}in" width="{$descriptionWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.DiagnosisName{$currentElement}"/>
          ...
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1)}in" font-size="6pt">
            <xsl:value-of select="$currentElement"/>
          </text>

          <circle cx="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $codeXOffset + 0.12}in" cy="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1) + 0.06}in" r="0.03in" fill="none" stroke="black"/>
          
          <!-- Creates the detail lines -->
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1)}in" width="{$codeWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.DiagnosisCode{$currentElement}"/>
          <text x="{$xLeftOffset + $xOffset * ($currentColumn - 1) + $descriptionXOffset + $codeWidth - 0.02}in" y="{$yTopOffset + $codeYOffset + $yOffset * ($currentRow + 1)}in" width="{$descriptionWidth}in" height="0.10in" font-size="6pt" valueSource="EncounterForm.1.DiagnosisName{$currentElement}"/>
    ...
    <xsl:variable name="ProceduresCategoryCount" select="count(data[starts-with(@id,''EncounterForm.1.ProcedureName'')])"/>
      ...
      <g id="ProcedureDetails">
        <text x="0.50in" y="2.71in" width="7.50in" height="0.10in" class="centeredtext">PROCEDURE</text>
        <text x="0.51in" y="2.86in" font-size="6pt">DIAG.</text>
        <text x="3.01in" y="2.86in" font-size="6pt">DIAG.</text>
        <text x="5.51in" y="2.86in" font-size="6pt">DIAG.</text>
        <text x="0.84in" y="2.86in" font-size="6pt">CPT</text>
        <text x="3.34in" y="2.86in" font-size="6pt">CPT</text>
        <text x="5.84in" y="2.86in" font-size="6pt">CPT</text>
        <text x="1.08in" y="2.86in" font-size="6pt">DESCRIPTION</text>
        <text x="3.58in" y="2.86in" font-size="6pt">DESCRIPTION</text>
        <text x="6.08in" y="2.86in" font-size="6pt">DESCRIPTION</text>
        <text x="2.69in" y="2.86in" font-size="6pt">FEE</text>
        <text x="5.19in" y="2.86in" font-size="6pt">FEE</text>
        <text x="7.69in" y="2.86in" font-size="6pt">FEE</text>
        <xsl:call-template name="CreateProceduresColumnLayout">
          <xsl:with-param name="maximumRowsInColumn" select="23"/>
          ...
          <xsl:with-param name="currentCategory" select="0"/>
			...
			<g id="DiagnosisDetails">
        <text x="0.50in" y="6.65in" font-size="7pt">**************************************************************************************************************DIAGNOSIS**************************************************************************************************************</text>
				<xsl:call-template name="CreateDiagnosesColumnLayout">
					<xsl:with-param name="maximumRowsInColumn" select="16"/>
      ...
      <g id="AccountBalance">
        ...
        <line x1="1.75in" y1="9.515in" x2="1.75in" y2="10.09in"></line>
        ...
        <line x1="0.50in" y1="9.8025in" x2="5.50in" y2="9.8025in"></line>
        ...
        <line x1="0.50in" y1="10.09in" x2="8.0in" y2="10.09in"></line>
      </g>

      <g id="AccountActivity">
        <text x="3.04in" y="9.40in" font-weight="bold" font-size="6pt">TODAY''S ACCOUNT ACTIVITY</text>
        <line x1="3.0in" y1="9.515in" x2="3.0in" y2="10.09in"></line>
        <text x="3.04in" y="9.545in" font-size="6pt">TODAY''S CHARGES</text>
        <line x1="4.25in" y1="9.515in" x2="4.25in" y2="10.09in"></line>
        ...
        <line x1="5.50in" y1="9.515in" x2="5.50in" y2="10.09in"></line>
      </g>
      ...
      <g id="PaymentOnAccount">
        ...
        <line x1="6.75in" y1="9.515in" x2="6.75in" y2="10.09in"></line>
        <text x="6.79in" y="9.545in" font-size="6pt">TODAY''S PAYMENT</text>
        <line x1="6.75in" y1="9.8025in" x2="8.0in" y2="9.8025in"></line>
...
WHERE PrintingFormDetailsID = 56

INSERT INTO EncounterFormType (EncounterFormTypeID, [Name], Description, SortOrder)
VALUES (37, 'One Page No Grid Lines', 'Encounter form that prints on a single page', 37)

INSERT INTO PrintingFormDetails (PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES (53, 9, 40, 'One Page No Grid Lines', 1)
  ...
  <xsl:template name="CreateProceduresColumnLayout">
    ...
    <xsl:variable name="ProceduresCategoryCount" select="count(data[starts-with(@id,''EncounterForm.1.ProcedureName'')])"/>
      ...
      <g id="ProcedureDetails">
        ...
        <line x1="0.50in" y1="5.93in" x2="8.0in" y2="5.93in" stroke="black"></line>
      </g>

			<g id="DiagnosisDetails">
        <text x="0.50in" y="5.96in" width="7.50in" height="0.10in" class="centeredtext">Diagnosis</text>
				<xsl:call-template name="CreateDiagnosesColumnLayout">
...
WHERE PrintingFormDetailsID = 53
