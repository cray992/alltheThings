-------------------------------------------------------------------------------------------------------------------
-- Case 13018: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (34, 'One Page Caduceus Ortho', 'Encounter form that prints on a single page', 34)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(50, 9, 37, 'One Page Caduceus Ortho', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
      ...
      <!-- Background image -->
	    <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://53485e16-3be0-432b-8ad5-ddad7e43dbee?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.Ortho.jpg" />
      -->
      <g>
...
WHERE PrintingFormDetailsID = 50
