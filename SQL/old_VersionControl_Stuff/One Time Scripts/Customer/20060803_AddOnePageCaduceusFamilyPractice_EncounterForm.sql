-------------------------------------------------------------------------------------------------------------------
-- Case 13017: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (33, 'One Page Caduceus Family Practice', 'Encounter form that prints on a single page', 33)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(49, 9, 36, 'One Page Caduceus Family Practice', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
      ...
      <!-- Background image -->
	    <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://691fe4dc-9101-4c9b-a418-175d0b937ce6?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.FamilyPractice.jpg" />
      -->
      <g>
        
				<g id="AccountActivity">
					<text x="4.62in" y="0.745in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.PatientBalance1"/>
				</g>
            ...
            <xsl:otherwise>
              ...
              <text x="0.40in" y="1.765in" width="2.32in" height="0.10in" valueSource="EncounterForm.1.FullPhone1"/>
				...
				<g id="AppointmentInformation">
					<text x="4.62in" y="1.405in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.AppDateTime1"/>
					<text x="4.62in" y="1.645in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.POS1"/>
					<text x="4.62in" y="1.885in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.PCP1"/>
					<text x="4.62in" y="2.125in" width="1.52in" height="0.10in" valueSource="EncounterForm.1.Provider1"/>
					<text x="6.19in" y="1.405in" width="1.96in" height="0.10in" valueSource="EncounterForm.1.TicketNumber1"/>
					<text x="6.19in" y="1.645in" width="1.96in" height="0.10in" valueSource="EncounterForm.1.Reason1"/>
          <text x="6.19in" y="1.885in" width="1.96in" height="0.10in" valueSource="EncounterForm.1.InjuryDate1"/>
				</g>

				<g id="AccountStatus">
					<text x="0.40in" y="2.4075in" width="5.74in" height="0.10in" valueSource="EncounterForm.1.AccountStatus1" />
				</g>
...
WHERE PrintingFormDetailsID = 49
