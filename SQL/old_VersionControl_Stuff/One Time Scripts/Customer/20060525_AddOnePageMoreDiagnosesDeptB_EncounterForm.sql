------------------------------------------------------------------------------------------------------------------------------------
-- Case 10889: Implement a one page, with more diagnoses and less procedures, customized encounter form for a Department B practice. 
------------------------------------------------------------------------------------------------------------------------------------

IF NOT EXISTS(SELECT EncounterFormTypeID FROM EncounterFormType WHERE EncounterFormTypeID = 21)
BEGIN
	...
	VALUES (21, 'One Page More Diagnoses', 'Encounter form that prints on a single page', 21, 1, 39, 1, 1, 1)
END

IF NOT EXISTS(SELECT PrintingFormDetailsID FROM PrintingFormDetails WHERE PrintingFormDetailsID = 39)
BEGIN
	INSERT INTO PrintingFormDetails
		(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
	VALUES
		(39, 9, 24, 'One Page More Diagnoses', 1)
END
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template name="CreateDiagnosisColumnLayout">
		...
		<xsl:variable name="xLeftOffset" select="0.495"/>
		<xsl:variable name="xOffset" select="1.875"/>
		<xsl:variable name="yTopOffset" select="4.6975"/>
		<xsl:variable name="yOffset" select=".140625"/>
		<xsl:variable name="codeXOffset" select=".03"/>
	...
	<xsl:template match="/formData/page">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
			...
			<xsl:call-template name="DrawVertLines">
				...
				<xsl:with-param name="yOffset" select="2.125"/>
				<xsl:with-param name="height" select="2.3975"/>
			...
			<g id="DiagnosisDetails">
				<rect x="0.50in" y="4.5725in" width="7.5in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt"/>
				<text x="0.55in" y="4.5725in" font-family="Arial" font-weight="bold" font-size="7pt">DIAGNOSES</text>
				<xsl:call-template name="CreateDiagnosisColumnLayout">
					<xsl:with-param name="maximumRowsInColumn" select="37"/>
					<xsl:with-param name="maximumRowsInLastColumn" select="33"/>
					<xsl:with-param name="maximumColumns" select="4"/>
			...
			<xsl:call-template name="DrawHorLines">
				<xsl:with-param name="yOffset" select="4.6975"/>
				<xsl:with-param name="maximumRows" select="37"/>
			</xsl:call-template>
			<xsl:call-template name="DrawVertLines">
				<xsl:with-param name="xOffset" select="0.5"/>
				<xsl:with-param name="yOffset" select="4.71"/>
				<xsl:with-param name="height" select="5.195"/>
				<xsl:with-param name="maximumCols" select="5"/>
			</xsl:call-template>
			<xsl:call-template name="DrawVertLines">
				<xsl:with-param name="xOffset" select="0.8125"/>
			...
			<g id="ReturnScheduleBox">
				<rect x="0.50in" y="9.965in" width="1.84375in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt"/>
				<rect x="0.50in" y="9.965in" width="1.84375in" height="0.500in" fill="none" stroke="black"/>
				<text x="0.55in" y="9.97in" font-family="Arial" font-weight="bold" font-size="7pt">RETURN SCHEDULE</text>
				<text x="0.66in" y="10.14in" width="1.751in" height="0.500in" font-family="Arial" font-weight="bold" font-size="7pt">1      2      3      4      5      6      7</text>
				<text x="0.66in" y="10.29in" width="1.751in" height="0.500in" font-family="Arial" font-weight="bold" font-size="7pt">D       W       M       Y    PRN_____</text>
			</g>
			<g id="AccountStatusBox">
				<rect x="2.40625in" y="9.965in" width="1.8125in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt"/>
				<rect x="2.40625in" y="9.965in" width="1.8125in" height="0.500in" fill="none" stroke="black"/>
				<text x="2.45625in" y="9.97in" font-family="Arial" font-weight="bold" font-size="7pt">ACCOUNT STATUS</text>
				<text x="2.56625in" y="10.125in" width="1.751in" height="0.500in" font-family="Arial Narrow" font-size="7pt"></text>
			</g>
			<g id="AccountActivityBox">
				<rect x="4.28125in" y="9.965in" width="1.8125in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt"/>
				<rect x="4.28125in" y="9.965in" width="1.8125in" height="0.500in" fill="none" stroke="black"/>
				<text x="4.33125in" y="9.97in" font-family="Arial" font-weight="bold" font-size="7pt">ACCOUNT ACTIVITY</text>
				<text x="5.18125in" y="10.14in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" class="ralignedtext">PRIOR BALANCE:</text>
				<text x="5.18125in" y="10.29in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" class="ralignedtext">TODAY''S CHARGES:</text>
				<text x="5.21125in" y="10.12in" width="0.75in" height="0.1in"  font-family="Arial Narrow" font-weight="bold" font-size="8pt" valueSource="EncounterForm.1.PatientBalance1"/>
			</g>
			<g id="PaymentOnAccountBox">
				<rect x="6.15625in" y="9.965in" width="1.84375in" height="0.125in" fill="rgb(190, 190, 190)" stroke="black" stroke-width="0.5pt"/>
				<rect x="6.15625in" y="9.965in" width="1.84375in" height="0.500in" fill="none" stroke="black"/>
				<text x="6.20625in" y="9.97in" font-family="Arial" font-weight="bold" font-size="7pt">PAYMENT ON ACCOUNT</text>
				<circle cx="6.24625in" cy="10.21in" r="0.03in" fill="none" stroke="black" />
				<circle cx="6.24625in" cy="10.36in" r="0.03in" fill="none" stroke="black" />
				<circle cx="6.67625in" cy="10.21in" r="0.03in" fill="none" stroke="black" />
				<text x="6.30625in" y="10.14in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" >CHECK</text>
				<text x="6.30625in" y="10.29in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" >CREDIT CARD</text>
				<text x="6.73625in" y="10.14in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" >CASH</text>
				<line x1="7.03125in" y1="10.09in" x2="7.03125in" y2="10.465in" stroke="black" stroke-width="0.5pt"/>
				<text x="7.50625in" y="10.14in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" class="ralignedtext">DUE:</text>
				<text x="7.50625in" y="10.29in" font-family="Arial Narrow" font-weight="bold" font-size="7pt" class="ralignedtext">PAYMENT:</text>
			</g>
			<g id="Signature">
				<rect x="6.125in" y="9.338125in" width="1.875in" height="0.5625in" fill="rgb(255, 255, 255)" stroke="black" stroke-width="0.5pt" />
				<text x="6.185in" y="9.649375in" font-family="Arial Narrow" font-size="5pt">X</text>
				<line x1="6.155in" y1="9.759375in" x2="7.97in" y2="9.759375in" stroke="black"></line>
				<text x="6.185in" y="9.789375in" font-family="Arial Narrow" font-size="5pt">PHYSICIAN''S SIGNATURE</text>
			</g>
		</svg>
	</xsl:template>
</xsl:stylesheet>'
WHERE PrintingFormDetailsID = 39