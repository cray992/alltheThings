-- HCFA with NPI Numbers - Update to make box 32 font smaller
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
  ...
  -->
	...
	<xsl:template name="GenerateProcedureSVG">
      ...
      <text x="4.39in" y="{$yProcedureLocation}in" width="0.30in" height="0.10in" valueSource="CMS1500.1.dModifier4{$currentProcedure}" />
			<text x="4.70in" y="{$yProcedureLocation}in" width="0.58in" height="0.10in" valueSource="CMS1500.1.eDiag{$currentProcedure}" />
			<text x="5.23in" y="{$yProcedureLocation}in" width="0.55in" height="0.10in" valueSource="CMS1500.1.fDollars{$currentProcedure}" class="money" />
	...
	<!--  
        ...
        Keeps track of how many rows that have been printed.
	...
	<xsl:template match="/formData/page">
      ...
      <g id="box31">
        ...
        <text x="7.23in" y="9.56in" width="1.04in" height="0.10in" valueSource="CMS1500.1.3_3Phone" class="smaller" />
				<text x="5.26in" y="9.68in" width="2.98in" height="0.10in" valueSource="CMS1500.1.3_3Provider" class="smaller" />
				<text x="5.26in" y="9.80in" width="2.98in" height="0.10in" valueSource="CMS1500.1.3_3Name" class="smaller" />
				<text x="5.26in" y="9.92in" width="2.98in" height="0.10in" valueSource="CMS1500.1.3_3Street" class="smaller" />
				<text x="5.26in" y="10.04in" width="2.98in" height="0.10in" valueSource="CMS1500.1.3_3CityStateZip" class="smaller" />
