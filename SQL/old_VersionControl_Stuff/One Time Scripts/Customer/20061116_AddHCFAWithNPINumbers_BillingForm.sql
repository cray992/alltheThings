/*
-----------------------------------------------------------------------------------------------------
CASE 14024 - Implement HCFA with NPI numbers Billing Form
-----------------------------------------------------------------------------------------------------

INSERT INTO BillingForm(BillingFormID, FormType, FormName, PrintingFormID, MaxProcedures, MaxDiagnosis)
VALUES(13, 'HCFA', 'Standard (with NPI Numbers)', 19, 6, 4)
    ...
    <formData formId="CMS1500">
      <page pageId="CMS1500.1">
        ...
        <data id="CMS1500.1.1_7bNPI">
          <xsl:value-of select="data[@id=''CMS1500.1.ReferringProviderNPI1'']" />
        </data>
        ...
        <data id="CMS1500.1.SupplementalInfo1">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode1''] = 7">
              ...
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes1'']" />
        ...
        <data id="CMS1500.1.SupplementalInfo2">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode2''] = 7">
              ...
              <xsl:text>Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes2'']" />
              <xsl:text> Minutes</xsl:text>
            </xsl:when>
        ...
        <data id="CMS1500.1.SupplementalInfo3">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode3''] = 7">
              ...
              <xsl:text>Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes3'']" />
              <xsl:text> Minutes</xsl:text>
            </xsl:when>
        ...
        <data id="CMS1500.1.SupplementalInfo4">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode4''] = 7">
              ...
              <xsl:text>Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes4'']" />
              <xsl:text> Minutes</xsl:text>
            </xsl:when>
        ...
        <data id="CMS1500.1.SupplementalInfo5">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode5''] = 7">
              ...
              <xsl:text>Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes5'']" />
              <xsl:text> Minutes</xsl:text>
            </xsl:when>
        ...
        <data id="CMS1500.1.SupplementalInfo6">
          <xsl:choose>
            <xsl:when test="data[@id=''CMS1500.1.TypeOfServiceCode6''] = 7">
              ...
              <xsl:text>Time </xsl:text>
              <xsl:value-of select="data[@id=''CMS1500.1.AnethesiaMinutes6'']" />
              <xsl:text> Minutes</xsl:text>
            </xsl:when>
...
VALUES(19, 'CMS1500 (with NPI numbers)', 'CMS 1500 Form - Version 08/05 with NPI', 'BillDataProvider_GetHCFADocumentDataWithNPINumbers', 1)

INSERT INTO PrintingFormDetails(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES(76, 19, 63, 'HCFA with NPI numbers', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template name="GenerateProcedureSVG">
		...
		<g id="box24_{$currentProcedure}">
			<text x="0.37in" y="{$yProcedureLocation}in" width="0.30in" height="0.10in" valueSource="CMS1500.1.aStartMM{$currentProcedure}" />
			...
			<text x="1.26in" y="{$yProcedureLocation}in" width="0.30in" height="0.10in" valueSource="CMS1500.1.aEndMM{$currentProcedure}" />
			...
			<text x="4.68in" y="{$yProcedureLocation}in" width="0.62in" height="0.10in" valueSource="CMS1500.1.eDiag{$currentProcedure}" class="smaller" />
	...
	<xsl:template match="/formData/page">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" printerAffinity="hcfa" formId="CMS1500" pageId="CMS1500.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
			...
			<g id="line2">
				...
				<text x="3.33in" y="1.74in" width="0.30in" height="0.10in" valueSource="CMS1500.1.3_MM" />
			...
			<g id="line7">
				...
				<text x="5.51in" y="3.40in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_1aMM" />
			...
			<g id="line8">
				<text x="0.42in" y="3.74in" width="0.30in" height="0.10in" valueSource="CMS1500.1.9_bMM" />
			...
			<g id="line13">
				...
				<text x="5.64in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8StartMM" />
				<text x="5.93in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8StartDD" />
				<text x="6.25in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8StartYY" />
				<text x="7.05in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8EndMM" />
				<text x="7.37in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8EndDD" />
				<text x="7.66in" y="5.72in" width="0.30in" height="0.10in" valueSource="CMS1500.1.1_8EndYY" />
			</g>
			<g id="line14">
				...
				<text x="6.61in" y="6.06in" width="0.80in" height="0.10in" valueSource="CMS1500.1.2_0Dollars" class="money" />
				<text x="7.38in" y="6.06in" width="0.30in" height="0.10in" valueSource="CMS1500.1.2_0Cents" />
			</g>
			<g id="box21">
			...
			<g id="box31">
				<text x="0.37in" y="9.93in" width="2.14in" height="0.10in" valueSource="CMS1500.1.3_1Signature" />
				<text x="0.37in" y="10.08in" width="2.14in" height="0.10in" valueSource="CMS1500.1.3_1ProviderName" />
				<text x="0.75in" y="10.23in" width="1.0in" height="0.10in" valueSource="CMS1500.1.3_1Date" />
			</g>
			<g id="box32">
...
WHERE PrintingFormDetailsID = 76