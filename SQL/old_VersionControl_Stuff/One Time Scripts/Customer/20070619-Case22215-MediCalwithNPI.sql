IF NOT EXISTS(SELECT BillingFormID FROM BillingForm WHERE BillingFormID = 16)
BEGIN
	INSERT INTO BillingForm (BillingFormID, FormType, FormName, PrintingFormID, MaxProcedures, MaxDiagnosis)
	VALUES(16, 'HCFA', 'Medi-Cal with NPI', 19, 6, 4)
END
	...
	<xsl:template match="/formData/page">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" printerAffinity="hcfa" formId="CMS1500" pageId="CMS1500.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
			...
			<g id="box31">
				...
				<text x="0.37in" y="10.02in" width="2.14in" height="0.10in" valueSource="CMS1500.1.3_1Signature" class="smaller" />
				<text x="0.37in" y="10.14in" width="2.14in" height="0.10in" valueSource="CMS1500.1.3_1ProviderName" class="smaller" />
				<text x="0.75in" y="10.26in" width="1.0in" height="0.10in" valueSource="CMS1500.1.3_1Date" class="smaller" />
			</g>
			<g id="box32">
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" printerAffinity="hcfa" formId="CMS1500" pageId="CMS1500.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
			...
			<g id="box31">
				<text x="0.57in" y="9.46in" width="2.08in" height="0.10in" valueSource="CMS1500.1.3_1AboveSignature" class="smaller" />
				<text x="0.57in" y="9.56in" width="2.08in" height="0.10in" valueSource="CMS1500.1.3_1Signature" class="smaller" />
				<text x="0.57in" y="9.66in" width="2.08in" height="0.10in" valueSource="CMS1500.1.3_1ProviderName" class="smaller" />
				<text x="0.95in" y="9.76in" width="1.0in" height="0.10in" valueSource="CMS1500.1.3_1Date" class="smaller" />
			</g>
			<g id="box32">
