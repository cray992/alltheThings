...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="SentinelPR2" pageId="SentinelPR2.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
  ...
  <g id="header">
    <text x="0.50in" y="0.50in">FRONTLINE MEDICAL ASSOCIATES /</text>
    <text x="3.0in" y="0.50in" width="3.10in" height="0.10in" valueSource="SentinelPR2.1.SERVICE_LOCATION1" />
    <text x="0.95in" y="0.69in">(818) 361-6104</text>
  </g>
