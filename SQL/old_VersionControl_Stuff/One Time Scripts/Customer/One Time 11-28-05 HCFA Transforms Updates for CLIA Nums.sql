			...
			<data id="CMS1500.1.2_3PriorAuth">
				<xsl:choose>
					<xsl:when test="data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MB'' or data[@id=''CMS1500.1.PayerInsuranceProgramCode1''] = ''MC''">
						<xsl:choose>
							<xsl:when test="string-length(data[@id=''CMS1500.1.FacilityCLIANumber1'']) > 0 and (//data[@id=''CMS1500.1.TypeOfServiceCode1''] = ''05'' or //data[@id=''CMS1500.1.TypeOfServiceCode2''] = ''05'' or //data[@id=''CMS1500.1.TypeOfServiceCode3''] = ''05'' or //data[@id=''CMS1500.1.TypeOfServiceCode4''] = ''05'' or //data[@id=''CMS1500.1.TypeOfServiceCode5''] = ''05'' or //data[@id=''CMS1500.1.TypeOfServiceCode6''] = ''05'')">
