--------------------------------------------------------------------------------------------------
-- Case 10919: Implement a one page customized encounter form for G.R.M.M provider Julius Jacinto. 
--------------------------------------------------------------------------------------------------
  ...
  -->
	...
	<xsl:template match="/formData/page">
        ...
        <g id="PracticeInformation">
          <text x="3.39375in" y="0.50in" font-weight="bold" font-size="9pt">FRONTLINE MEDICAL ASSOCIATES</text>
          <text x="3.8625in" y="0.62in" >JULIUS JACINTO, R.P.T</text>
          <text x="3.51875in" y="0.74in" >______San Fernando   ______Los Angeles</text>
        </g>
...
WHERE PrintingFormDetailsID = 37
