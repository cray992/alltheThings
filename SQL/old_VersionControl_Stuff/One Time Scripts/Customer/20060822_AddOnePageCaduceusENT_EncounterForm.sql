-------------------------------------------------------------------------------------------------------------------
-- Case 13582: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (44, 'One Page Caduceus ENT', 'Encounter form that prints on a single page', 44)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(60, 9, 47, 'One Page Caduceus ENT', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
  ...
  <xsl:template match="/formData/page">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="EncounterForm" pageId="EncounterForm.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="300">
      ...
      <!-- Background image -->
	    <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://00744e43-e945-4266-8fd6-f38e6ff197d8?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.ENT.jpg" />
      -->
      ...
      <g>
        ...
        <g id="PatientInformation">
          ...
          <text x="0.40in" y="2.005in" width="1.21in" height="0.10in" valueSource="EncounterForm.1.PatientID1"/>
          <text x="1.71in" y="2.005in" width="0.99in" height="0.10in" valueSource="EncounterForm.1.DOBAge1"/>
        </g>
        ...
        <g id="InsuranceCoverage">
          ...
          <text x="2.76in" y="2.005in" width="0.97in" height="0.10in" valueSource="EncounterForm.1.Copay1"/>
          <text x="3.78in" y="2.005in" width="0.78in" height="0.10in" valueSource="EncounterForm.1.Deductible1"/>
        </g>
        ...
        <g id="EncounterInformation">
          ...
          <text x="4.62in" y="2.005in" width="1.49in" height="0.10in" valueSource="EncounterForm.1.Provider1"/>
          <text x="6.17in" y="1.265in" width="1.92in" height="0.10in" valueSource="EncounterForm.1.TicketNumber1"/>
          <text x="6.17in" y="1.505in" width="1.92in" height="0.10in" valueSource="EncounterForm.1.Reason1"/>
          <text x="6.17in" y="1.755in" width="1.92in" height="0.10in" valueSource="EncounterForm.1.InjuryDate1"/>
        </g>
...
WHERE PrintingFormDetailsID = 60
