...
SET @x = '<parameters csv="false">
  ...
  <extendedParameters>
    ...
    <extendedParameter type="ComboBox" parameterName="MeasureType" text="Measure Type:" description="Select sum by amount or unit count." default="A">
      <value displayText="Amount" value="A" />
      <value displayText="Unit Count" value="U" />
    </extendedParameter>
...
where name like 'Charges Summary';