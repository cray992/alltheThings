...
INSERT INTO PrintingForm
			...
			RecipientSpecific)
VALUES(		12,
			'CMS1500 NDC (with background)',
			'CMS 1500 Form',
			'BillDataProvider_GetHCFADocumentDataWithBackground_NDCCodes_MultiForm',
			1)

-- Add new printing form detail
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" printerAffinity="hcfa" formId="CMS1500" pageId="CMS1500.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
	...
	<g id="box24_1">
		...
		<text x="2.8in" 	y="7.36in" width="1.625in" height="0.1in" valueSource="CMS1500.1.dCPT1" />
	...
	<g id="box24_2">
		...
		<text x="2.8in"  	y="7.66in" width="1.625in"  height="0.1in" valueSource="CMS1500.1.dCPT2" />
	...
	<g id="box24_3">
		...
		<text x="2.8in"  	y="8.00in" width="1.625in"  height="0.1in" valueSource="CMS1500.1.dCPT3" />
	...
	<g id="box24_4">
		...
		<text x="2.8in"  	y="8.33in" width="1.625in"  height="0.1in" valueSource="CMS1500.1.dCPT4" />
	...
	<g id="box24_5">
		...
		<text x="2.8in"  	y="8.67in" width="1.625in"  height="0.1in" valueSource="CMS1500.1.dCPT5" />
	...
	<g id="box24_6">
		...
		<text x="2.8in"  	y="9.00in" width="1.625in"  height="0.1in" valueSource="CMS1500.1.dCPT6" />
