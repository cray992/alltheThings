...
IF NOT EXISTS(SELECT EncounterFormTypeID FROM EncounterFormType WHERE EncounterFormTypeID = 9)
BEGIN
	...
	VALUES (9, 'One Page Version 2', 'Encounter form that prints on a single page', 9, 1, 23, 1, 1, 1)
END

IF NOT EXISTS(SELECT PrintingFormDetailsID FROM PrintingFormDetails WHERE PrintingFormDetailsID = 23)
BEGIN
	INSERT INTO PrintingFormDetails 
		(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
	VALUES
		(23, 9, 10, 'One Page Version 2', 1)
END
...
WHERE PrintingFormDetailsID = 23
