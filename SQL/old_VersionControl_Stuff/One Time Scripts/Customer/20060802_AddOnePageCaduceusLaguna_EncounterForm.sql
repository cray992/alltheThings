-------------------------------------------------------------------------------------------------------------------
-- Case 13015: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (30, 'One Page Caduceus Laguna', 'Encounter form that prints on a single page', 30)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(46, 9, 33, 'One Page Caduceus Laguna', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
      ...
      <!-- Background image -->
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://ee2eb220-2bb6-48ce-8154-c197aeabe409?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.Laguna.jpg" />
      -->
            ...
            <xsl:otherwise>
              ...
              <text x="0.40in" y="1.765in" width="2.32in" height="0.10in" valueSource="EncounterForm.1.FullPhone1"/>
				...
				<g id="AppointmentInformation">
					<text x="4.63in" y="1.405in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.AppDateTime1"/>
					<text x="4.63in" y="1.645in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.POS1"/>
					<text x="4.63in" y="1.885in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.RefProvider1"/>
					<text x="4.63in" y="2.125in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.Provider1"/>
...
WHERE PrintingFormDetailsID = 46
