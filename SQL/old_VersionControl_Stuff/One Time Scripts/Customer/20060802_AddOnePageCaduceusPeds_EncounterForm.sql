-------------------------------------------------------------------------------------------------------------------
-- Case 13016: Implement a one page customized encounter form for Caduceus, a practice of Department B(Customer 1). 
-------------------------------------------------------------------------------------------------------------------
...
VALUES (31, 'One Page Caduceus Peds', 'Encounter form that prints on a single page', 31)

INSERT INTO PrintingFormDetails
	(PrintingFormDetailsID, PrintingFormID, SVGDefinitionID, Description, SVGTransform)
VALUES
	(47, 9, 34, 'One Page Caduceus Peds', 1)
*/
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg">
	...
	<xsl:template match="/formData/page">
      ...
      <!-- Background image -->
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="kareodms://47c7c37f-9425-412e-b144-85f606a9e2c7?type=global" />

      <!--
      <image x="0" y="0" width="8.5in" height="11in" xlink:href="EncounterForm.OnePage.Caduceus.Peds.jpg" />
      -->
            ...
            <xsl:otherwise>
              ...
              <text x="0.40in" y="1.765in" width="2.32in" height="0.10in" valueSource="EncounterForm.1.FullPhone1"/>
				...
				<g id="AppointmentInformation">
					...
					<text x="4.63in" y="1.885in" width="1.51in" height="0.10in" valueSource="EncounterForm.1.PCP1"/>
...
WHERE PrintingFormDetailsID = 47
