...
IF  exists( select * from report where Name = 'Provider Utilization' )
BEGIN
...
ELSE BEGIN
	...
	VALUES(
		...
		'This report shows each provider’s utilization organized by timeblock.',
		'Report V2 Viewer',
		'/BusinessManagerReports/rptProviderUtilizationSummary',
		@Par,
		'Provider &Utilization',
