...
/*
-- kprod-db28
USE superbill_11271_dev;
GO
USE superbill_11271_prod;
GO
*/

IF OBJECT_ID('tempdb..#table_delete_false_rejections') IS NOT NULL 
    BEGIN
                        ...
                        INNER JOIN ( SELECT  DISTINCT
                                     ...
                                     WHERE  CT2.CreatedDate > '2/1/2012'
                                            ...
                                            AND ( CT2.Notes LIKE '%Entity acknowledges receipt of claim/encounter. Note: This code requires us%'
                                                  OR ( CT2.Notes LIKE '%Entity acknowledges receipt of claim/encounter%'
                                                       AND ( CT2.Notes LIKE '%ACK/%'
                                                             OR CT2.Notes LIKE '%Acknowledgement%'
                                                           )
                                                     )
    ...
    INSERT  INTO #table_delete_false_rejections
            ...
            WHERE   CTE2.ClaimTransactionTypeCode = 'RJT'
                    ...
                    AND ( CTE2.Notes LIKE '%Entity acknowledges receipt of claim/encounter. Note: This code requires us%'
                          OR ( CTE2.Notes LIKE '%Entity acknowledges receipt of claim/encounter%'
                               AND ( CTE2.Notes LIKE '%ACK/%'
                                     OR CTE2.Notes LIKE '%Acknowledgement%'
                                   )
                             )
