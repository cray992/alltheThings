/*
-- kprod-db24
USE superbill_7704_dev;
GO
USE superbill_7704_prod;
GO
*/
                        ...
                        INNER JOIN ( SELECT  DISTINCT
                                     ...
                                     WHERE  CT2.CreatedDate > '2/1/2012'
                                            ...
                                            AND ( CT2.Notes LIKE '%Entity acknowledges receipt of claim/encounter. Note: This code requires us%'
                                                  ...
                                                  OR CT2.Notes LIKE '%Cannot provide further status electronically Acknowledgement/Receipt  Entity acknowledges receipt of claim/encounter Acknowledgement/Receipt%'
                                                )
    ...
    INSERT  INTO #table_delete_false_rejections
            ...
            WHERE   CTE2.ClaimTransactionTypeCode = 'RJT'
                    ...
                    AND ( CTE2.Notes LIKE '%Entity acknowledges receipt of claim/encounter. Note: This code requires us%'
                          ...
                          OR CTE2.Notes LIKE '%Cannot provide further status electronically Acknowledgement/Receipt  Entity acknowledges receipt of claim/encounter Acknowledgement/Receipt%'
                        )
