/*
-----------------------------------------------------------------------------------------------------
CASE 22426 - Updated MassHealth Claim Form 5 with NPI.
-----------------------------------------------------------------------------------------------------
*/
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="MASSM5" pageId="MASSM5.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
	...
	<g>
		<!-- add 1a, 1b -->
		<text x="1.48in" y="1.35in" width="2.00in" height="0.1in" valueSource="MASSM5.1.1a_BillingProviderNPI" />
		<text x="5.00in" y="1.35in" width="2.00in" height="0.1in" valueSource="MASSM5.1.1b_BillingProviderTaxonomyCode" />
	
		<text x="0.28in" y="1.67in" width="3.10in" height="0.1in" valueSource="MASSM5.1.1c_MemberName" />
		<text x="3.48in" y="1.67in" width="1.80in" height="0.1in" valueSource="MASSM5.1.2_PatientBirthDate" />
		<text x="5.32in" y="1.67in" width="2.96in" height="0.1in" valueSource="MASSM5.1.3_InsuredName" />
		<text x="0.28in" y="1.93in" width="3.17in" height="0.1in" valueSource="MASSM5.1.4_MemberAddress_Street" />
		<text x="0.28in" y="2.08in" width="3.17in" height="0.1in" valueSource="MASSM5.1.4_MemberAddress_CityStateZip" />
		<text x="1.22in" y="2.35in" width="2.21in" height="0.1in" valueSource="MASSM5.1.4_MemberTelephone" />
		<text x="3.68in" y="1.98in" width="0.17in" height="0.1in" valueSource="MASSM5.1.5_PatientGender_Male" />
		<text x="4.36in" y="1.98in" width="0.17in" height="0.1in" valueSource="MASSM5.1.5_PatientGender_Female" />
		<text x="5.32in" y="2.00in" width="2.96in" height="0.1in" valueSource="MASSM5.1.6_PolicyNumber" />
		<text x="3.56in" y="2.35in" width="0.15in" height="0.1in" valueSource="MASSM5.1.7_MemberRelationshipToInsured_Self" />
		<text x="3.98in" y="2.35in" width="0.18in" height="0.1in" valueSource="MASSM5.1.7_MemberRelationshipToInsured_Spouse" />
		<text x="4.38in" y="2.35in" width="0.17in" height="0.1in" valueSource="MASSM5.1.7_MemberRelationshipToInsured_Child" />
		<text x="4.77in" y="2.35in" width="0.17in" height="0.1in" valueSource="MASSM5.1.7_MemberRelationshipToInsured_Other" />
		<text x="5.32in" y="2.35in" width="2.96in" height="0.1in" valueSource="MASSM5.1.8_GroupNumber" />
		<text x="0.45in" y="2.62in" width="0.18in" height="0.1in" valueSource="MASSM5.1.9_MemberOtherHealthIns_YES" />
		<text x="0.96in" y="2.62in" width="0.17in" height="0.1in" valueSource="MASSM5.1.9_MemberOtherHealthIns_NO" />
		<text x="0.28in" y="2.96in" width="3.18in" height="0.1in" valueSource="MASSM5.1.9_MemberOtherHealthIns_AddressStreet" />
		<text x="0.28in" y="3.11in" width="3.18in" height="0.1in" valueSource="MASSM5.1.9_MemberOtherHealthIns_AddressCityStateZip" />
		<text x="3.7in"  y="2.82in" width="0.19in" height="0.1in" valueSource="MASSM5.1.10_MemberCondition_Employment_YES" />
		<text x="4.38in" y="2.82in" width="0.18in" height="0.1in" valueSource="MASSM5.1.10_MemberCondition_Employment_NO" />
		<text x="3.7in"  y="3.16in" width="0.17in" height="0.1in" valueSource="MASSM5.1.10_MemberCondition_Accident_Auto" />
		<text x="4.38in" y="3.16in" width="0.18in" height="0.1in" valueSource="MASSM5.1.10_MemberCondition_Accident_Other" />
		<text x="5.32in" y="2.62in" width="2.96in" height="0.1in" valueSource="MASSM5.1.11_InsuredAddress_Street" />
		<text x="5.32in" y="2.77in" width="2.96in" height="0.1in" valueSource="MASSM5.1.11_InsuredAddress_CityStateZip" />
		<text x="0.38in" y="3.56in" width="3.35in" height="0.1in" valueSource="MASSM5.1.12_Signature" />
		<text x="3.9in"  y="3.56in" width="1.40in" height="0.1in" valueSource="MASSM5.1.12_Date" />
		<text x="5.32in" y="3.56in" width="1.90in" height="0.1in" valueSource="MASSM5.1.13_Signature" />
		<text x="7.22in" y="3.56in" width="0.96in" height="0.1in" valueSource="MASSM5.1.13_Date" />
		
		
		<text x="0.28in" y="4.03in" width="1.36in" height="0.1in" valueSource="MASSM5.1.14_CurrentIllnessDate" />
		<text x="3.48in" y="4.03in" width="1.49in" height="0.1in" valueSource="MASSM5.1.15_FirstConsultationDate" />
		<text x="5.58in" y="4.03in" width="0.19in" height="0.1in" valueSource="MASSM5.1.16_SimilarSymptoms_YES" />
		<text x="6.23in" y="4.03in" width="0.19in" height="0.1in" valueSource="MASSM5.1.16_SimilarSymptoms_NO" />
		<text x="7.6in" y="4.03in" width="0.19in" height="0.1in" valueSource="MASSM5.1.16a_Emergency" />
		<text x="0.28in" y="4.37in" width="1.49in" height="0.1in" valueSource="MASSM5.1.17_ReturnToWorkDate" />
		<text x="2.1in" y="4.37in" width="1.40in" height="0.1in" valueSource="MASSM5.1.18_TotalDisabilityBeginDate" />
		<text x="3.94in" y="4.37in" width="1.40in" height="0.1in" valueSource="MASSM5.1.18_TotalDisabilityEndDate" />
		<text x="5.62in" y="4.37in" width="1.20in" height="0.1in" valueSource="MASSM5.1.18_PartialDisabilityBeginDate" />
		<text x="7.4in" y="4.37in" width="0.96in" height="0.1in" valueSource="MASSM5.1.18_PartialDisabilityEndDate" />
		<text x="0.28in" y="4.70in" width="3.38in" height="0.1in" valueSource="MASSM5.1.19a_ReferringPhyscianName" />
		<text x="3.67in" y="4.70in" width="1.62in" height="0.1in" valueSource="MASSM5.1.19b_ReferringProviderNumber" />
		<text x="5.81in" y="4.70in" width="1.08in" height="0.1in" valueSource="MASSM5.1.20_HospitalizationBeginDate" />
		<text x="7.51in" y="4.70in" width="0.76in" height="0.1in" valueSource="MASSM5.1.20_HospitalizationEndDate" />
		<text x="0.28in" y="5.02in" width="5.03in" height="0.1in" valueSource="MASSM5.1.21_FacilityName" />
		<text x="5.59in" y="5.02in" width="0.17in" height="0.1in" valueSource="MASSM5.1.22_LabWork_External_YES" />
		<text x="6.2in" y="5.02in" width="0.19in" height="0.1in" valueSource="MASSM5.1.22_LabWork_External_NO" />
		<text x="7.41in" y="5.02in" width="0.97in" height="0.1in" valueSource="MASSM5.1.22_LabWork_External_Charges" />


		<text x="0.26in" y="5.49in" width="2.00in" height="0.1in" valueSource="MASSM5.1.23_RenderingProviderNPI" />
		<text x="2.60in" y="5.49in" width="2.00in" height="0.1in" valueSource="MASSM5.1.23a_RenderingProviderTaxonomyCode" />
		
		<text x="6.84in" y="5.27in" width="0.19in" height="0.1in" valueSource="MASSM5.1.23b_Screen" />
		<text x="7.6in" y="5.27in" width="0.19in" height="0.1in" valueSource="MASSM5.1.23b_Referral" />
		<text x="6.84in" y="5.49in" width="0.19in" height="0.1in" valueSource="MASSM5.1.23c_FamilyPlanning" />
		<text x="6.86in" y="5.83in" width="1.40in" height="0.1in" valueSource="MASSM5.1.23d_AuthorizationNumber" />
	</g>
	<g class="smaller">
  ...
  <xsl:template match="/formData/page">
    <formData formId="MASSM5">
      <page pageId="MASSM5.1">
        ...
        <data id="MASSM5.1.1a_BillingProviderNPI">
          <xsl:value-of select="data[@id=''MASSM5.1.BillingProviderNPI1'']" />
        </data>
        <data id="MASSM5.1.1b_BillingProviderTaxonomyCode">
          <xsl:value-of select="data[@id=''MASSM5.1.BillingProviderTaxonomyCode1'']" />
        </data>
        <data id="MASSM5.1.1c_MemberName">
        ...
        <data id="MASSM5.1.23_RenderingProviderNPI">
          <xsl:value-of select="data[@id=''MASSM5.1.RenderingProviderNPI1'']" />
        </data>
        <data id="MASSM5.1.23a_RenderingProviderTaxonomyCode">
          <xsl:value-of select="data[@id=''MASSM5.1.RenderingProviderTaxonomyCode1'']" />
        </data>
