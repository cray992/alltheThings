/*
-----------------------------------------------------------------------------------------------------
CASE 21386 - Add Medicaid number.
-----------------------------------------------------------------------------------------------------
*/
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" formId="NYM" pageId="NYM.1" width="8.5in" height="11in" topOffset="0.0in" leftOffset="0.0in" dpi="200">
    ...
    <text x="6.55in" y="1.09in" width="1.24in" height="0.1in" valueSource="NYM.1.6A_MedicaidNumber" />
	...
	<g class="smaller">
		<text x="0.13in" y="6.09in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate1" />
    ...
    <text x="0.13in" y="6.405in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate2" />
    ...
    <text x="0.13in" y="6.72in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate3" />
    ...
    <text x="0.13in" y="7.03in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate4" />
    ...
    <text x="0.13in" y="7.345in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate5" />
    ...
    <text x="0.13in" y="7.66in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate6" />
    ...
    <text x="0.13in" y="7.975in" width="0.83in" height="0.10in" text-anchor="end" valueSource="NYM.1.24A_ServiceBeginDate7" />
      ...
      <page pageId="NYM.1">
        ...
        <xsl:if test="data[@id=''NYM.1.OtherInsuranceType1''] != ''MC'' and data[@id=''NYM.1.OtherInsuranceType1''] != ''MB''">
          ...
          <data id="NYM.1.9_OtherInsuredAddress_CityStateZip">
            <xsl:choose>
              <xsl:when test="data[@id=''NYM.1.OtherSubscriberDifferentFlag1''] = ''1''">
                <xsl:if test="string-length(data[@id=''NYM.1.OtherSubscriberCity1'']) &gt; 0">
              ...
              <xsl:otherwise>
                <xsl:if test="string-length(data[@id=''NYM.1.PatientCity1'']) &gt; 0">
