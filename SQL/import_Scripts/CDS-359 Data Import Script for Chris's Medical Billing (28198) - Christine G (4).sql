...
PRINT 'Inserting into Insurance Company...'
      ...
      FROM dbo._import_23_4_Insurances
...
PRINT 'Inserting into Insurance Company Plan...'
      ...
      SELECT DISTINCT
                    ...
                    @VendorImportID  -- VendorImportID - int
      FROM dbo._import_23_4_Insurances AS impIns
...
PRINT 'Inserting into Referring Doctor...'
      ...
      SELECT DISTINCT
                    ...
                    1  -- External - bit
      FROM dbo._import_23_4_ReferringPhys AS impRph
...
PRINT 'Inserting into Patient...'
      ...
      FROM dbo._import_23_4_PatientData AS impPat
      LEFT OUTER JOIN dbo._import_23_4_Providers AS impPro ON
...
FROM dbo.[_import_23_4_CaseInformation] AS impCas
...
INSERT INTO dbo.InsurancePolicy
      ...
      INNER JOIN 
            ...
            FROM dbo._import_23_4_PatientData) AS holder ON
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_23_4_StandardFeeSchedule AS Impsfs
...
INNER JOIN dbo.[_import_23_4_CaseInformation] impCas ON
	impCas.chartnumber = pat.VendorID
INNER JOIN dbo.[_import_23_4_PatientData] impPat ON
...
impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_23_4_CaseInformation] WHERE
...
--	impPat.chartnumber = impCas.guarantor
--WHERE impCas.chartnumber <> '' AND pat.PracticeID = @PracticeID AND pat.VendorImportID = @VendorImportID AND 
--impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_23_4_CaseInformation] WHERE impCas.studentstatus <> '' AND impCas.employmentstatus = '' ORDER BY impCas.chartnumber DESC)
--PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'
