...
SET @PracticeID4 = 4
SET @Practice4VendorImportID = 4

PRINT ''
PRINT ''
PRINT 'PracticeID = ' + CAST(@PracticeID4 AS VARCHAR(10))
PRINT 'VendorImportID = ' + CAST(@Practice4VendorImportID AS VARCHAR(10))

--DELETE FROM dbo.InsurancePolicy WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Policy records deleted'
--DELETE FROM dbo.InsuranceCompanyPlan WHERE VendorImportID = @Practice4VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company Plan records deleted'
--DELETE FROM dbo.InsuranceCompany WHERE VendorImportID = @Practice4VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company records deleted'
--DELETE FROM dbo.PatientCaseDate WHERE PatientCaseID IN (SELECT PatientCaseID FROM dbo.PatientCase WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case Date records deleted'
--DELETE FROM dbo.PatientCase WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case records deleted'
--DELETE FROM dbo.PatientAlert WHERE PatientID IN (SELECT PatientID FROM dbo.Patient WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Alert records deleted'
--DELETE FROM dbo.Patient WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient records deleted'
--DELETE FROM dbo.Doctor WHERE PracticeID = @PracticeID4 AND VendorImportID = @Practice4VendorImportID
...
FROM dbo.[_import_4_4_InsuranceMaster] i
...
WHERE VendorImportID = @Practice4VendorImportID 
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
FROM dbo.[_import_4_4_ReferringMaster]
...
FROM dbo.[_import_4_4_CPCPediatrics4] i
	LEFT JOIN dbo.Doctor rd ON
		i.patientreferringcode = rd.VendorID AND
		rd.VendorImportID = @Practice4VendorImportID
...
FROM dbo.[_import_4_4_CPCPediatrics4] i
	INNER JOIN dbo.Patient p ON
		...
		p.VendorImportID = @Practice4VendorImportID
...
FROM dbo.[_import_4_4_PolicyMaster] i
	INNER JOIN dbo.PatientCase pc ON
		i.policyaccountnumber = pc.VendorID AND
		pc.VendorImportID = @Practice4VendorImportID
	INNER JOIN dbo.InsuranceCompanyPlan icp ON
		i.policyinsurancecode = icp.VendorID AND
		icp.CreatedPracticeID = @PracticeID4
...
UPDATE dbo.PatientCase 
      ...
      WHERE pc.VendorImportID = @Practice4VendorImportID AND
