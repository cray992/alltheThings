--USE superbill_49078_dev
USE superbill_49078_prod
GO
...
UPDATE dbo.[_import_1_1_Doctor] SET NPI = '1922056043' WHERE FirstName = 'Lisa' AND LastName = 'King' AND [External] = 0 AND PracticeID = @SourcePracticeID
...
SELECT DISTINCT
          ...
          CASE WHEN d.DoctorID IS NULL THEN (SELECT DoctorID FROM dbo.Doctor WHERE FirstName = 'LISA' AND LastName = 'KING' AND [External] = 0 AND ActiveDoctor = 1)
