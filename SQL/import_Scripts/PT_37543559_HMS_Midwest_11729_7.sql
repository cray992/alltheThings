...
SET @PracticeID = 7
SET @VendorImportID = 29 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_29_7_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_29_7_Patient] pat
...
FROM dbo._import_29_7_PatientNotes pjn
...
LEFT JOIN dbo.[_import_29_7_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_29_7_FeeSchedule] impFS
...
FROM dbo.[_import_29_7_Patient] pa
LEFT JOIN dbo.Patient realP ON	
