...
SELECT COUNT(DiagnosisCode) AS CntCode, OfficialName, DiagnosisCode
FROM xDiagnosisCodeDictionary
GROUP BY OfficialName, DiagnosisCode
...
AND xDiagnosisCodeDictionary.DiagnosisCode IS NOT NULL
