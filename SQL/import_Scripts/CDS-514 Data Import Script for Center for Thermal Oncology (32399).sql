USE superbill_32399_dev
--USE superbill_32399_prod
go
...
SET ReviewCode = 'R'
FROM dbo.[_import_4_4_InsurancePolicy] i
...
FROM dbo.Doctor d
INNER JOIN dbo.[_import_4_4_Providers] i ON
...
SELECT DISTINCT
          ...
          1 ,
          i.NPI 
FROM dbo.[_import_4_4_Providers] i
...
FROM dbo.[_import_4_4_PatientCase] pc
...
FROM dbo.[_import_4_4_PatientJournalNote] pjn
	INNER JOIN dbo.Patient p ON
...
FROM dbo.[_import_4_4_InsurancePolicy] ip
