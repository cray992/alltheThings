--05292006 kdev01_0218 HCPlus - New Coastal EMS import script (test) - includes Facilities imported as referring physicians
-- PracticeID = 31
-- VendorImportID = ? -- 26
...
FROM Doctor D INNER JOIN Coastal_mwadd a
ON D.VendorImportID=@VendorImportID AND D.VendorID=a.Code 
WHERE LTRIM(RTRIM(UPIN))<> '' AND [External] = 1
*/
