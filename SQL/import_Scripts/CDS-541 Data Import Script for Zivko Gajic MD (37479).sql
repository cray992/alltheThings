USE superbill_37479_dev
--USE superbill_37479_prod
go
...
DELETE FROM dbo.CollectionCategory WHERE CreatedDate = '2015-04-17 12:32:42.743'
PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Collection Category records deleted'
...
PRINT ''
PRINT 'Updating Colection Category...'
UPDATE dbo.CollectionCategory 
SET   [CollectionCategoryName] = i.CollectionCategoryName ,
      [Description] = i.[Description] ,
      [SendStatement] = i.SendStatement ,
      [IsDefaultCategory] = i.IsDefaultCategory ,
      [DunningMessage] = i.dunningmessage ,
      [Notes] = i.notes ,
      [ModifiedDate] = GETDATE() ,
      [ShowAlert] = i.showalert ,
      [AlertMessage] = i.alertmessage 
FROM dbo.CollectionCategory c
	INNER JOIN dbo.[_import_1_1_CollectionCategory] i ON
		i.collectioncategoryid = c.CollectionCategoryID
...
WHERE i.collectioncategoryid NOT IN (1,2)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		a.[Subject] = LEFT(i.appointmentid + ' ' + i.[subject],64) AND
		a.PracticeID = @PracticeID
WHERE i.practiceresource1 = ''
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 1 of 6...'
...
FROM dbo.[_import_1_1_Appointment] i
	...
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason1 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 2 of 6...'
INSERT INTO dbo.AppointmentToAppointmentReason
        ( AppointmentID ,
          AppointmentReasonID ,
          PrimaryAppointment ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason2 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 3 of 6...'
INSERT INTO dbo.AppointmentToAppointmentReason
        ( AppointmentID ,
          AppointmentReasonID ,
          PrimaryAppointment ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason3 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 4 of 6...'
INSERT INTO dbo.AppointmentToAppointmentReason
        ( AppointmentID ,
          AppointmentReasonID ,
          PrimaryAppointment ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason4 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 5 of 6...'
INSERT INTO dbo.AppointmentToAppointmentReason
        ( AppointmentID ,
          AppointmentReasonID ,
          PrimaryAppointment ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason5 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Appointment Reason 6 of 6...'
INSERT INTO dbo.AppointmentToAppointmentReason
        ( AppointmentID ,
          AppointmentReasonID ,
          PrimaryAppointment ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.AppointmentReason ar ON
		ar.Name = i.reason6 AND
		ar.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Resource - Practice Resource 1 of 4...'
INSERT INTO dbo.AppointmentToResource
        ( AppointmentID ,
          AppointmentResourceTypeID ,
          ResourceID ,
...
FROM dbo.[_import_1_1_Appointment] i
	...
	INNER JOIN dbo.PracticeResource pr ON	
		pr.ResourceName = i.practiceresource1 AND
		pr.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Resource - Practice Resource 2 of 4...'
INSERT INTO dbo.AppointmentToResource
        ( AppointmentID ,
          AppointmentResourceTypeID ,
          ResourceID ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.PracticeResource pr ON	
		pr.ResourceName = i.practiceresource2 AND
		pr.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Resource - Practice Resource 3 of 4...'
INSERT INTO dbo.AppointmentToResource
        ( AppointmentID ,
          AppointmentResourceTypeID ,
          ResourceID ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.PracticeResource pr ON	
		pr.ResourceName = i.practiceresource3 AND
		pr.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Inserting Into Appointment to Resource - Practice Resource 4 of 4...'
INSERT INTO dbo.AppointmentToResource
        ( AppointmentID ,
          AppointmentResourceTypeID ,
          ResourceID ,
...
FROM dbo.[_import_1_1_Appointment] i
	INNER JOIN dbo.Appointment a ON
		...
		a.PracticeID = @PracticeID
	INNER JOIN dbo.PracticeResource pr ON	
		pr.ResourceName = i.practiceresource4 AND
		pr.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
