...
SET @PracticeID = 15
SET @VendorImportID = 18 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_18_15_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_18_15_Patient] pat
...
FROM dbo._import_18_15_PatientNotes pjn
...
LEFT JOIN dbo.[_import_18_15_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_18_15_FeeSchedule] impFS
...
FROM dbo.[_import_18_15_Patient] pa
LEFT JOIN dbo.Patient realP ON	
