...
WHERE i.PracticeID = @SourcePracticeID AND i.DoctorID = 2 -- Inserting Dr. Joesph Franklin 
...
INNER JOIN dbo._import_1_1_CollectionCategory cc ON 
...
INNER JOIN dbo._import_1_1_AppointmentToResource atr ON 
	a.AppointmentID = atr.AppointmentID AND
	atr.PracticeID = @SourcePracticeID AND
	atr.AppointmentResourceTypeID = 1
WHERE p.PracticeID = @SourcePracticeID AND atr.ResourceID = 2 -- Dr. Joseph Franklin
...
DROP TABLE #tempdoc , #tempsl , #apptreason , #appttopracres , #colcat
