--USE superbill_17971_dev
USE superbill_17971_prod
GO
...
SELECT DISTINCT
		  11089 , -- InsuranceCompanyName - varchar(128)
          ...
          insurance , -- VendorID - varchar(50)
          @VendorImportID , -- VendorImportID - int
          1 , -- NDCFormat - int
          1 , -- UseFacilityID - bit
          'U' , -- AnesthesiaType - varchar(1)
          18  -- InstitutionalBillingFormID - int
FROM dbo.[_import_1_2_InsuranceList]
...
WHERE mrnum NOT IN (1090157,3009485,3062869,3110743)
...
WHERE ip.memberid <> '' AND
	  ip.mrnum NOT IN (1090157,3009485,3062869,3110743)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
