...
SET @PracticeID = 8
SET @VendorImportID = 27 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_27_8_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_27_8_Patient] pat
...
FROM dbo._import_27_8_PatientNotes pjn
...
LEFT JOIN dbo.[_import_27_8_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_27_8_FeeSchedule] impFS
...
FROM dbo.[_import_27_8_Patient] pa
LEFT JOIN dbo.Patient realP ON	
