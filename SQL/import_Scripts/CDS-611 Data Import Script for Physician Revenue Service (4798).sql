USE superbill_4798_dev
--USE superbill_4798_prod
GO
...
FROM dbo.Doctor d
INNER JOIN dbo.[_import_1_7_Doctor] i ON
...
FROM dbo.[_import_1_7_PatientAlert] pa
...
SELECT DISTINCT
          ...
          pjn.NoteTypeCode ,
          pjn.lastnote 
FROM dbo.[_import_1_7_PatientJournalNote] pjn
	INNER JOIN dbo.Patient p ON
...
FROM dbo._import_1_7_Patient pd
INNER JOIN dbo.Patient p ON 
	p.VendorID = pd.PatientID AND
