USE superbill_5030_dev
--USE superbill_5030_prod
go
...
FROM dbo.[_import_2_22_InsuranceCompany] i
...
FROM dbo.[_import_2_22_PracticeToInsuranceCompany] ptic
...
SELECT DISTINCT
          ...
          @VendorImportID 
FROM dbo.[_import_2_22_InsuranceCompanyPlan] i
	INNER JOIN dbo.InsuranceCompany ic ON 
...
FROM dbo.Doctor d
INNER JOIN dbo.[_import_2_22_Providers] i ON
...
SELECT DISTINCT
          ...
          1 ,
          i.NPI 
FROM dbo.[_import_2_22_Providers] i
...
FROM dbo.[_import_2_22_ServiceLocation] 
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted...'
...
FROM dbo.[_import_2_22_Patient] p
...
FROM dbo.[_import_2_22_PatientCase] pc
...
FROM dbo.[_import_2_22_PatientAlert] pa
	INNER JOIN dbo.Patient p ON
...
FROM dbo.[_import_2_22_PatientJournalNote] pjn
	INNER JOIN dbo.Patient p ON
...
FROM dbo.[_import_2_22_InsurancePolicy] ip
...
SELECT DISTINCT
          ...
          @VendorImportID  -- VendorImportID - int
FROM dbo.[_import_2_22_InsurancePolicyAuthorization] i
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          GETDATE()  -- CreatedDate - datetime
FROM dbo.[_import_2_22_PracticeResource] i
...
SELECT DISTINCT
          ...
          GETDATE()  -- ModifiedDate - datetime
FROM dbo.[_import_2_22_AppointmentReason] i
...
FROM dbo.[_import_2_22_Appointment] i
	INNER JOIN dbo.Patient p ON
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo.[_import_2_22_ContractsAndFeesStandardFee] AS i
