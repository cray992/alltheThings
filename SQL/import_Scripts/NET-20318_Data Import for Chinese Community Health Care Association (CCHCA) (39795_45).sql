...
FROM _import_89_46_InsuranceCOMPANYPLANList ICP 
...
FROM dbo._import_89_46_InsuranceCOMPANYPLANList i
INNER JOIN dbo.InsuranceCompany ic ON 
...
SELECT DISTINCT
	...
	insuranceid,  -- VendorID - varchar(50) --FIX
	@VendorImportID -- VendorImportID - int
FROM dbo._import_89_46_InsuranceCOMPANYPLANList ICP 
INNER JOIN dbo.InsuranceCompany IC ON 
...
/*
==========================================================================================================================================
CREATE INSURANCE COMPANIES FROM [_import_89_46_InsuranceCOMPANYPLANList]
==========================================================================================================================================
*/	
...
FROM dbo._import_89_46_InsuranceCOMPANYPLANList AS IICL
...
FROM dbo._import_89_46_ReferringDoctors AS RP 
...
FROM dbo._import_89_46_PatientDemographics AS PD
...
FROM dbo._import_89_46_PatientDemographics pd
...
(	SELECT DISTINCT 
	...
	FROM dbo._import_89_46_PatientDemographics
...
PRINT 'Inserting Into Appointment...'
	...
	FROM dbo._import_89_46_PatientAppointments PA
...
LEFT JOIN dbo.InsurancePolicy ip ON 
	pc.PatientCaseID = ip.PatientCaseID AND ip.PracticeID = @PracticeID AND ip.VendorImportID = @VendorImportID
WHERE 
	pc.VendorImportID = @VendorImportID AND 
	pc.PracticeID = @PracticeID AND
	pc.PayerScenarioID <> 11 AND 
