...
SELECT DISTINCT
          ...
          @VendorImportID 
		  --SELECT * 
FROM dbo._import_3_1_balanceforward i
...
INNER JOIN patient p ON 
	e.VendorID = p.PatientID
INNER JOIN dbo._import_3_1_balanceforward i ON
	p.FirstName = i.firstname AND 
	p.lastname = i.lastname  
