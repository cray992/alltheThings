USE superbill_49997_prod
--USE superbill_49997_dev
GO
...
PRINT ''
PRINT 'Updating Into Practice...'
UPDATE dbo.Practice 
SET
		  Name = i.Name , 
          EIN = i.ein ,
          MedicareGroupProviderNumber  = i.MedicareGroupProviderNumber ,-- varchar(32)
          AdministrativeContactPrefix = i.AdministrativeContactPrefix ,-- varchar(16)
          AdministrativeContactFirstName = i.AdministrativeContactFirstName ,-- varchar(64)
          AdministrativeContactMiddleName = i.AdministrativeContactMiddleName ,-- varchar(64)
          AdministrativeContactLastName = i.AdministrativeContactLastName ,-- varchar(64)
          AdministrativeContactSuffix = i.AdministrativeContactSuffix ,-- varchar(16)
          AdministrativeContactPhone = i.AdministrativeContactPhone ,-- varchar(10)
          AdministrativeContactEmailAddress = i.AdministrativeContactEmailAddress ,-- varchar(256)
          AddressLine1 = i.AddressLine1 ,-- varchar(256)
          AddressLine2 = i.AddressLine2 ,-- varchar(256)
          City = i.City ,-- varchar(128)
          State = i.State ,-- varchar(2)
          Country = i.Country ,-- varchar(32)
          ZipCode = i.ZipCode ,-- varchar(9)
          Phone = i.Phone ,-- varchar(10)
          PhoneExt = i.PhoneExt ,-- varchar(10)
          Fax = i.Fax ,-- varchar(10)
          FaxExt = i.FaxExt ,-- varchar(10)
          WebSite = i.WebSite ,-- varchar(128)
          Notes = i.Notes ,-- text
          BillingAddressLine1 = i.BillingAddressLine1 ,-- varchar(256)
          BillingAddressLine2 = i.BillingAddressLine2 ,-- varchar(256)
          BillingCity = i.BillingCity ,-- varchar(128)
          BillingState = i.BillingState ,-- varchar(2)
          BillingCountry = i.BillingCountry ,-- varchar(32)
          BillingZipCode = i.BillingZipCode ,-- varchar(9)
          BillingPhone = i.BillingPhone ,-- varchar(10)
          BillingPhoneExt = i.BillingPhoneExt ,-- varchar(10)
          BillingEmailAddress = i.BillingEmailAddress ,-- varchar(256)
          AdministrativeContactPhoneExt = i.AdministrativeContactPhoneExt ,-- varchar(10)
          EnrolledForEStatements = i.EnrolledForEStatements ,-- bit
          EClaimsSendEnabled = i.EClaimsSendEnabled ,-- bit
          EStatementsSendEnabled = i.EStatementsSendEnabled ,-- bit
          EStatementsSendInTestMode = i.EStatementsSendInTestMode ,-- bit
          EStatementsLogin = i.EStatementsLogin ,-- varchar(32)
          EStatementsPassword = i.EStatementsPassword ,-- varchar(32)
          EStatementsNotes = i.EStatementsNotes ,-- text
          EmailAddress = i.EmailAddress ,-- varchar(256)
          AdministrativeContactAddressLine1 = i.AdministrativeContactAddressLine1 ,-- varchar(256)
          AdministrativeContactAddressLine2 = i.AdministrativeContactAddressLine2 ,-- varchar(256)
          AdministrativeContactCity = i.AdministrativeContactCity ,-- varchar(128)
          AdministrativeContactState = i.AdministrativeContactState ,-- varchar(2)
          AdministrativeContactCountry = i.AdministrativeContactCountry ,-- varchar(32)
          AdministrativeContactZipCode = i.AdministrativeContactZipCode ,-- varchar(9)
          AdministrativeContactFax = i.AdministrativeContactFax ,-- varchar(10)
          AdministrativeContactFaxExt = i.AdministrativeContactFaxExt ,-- varchar(10)
          BillingContactPrefix = i.BillingContactPrefix ,-- varchar(16)
          BillingContactFirstName = i.BillingContactFirstName ,-- varchar(64)
          BillingContactMiddleName = i.BillingContactMiddleName ,-- varchar(64)
          BillingContactLastName = i.BillingContactLastName ,-- varchar(64)
          BillingContactSuffix = i.BillingContactSuffix ,-- varchar(16)
          BillingFax = i.BillingFax ,-- varchar(10)
          BillingFaxExt = i.BillingFaxExt ,-- varchar(10)
          EClaimsEnrollmentStatusID = i.EClaimsEnrollmentStatusID ,-- int
          EClaimsNotes = i.EClaimsNotes ,-- text
          CalendarIntervalMinutes = i.CalendarIntervalMinutes ,-- int
          CalendarUseAppointmentPrimaryReasonColor = i.CalendarUseAppointmentPrimaryReasonColor ,-- bit
          Active = i.Active ,-- bit
          ProcedureModifiersNumber = i.ProcedureModifiersNumber ,-- int
          EStatementsVendorId = i.EStatementsVendorId ,-- int
          CalendarUseTimeblockColor = i.CalendarUseTimeblockColor ,-- bit
          CalendarShowTimeblockLegend = i.CalendarShowTimeblockLegend ,-- bit
          DNIS = i.DNIS ,-- char(10)
          EStatementsPreferredPrintFormatId = i.EStatementsPreferredPrintFormatId ,-- int
          EStatementsPreferredElectronicFormatId = i.EStatementsPreferredElectronicFormatId ,-- int
          EStatementsCustomText1 = i.EStatementsCustomText1 ,-- text
          EStatementsCustomText2 = i.EStatementsCustomText2 ,-- text
          EnforceTimeblockRules = i.EnforceTimeblockRules ,-- bit
          NPI = i.NPI ,-- varchar(10)
          EOSchedulingProviderID = i.EOSchedulingProviderID ,-- int
          EORenderingProviderID = i.EORenderingProviderID ,-- int
          EOSupervisingProviderID = i.EOSupervisingProviderID ,-- int
          EOServiceLocationID = i.EOServiceLocationID ,-- int
          EOShowProcedureDescription = i.EOShowProcedureDescription ,-- bit
          EOShowDiagnosisDescription = i.EOShowDiagnosisDescription ,-- bit
          EOPopulateCopay = i.EOPopulateCopay ,-- bit
          EditionTypeID = i.EditionTypeID ,-- int
          SupportTypeID = i.SupportTypeID ,-- int
          Metrics = i.Metrics ,-- bit
          EStatementsMinimumAllowableBalance = i.EStatementsMinimumAllowableBalance ,-- money
          EStatementsDaysBetweenStatements = i.EStatementsDaysBetweenStatements ,-- int
          PracticeAddressTypeID = i.PracticeAddressTypeID ,-- int
          RemitAddressTypeID = i.RemitAddressTypeID ,-- int
          VisaAccepted = i.VisaAccepted ,-- bit
          MastercardAccepted = i.MastercardAccepted ,-- bit
          AmexAccepted = i.AmexAccepted ,-- bit
          DiscoverAccepted = i.DiscoverAccepted ,-- bit
          OfficeHours = i.OfficeHours ,-- varchar(50)
          EligibilityDefaultProviderID = i.EligibilityDefaultProviderID ,-- int
          EligibilityAlwaysUseDefaultProvider = i.EligibilityAlwaysUseDefaultProvider ,-- bit
          EStatementsShowPracticeNameInReturnAddress = i.EStatementsShowPracticeNameInReturnAddress ,-- bit
          MetricDRO = i.MetricDRO ,-- decimal
          AppointmentRemindersEnabled = i.AppointmentRemindersEnabled ,-- bit
          AppointmentRemindersDefault = i.AppointmentRemindersDefault ,-- bit
          AppointmentRemindersCCList = i.AppointmentRemindersCCList ,-- varchar(7000)
          EOClaimTypes = i.EOClaimTypes ,-- tinyint
          EOClaimTypeDefaultID = i.EOClaimTypeDefaultID ,-- int
          EOShowAllEncounters = i.EOShowAllEncounters ,-- bit
          EODefaultRevenueCodeID = i.EODefaultRevenueCodeID ,-- int
          CustomNameText = i.CustomNameText ,-- varchar(255)
          WizardComplete = i.WizardComplete ,-- bit
          CurrentWizardStep = i.CurrentWizardStep ,-- varchar(20)
          OnStepExit = i.OnStepExit ,-- varchar(max)
          PreferredPayerSourceID = i.PreferredPayerSourceID ,-- int
          EStatementsBillingSequenceID = i.EStatementsBillingSequenceID ,-- int
          EStatementsBillingDelay = i.EStatementsBillingDelay ,-- int
          PatientPaymentID = i.PatientPaymentID ,-- int
          PhonecallRemindersEnabled = i.PhonecallRemindersEnabled ,-- bit
          EStatementsMaxStatementsSent = i.EStatementsMaxStatementsSent ,-- int
          EOCheckCodesOnApproval = i.EOCheckCodesOnApproval ,-- bit
          ChecklistComplete = i.ChecklistComplete ,-- bit
          EhrDataMigrationStatus = i.EhrDataMigrationStatus ,-- tinyint
          IsLegacyEHRPartner = i.IsLegacyEHRPartner ,-- bit
          EOClaimTypePrintDefaultID = i.EOClaimTypePrintDefaultID  -- EOClaimTypePrintDefaultID ,-- int
FROM [_import_1_2_Practice] i 	
WHERE i.PracticeID = 2
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'

PRINT ''
PRINT 'Updating Service Location...'
UPDATE dbo.ServiceLocation
SET
          Name = i.Name ,-- varchar(128)
          AddressLine1 = i.AddressLine1 ,-- varchar(256)
          AddressLine2 = i.AddressLine2 ,-- varchar(256)
          City = i.City ,-- varchar(128)
          [State] = i.[State] ,-- varchar(2)
          Country = i.Country ,-- varchar(32)
          ZipCode = i.ZipCode ,-- varchar(9)
          PlaceOfServiceCode = i.PlaceOfServiceCode ,-- char(2)
          BillingName = i.BillingName ,-- varchar(128)
          Phone = i.Phone ,-- varchar(10)
          PhoneExt = i.PhoneExt ,-- varchar(10)
          FaxPhone = i.FaxPhone ,-- varchar(10)
          FaxPhoneExt = i.FaxPhoneExt ,-- varchar(10)
          HCFABox32FacilityID = i.HCFABox32FacilityID ,-- varchar(50)
          CLIANumber = i.CLIANumber ,-- varchar(30)
          RevenueCode = i.RevenueCode ,-- varchar(4)
          NPI = i.NPI ,-- varchar(10)
          FacilityIDType = i.FacilityIDType ,-- int
          TimeZoneID = i.TimeZoneID ,-- int
          PayToName = i.PayToName ,-- varchar(60)
          PayToAddressLine1 = i.PayToAddressLine1 ,-- varchar(256)
          PayToAddressLine2 = i.PayToAddressLine2 ,-- varchar(256)
          PayToCity = i.PayToCity ,-- varchar(128)
          PayToState = i.PayToState ,-- varchar(2)
          PayToCountry = i.PayToCountry ,-- varchar(32)
          PayToZipCode = i.PayToZipCode ,-- varchar(9)
          PayToPhone = i.PayToPhone ,-- varchar(10)
          PayToPhoneExt = i.PayToPhoneExt ,-- varchar(10)
          PayToFax = i.PayToFax ,-- varchar(10)
          PayToFaxExt = i.PayToFaxExt ,-- varchar(10)
          EIN = i.EIN ,-- varchar(9)
          BillTypeID = i.BillTypeID  -- BillTypeID ,-- int
FROM dbo.[_import_1_2_ServiceLocation] i
...
SELECT  
          ...
          i.DefaultEncounterTemplateID , -- DefaultEncounterTemplateID - int
          i.TaxonomyCode , -- TaxonomyCode - char(10)
          i.DepartmentID , -- DepartmentID - int
          i.VendorID , -- VendorID - varchar(50)
          i.VendorImportID , -- VendorImportID - int
          i.FaxNumber , -- FaxNumber - varchar(10)
          i.FaxNumberExt , -- FaxNumberExt - varchar(10)
          i.OrigReferringPhysicianID , -- OrigReferringPhysicianID - int
          ...
          1  -- ActivateAfterWizard - bit
FROM dbo.[_import_1_2_Doctor] i
WHERE i.[External] = 0 AND ActiveDoctor = 1
...
WHERE d.PracticeID = @SourcePracticeID AND d.ActiveDoctor = 1
...
NOT EXISTS (SELECT * FROM dbo.Doctor d WHERE d.FirstName = i.FirstName AND d.LastName = i.LastName AND d.NPI = i.NPI AND d.[External] = 1 AND d.PracticeID = @TargetPracticeID)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'
...
--FROM dbo.[_import_1_1_CollectionCategory] i 
...
INNER JOIN dbo.Employers oe ON
	e.EmployerName = oe.EmployerName
...
SELECT 		
          i.InsurancePolicyID , -- InsurancePolicyID - int
...
--          i.AppointmentReasonID , -- AppointmentReasonID - int
--          i.PrimaryAppointment , -- PrimaryAppointment - bit
--          GETDATE() , -- ModifiedDate - datetime
--          @TargetPracticeID  -- PracticeID - int
--FROM dbo.[_import_1_1_AppointmentToAppointmentReason] i
--PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
--SELECT DISTINCT
--		  i.AppointmentID , -- AppointmentID - int
--          i.AppointmentToResourceID , -- AppointmentResourceTypeID - int
...
PRINT ''
PRINT 'Inserting Into Practice Resource - 1 record'
INSERT INTO dbo.PracticeResource
        ( PracticeResourceTypeID ,
          PracticeID ,
          ResourceName ,
...
VALUES  ( 3 , -- PracticeResourceTypeID - int
          @TargetPracticeID , -- PracticeID - int
          'WILLARD MAUGHAN' , -- ResourceName - varchar(50)
          GETDATE() , -- ModifiedDate - datetime
          GETDATE()  -- CreatedDate - datetime
        )
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
SELECT DISTINCT
	      a.AppointmentID , -- AppointmentID - int
          CASE WHEN d.DoctorID IS NULL THEN 2 ELSE 1 END , -- AppointmentResourceTypeID - int
          CASE WHEN d.DoctorID IS NULL THEN (SELECT PracticeResourceID FROM dbo.PracticeResource WHERE ResourceName = 'WILLARD MAUGHAN') ELSE d.DoctorID END , -- ResourceID - int
          GETDATE() , -- ModifiedDate - datetime
          @TargetPracticeID  -- PracticeID - int
FROM dbo.[_import_1_1_AppointmentToResource] i
	INNER JOIN dbo.Appointment a ON
...
INNER JOIN dbo.[_import_1_1_Appointment] i ON
	i.AppointmentID = a.AppointmentID AND
    a.PracticeID = @TargetPracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated...'
