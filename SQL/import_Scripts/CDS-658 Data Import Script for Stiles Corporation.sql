...
UPDATE dbo.[_import_3_1_PatientDemographics]
	SET insurancecode1 = CASE WHEN LEN(insurancecode1) = 1 THEN '0000' + insurancecode1
							  WHEN LEN(insurancecode1) = 2 THEN '000' + insurancecode1
							  WHEN LEN(insurancecode1) = 3 THEN '00' + insurancecode1
							  WHEN LEN(insurancecode1) = 4 THEN '0' + insurancecode1
						 END
...
WHERE pc.VendorID NOT IN ('10165','10158')
