...
SET @PracticeID = 14
SET @VendorImportID = 19 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_19_14_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_19_14_Patient] pat
...
FROM dbo._import_19_14_PatientNotes pjn
...
LEFT JOIN dbo.[_import_19_14_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_19_14_FeeSchedule] impFS
...
FROM dbo.[_import_19_14_Patient] pa
LEFT JOIN dbo.Patient realP ON	
