...
----SELECT * FROM dbo.ContractsAndFees_ContractRate WHERE =11 
...
SELECT 
    100450,    -- ContractRateScheduleID - int
...
cr.ContractRateScheduleID=100118
...
SELECT 
    100451,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100119
...
SELECT 
    100452,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100120
...
SELECT 
    100453,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100121
...
SELECT 
    100454,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100122
...
SELECT 
    100455,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100123
...
SELECT 
    100456,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100124
...
SELECT 
    100457,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100125
...
SELECT 
    100458,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100126
...
SELECT 
    100459,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100127
...
SELECT 
    100460,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100128
...
SELECT 
    100461,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100129
...
SELECT 
    100462,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100130
...
SELECT 
    100463,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100154
...
SELECT 
    100464,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100155
...
SELECT 
    100465,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100156
...
SELECT 
    100466,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100157
...
SELECT 
    100467,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100163
...
SELECT 
    100468,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
SELECT 
    100469,    -- ContractRateScheduleID - int
    cr.ProcedureCodeID,    -- ProcedureCodeID - int
    NULL ,    -- ModifierID - int
    cr.SetFee, -- SetFee - money
    0,     -- AnesthesiaBaseUnits - int
...
ON crs.ContractRateScheduleID = cr.ContractRateScheduleID
WHERE crs.PracticeID=11 AND 
cr.ContractRateScheduleID=100246
