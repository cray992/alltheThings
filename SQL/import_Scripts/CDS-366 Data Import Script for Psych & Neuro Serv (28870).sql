USE superbill_28870_dev
--USE superbill_28870_prod
GO
...
PRINT 'Inserting into Appointment...'
      ...
      SELECT DISTINCT
                    ...
                    impApp.name + ' - ' + impApp.provider , -- Subject - varchar(64)
...
PRINT 'Inserting into Appointment To Resource...'
      ...
      INNER JOIN dbo.Appointment AS realapp ON
            ...
            realapp.[StartDate] = impApp.[startdate] AND
			realapp.[Subject] = impApp.name + ' - ' + impApp.provider 
      INNER JOIN dbo._import_1_1_Providers AS impPro ON
            impPro.[code] = impApp.[provider]
      INNER JOIN dbo.Doctor AS realdoc ON
            realdoc.[FirstName] = impPro.[firstname] AND
