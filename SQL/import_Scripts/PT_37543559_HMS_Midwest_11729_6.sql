...
SET @PracticeID = 6
SET @VendorImportID = 31 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_31_6_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_31_6_Patient] pat
...
FROM dbo._import_31_6_PatientNotes pjn
...
LEFT JOIN dbo.[_import_31_6_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_31_6_FeeSchedule] impFS
...
FROM dbo.[_import_31_6_Patient] pa
LEFT JOIN dbo.Patient realP ON	
