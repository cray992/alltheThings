...
SET @PracticeID = 4
SET @VendorImportID = 30 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_30_4_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_30_4_Patient] pat
...
FROM dbo._import_30_4_PatientNotes pjn
...
LEFT JOIN dbo.[_import_30_4_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_30_4_FeeSchedule] impFS
...
FROM dbo.[_import_30_4_Patient] pa
LEFT JOIN dbo.Patient realP ON	
