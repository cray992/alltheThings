...
PRINT 'Inserting into Insurance Company...'
      ...
      FROM dbo._import_51_37_Insurances
...
PRINT 'Inserting into Insurance Company Plan...'
      ...
      SELECT DISTINCT
                    ...
                    @VendorImportID  -- VendorImportID - int
      FROM dbo._import_51_37_Insurances AS impIns
...
PRINT 'Inserting into Referring Doctor...'
      ...
      SELECT DISTINCT
                    ...
                    1  -- External - bit
      FROM dbo._import_51_37_ReferringPhys AS impRph
...
PRINT 'Inserting into Patient...'
      ...
      FROM dbo._import_51_37_PatientData AS impPat
      LEFT OUTER JOIN dbo._import_51_37_Providers AS impPro ON
...
FROM dbo.[_import_51_37_CaseInformation] AS impCas
...
INSERT INTO dbo.InsurancePolicy
      ...
      INNER JOIN 
            ...
            FROM dbo._import_51_37_PatientData) AS holder ON
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_51_37_StandardFeeSchedule AS Impsfs
...
PRINT 'Inserting into Appointment...'
      ...
      FROM dbo.[_import_51_37_Appointment] AS impApp
	  ...
	  INNER JOIN dbo._import_51_37_Providers AS impPro ON
...
PRINT 'Inserting into Patient Case for Balance Forward...'
      ...
      INNER JOIN dbo._import_51_37_PatientData AS impPat ON
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      FROM dbo._import_51_37_PatientData impPat
      ...
      LEFT JOIN dbo._import_51_37_Providers AS impPro ON
               impPro.code = impPat.assignedprovider
...
INNER JOIN dbo.[_import_51_37_CaseInformation] impCas ON
	impCas.chartnumber = pat.VendorID
INNER JOIN dbo.[_import_51_37_PatientData] impPat ON
...
impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_51_37_CaseInformation] WHERE
...
--	impPat.chartnumber = impCas.guarantor
--WHERE impCas.chartnumber <> '' AND pat.PracticeID = @PracticeID AND pat.VendorImportID = @VendorImportID AND 
--impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_51_37_CaseInformation] WHERE impCas.studentstatus <> '' AND impCas.employmentstatus = '' ORDER BY impCas.chartnumber DESC)
--PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'
--0 Records Updated
