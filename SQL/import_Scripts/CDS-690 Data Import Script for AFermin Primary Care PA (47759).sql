--USE superbill_47759_dev
USE superbill_47759_prod
GO
...
SELECT COUNT(*) AS [Existing Renderring Doctors To Be Updated] FROM dbo._import_1_1_Doctor d 
...
SELECT COUNT(*) AS [Existing Referring Doctors To Be Updated] FROM dbo._import_1_1_Doctor d 
INNER JOIN #tempdocqa i ON d.FirstName = i.firstname AND d.LastName = i.lastname AND d.NPI = i.npi
...
--SELECT COUNT(*) AS [Existing Insurance Company Records to be Updated with ReviewCode] FROM dbo._import_1_1_InsuranceCompany ic
--INNER JOIN dbo._import_1_1_InsuranceCompanyPlan icp ON ic.InsuranceCompanyID = icp.InsuranceCompanyID 
--INNER JOIN dbo._import_1_1_InsurancePolicy ip ON ip.PracticeID = @SourcePracticeID AND icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID
