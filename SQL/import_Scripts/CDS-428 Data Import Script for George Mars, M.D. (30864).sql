...
PRINT 'Inserting Into Patient Case...'
	...
	LEFT JOIN dbo._import_2_1_CaseInformation AS impCas ON
		realP.VendorID = impCas.ChartNumber
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 1...'
	--PatientCaseDate
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 2...'
	--PatientCaseDate
	INSERT INTO dbo.PatientCaseDate
			( PracticeID ,
			  PatientCaseID ,
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 6...'
	--PatientCaseDate
	INSERT INTO dbo.PatientCaseDate
			( PracticeID ,
			  PatientCaseID ,
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 7...'
	--PatientCaseDate
	INSERT INTO dbo.PatientCaseDate
			( PracticeID ,
			  PatientCaseID ,
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 8...'
	--PatientCaseDate
	INSERT INTO dbo.PatientCaseDate
			( PracticeID ,
			  PatientCaseID ,
...
PRINT ''
PRINT 'Inserting Into Patient Case Date 11...'
	--PatientCaseDate
	INSERT INTO dbo.PatientCaseDate
			( PracticeID ,
			  PatientCaseID ,
...
PRINT 'Inserting Into Patient Case for Balance Forward...'
	...
	WHERE realpat.VendorImportID = @VendorImportID AND dbo.fn_RemoveNonNumericCharacters(impPat.patientreferencebalance) > 0
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'

PRINT ''
PRINT 'Creating Miscellaneous Diag Code...'
...
PRINT 'Inserting Into Encounter...'
	...
	LEFT JOIN dbo.Doctor doc ON
		   ...
		   doc.PracticeID = @PracticeID AND
		   doc.[External] = 0
	WHERE dbo.fn_RemoveNonNumericCharacters(impPat.patientreferencebalance) > '0'
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
PRINT 'Inserting Into Encounter Procedure...'
	...
	SELECT   
			  ...
			  GETDATE() , -- ModifiedDate - datetime
			  0 , -- ModifiedUserID - int
			  impPat.patientreferencebalance , -- ServiceChargeAmount - money
