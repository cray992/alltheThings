...
SELECT DISTINCT
	...
	13
FROM dbo._import_1_1_Carrier ic
...
FROM dbo._import_1_1_Carrier impIns
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_1_1_referral ref
WHERE ref.id <> ''
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
FROM dbo._import_1_1_PatientNotes pjn
...
INNER JOIN dbo.[_import_1_1_Policy] i ON 
...
LEFT JOIN dbo.[_import_1_1_Patient] h ON
	p.id = h.id
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
INSERT INTO dbo.ContractsAndFees_StandardFee
	...
	FROM dbo.[_import_1_1_FeeSchedule] impSFS
...
FROM dbo.[_import_1_1_Patient] pa
