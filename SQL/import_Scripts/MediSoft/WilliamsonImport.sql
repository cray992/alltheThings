...
***********************************************************/
set @NewImport = 1;
set @VendorName = 'Williamson'
set @Notes = 'Import :- Patients, PatientCases, Doctors, Ref. Physicians, InsCompanies, Policies'
set  @Format = 'Williamson'
...
/*8
    ...
    create synonym iPatient for impPAT
