...
--
--Clear out old data
   --drop table impPAT_Marks


--need to run an import script here
/*
    Drop Synonym iPatient_Marks
	
    create synonym iPatient_Marks for impPAT_Marks
