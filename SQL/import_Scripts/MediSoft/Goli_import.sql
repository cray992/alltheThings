...
***********************************************************/
set @NewImport = 1;
set @VendorName = 'North Carolina Internal Medicine'
...
--
--Clear out old data
   --drop table impPAT_Goli


--need to run an import script here
/*
    Drop Synonym iPatient_Goli
	
    create synonym iPatient_Goli for impPAT_Goli
