USE superbill_38280_dev
--USE superbill_38280_prod
go
...
FROM dbo.[_import_2_1_Carriers] i
WHERE i.carrieruid <> 1
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_2_1_PatientInfo] i 
...
LEFT JOIN dbo.[_import_2_1_ResponsibleParties] rp ON
...
INNER JOIN dbo.[_import_2_1_NoteTypes] n ON 
