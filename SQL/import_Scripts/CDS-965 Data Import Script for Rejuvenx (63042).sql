...
PRINT ''
PRINT 'Inserting Into Insurance Company Plan [Existing Companies]...'
...
FROM dbo.[_import_1_1_InsuranceCompanyPlan] i
	INNER JOIN dbo.InsuranceCompany ic ON 
		i.PlanName = ic.InsuranceCompanyName AND
...
WHERE i.CreatedPracticeID = @SourcePracticeID AND ic.InsuranceCompanyID IS NULL
PRINT CAST (@@ROWCOUNT AS VARCHAR(10)) + ' records inserted '
