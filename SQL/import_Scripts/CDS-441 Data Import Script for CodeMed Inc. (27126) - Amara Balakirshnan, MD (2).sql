...
PRINT 'Inserting into Insurance Company...'
      ...
      FROM dbo._import_1_2_Insurances
...
PRINT 'Inserting into Insurance Company Plan...'
      ...
      SELECT DISTINCT
                    ...
                    @VendorImportID  -- VendorImportID - int
      FROM dbo._import_1_2_Insurances AS impIns
...
--                    1  -- External - bit
--      FROM dbo._import_1_2_ReferringPhys AS impRph
...
PRINT 'Inserting into Patient...'
      ...
      FROM dbo._import_1_2_PatientData AS impPat
      LEFT OUTER JOIN dbo._import_1_2_Providers AS impPro ON
...
INSERT INTO dbo.InsurancePolicy
      ...
      INNER JOIN 
            ...
            FROM dbo._import_1_2_PatientData) AS holder ON
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_1_2_StandardFeeSchedule AS Impsfs
...
--      FROM dbo.[_import_1_2_Appointment] AS impApp
...
--	  INNER JOIN dbo._import_1_2_Providers AS impPro ON
...
PRINT 'Inserting into Patient Case for Balance Forward...'
      ...
      INNER JOIN dbo._import_1_2_PatientData AS impPat ON
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      FROM dbo._import_1_2_PatientData impPat
...
INNER JOIN dbo.[_import_1_2_CaseInformation] impCas ON
	impCas.chartnumber = pat.VendorID
INNER JOIN dbo.[_import_1_2_PatientData] impPat ON
...
impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_1_2_CaseInformation] WHERE
...
INNER JOIN dbo.[_import_1_2_PatientData] impPat ON
	impPat.chartnumber = impCas.guarantor
WHERE impCas.chartnumber <> '' AND pat.PracticeID = @PracticeID AND pat.VendorImportID = @VendorImportID AND 
impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_1_2_CaseInformation] WHERE impCas.studentstatus <> '' AND impCas.employmentstatus = '' ORDER BY impCas.chartnumber DESC)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'
