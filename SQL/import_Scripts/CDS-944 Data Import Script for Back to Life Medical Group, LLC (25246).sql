...
FROM dbo._import_8_3_InsuranceCOMPANYPLANList ICP 
...
/*
==========================================================================================================================================
CREATE INSURANCE COMPANIES FROM [_import_8_3_InsuranceCOMPANYPLANList]
==========================================================================================================================================
*/	
...
FROM dbo._import_8_3_InsuranceCOMPANYPLANList AS IICL
...
FROM dbo._import_8_3_PatientDemographics AS PD
...
FROM dbo._import_8_3_PatientDemographics pd
...
(	SELECT DISTINCT 
	...
	FROM dbo._import_8_3_PatientDemographics
...
PRINT 'Inserting Into Appointment...'
	...
	FROM dbo._import_8_3_PatientAppointments PA
