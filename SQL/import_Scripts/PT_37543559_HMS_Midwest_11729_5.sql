...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_17_5_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_17_5_Patient] pat
...
FROM dbo._import_17_5_PatientNotes pjn
...
LEFT JOIN dbo.[_import_17_5_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_17_5_FeeSchedule] impFS
...
FROM dbo.[_import_17_5_Patient] pa
LEFT JOIN dbo.Patient realP ON	
