...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_1_1_Insurances]') AND type in (N'U'))
BEGIN
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_1_1_ReferringPhys]') AND type in (N'U'))
BEGIN
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_1_1_PatientData]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Patient...'
      ...
      LEFT OUTER JOIN dbo._import_1_1_Providers AS impPro ON
      ...
      LEFT OUTER JOIN dbo._import_1_1_CaseInformation AS impCas ON
            impCas.[chartnumber] = impPat.[chartnumber]
      LEFT OUTER JOIN dbo._import_1_1_PatientData AS guar ON
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_1_1_CaseInformation]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Patient Case...'
      ...
      FROM dbo.Patient AS realP
		LEFT JOIN dbo.[_import_1_1_CaseInformation] AS impCas ON
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_1_1_StandardFeeSchedule]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_1_1_StandardFeeSchedule AS Impsfs
...
PRINT 'Inserting into Patient Case for Balance Forward...'
      ...
      INNER JOIN dbo._import_1_1_PatientData AS impPat ON
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      FROM dbo._import_1_1_PatientData impPat
      ...
      INNER JOIN dbo._import_1_1_Providers AS impPro ON
               impPro.code = impPat.assignedprovider
