...
SELECT DISTINCT
	...
	,1
	,1
FROM dbo._import_6_13_KABATSIPatientDataPrimary impP
WHERE plastname <> ''
...
SELECT DISTINCT
	...
	,@VendorImportID
FROM 
	dbo.[_import_6_13_KABATSIPatientDataPrimary] impP
...
SELECT DISTINCT
	...
	,@VendorImportID
	,'Y'
FROM dbo.[_import_6_13_KABATSIPatientDataSecondary] impP
INNER JOIN dbo.Patient realP ON 
	realP.VendorImportID = @VendorImportID AND
	realP.VendorID = impP.account
INNER JOIN dbo.PatientCase pc ON 
