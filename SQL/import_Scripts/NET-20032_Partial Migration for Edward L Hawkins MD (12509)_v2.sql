...
------------------------------------
--Update DOB between DBs— FOR Dev Use
...
SELECT DISTINCT
		  ...
		  WHEN 'Patient' THEN 'P'
		  WHEN 'Other' THEN 'O'
		  ELSE '' END  , -- AppointmentType - varchar(1)
          '' , -- Subject - varchar(64)
          i.notes , -- Notes - text
		  ...
		  @VendorImportID
		  --SELECT * 
FROM dbo._import_9_2_AppointmentData1 i 
...
--SELECT * FROM dbo._import_9_2_AppointmentData1
...
SELECT DISTINCT	
    ...
    GETDATE() -- ModifiedDate - datetime
	--SELECT * 
FROM dbo._import_9_2_AppointmentData1 ip
...
FROM dbo._import_9_2_AppointmentData1 a 
...
SELECT DISTINCT 
    ...
    2          -- PracticeID - int
	 ...
	 --SELECT *
FROM dbo._import_9_2_AppointmentData1 imp
	INNER JOIN dbo.Patient p ON 
