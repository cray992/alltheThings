...
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'pat_FirstName'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD pat_FirstName VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'pat_LastName'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD pat_LastName VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'pat_Middle'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD pat_Middle VARCHAR(64) NULL
END 

UPDATE dbo.[_import_3_3_PatientsGuarantorsandInsur]
...
FROM(
	...
	FROM (
		SELECT id, REPLACE(SUBSTRING(patientname,1, CHARINDEX(',', patientname)), ',', '') AS LastName,
					...
					patientname
					FROM dbo.[_import_3_3_PatientsGuarantorsandInsur]
		)ptStart
	)ptFullName
WHERE ptFullName.ID = dbo.[_import_3_3_PatientsGuarantorsandInsur].ID 
...
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured1First'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD insured1First VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured1Last'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD insured1Last VARCHAR(64) NULL
END 
...
WHERE ptFullName.[1insuredname] <> '' AND ptFullName.ID = dbo.[_import_3_3_PatientsGuarantorsandInsur].ID
...
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured2First'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD insured2First VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured2Last'
	AND OBJECT_ID = OBJECT_ID(N'_import_3_3_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_3_3_PatientsGuarantorsandInsur] ADD insured2Last VARCHAR(64) NULL
END 
...
FROM(
	SELECT id, REPLACE(SUBSTRING([2insuredname],1, CHARINDEX(',', [2insuredname])), ',', '') AS LastName,
				...
				[2insuredname]
				FROM dbo.[_import_3_3_PatientsGuarantorsandInsur] WHERE [2insuredname] <> ''
	)ptFullName
WHERE ptFullName.[2insuredname] <> '' AND ptFullName.ID = dbo.[_import_3_3_PatientsGuarantorsandInsur].ID
