...
SET ReviewCode = 'R'
FROM dbo.[_import_2_24_InsurancePolicy] i
...
FROM dbo.Doctor d
INNER JOIN dbo.[_import_2_24_Providers] i ON
...
FROM dbo.[_import_2_24_Providers] i WHERE providertype = 'Referring' 
								 AND NOT EXISTS
...
FROM dbo.[_import_2_24_Patient] i
...
FROM dbo.[_import_2_24_PatientAlert] i
...
FROM dbo.[_import_2_24_PatientJournalNote] AS pjn 
...
FROM dbo.[_import_2_24_PatientCase] as patcase
...
FROM dbo.[_import_2_24_InsurancePolicy] AS iip
