...
UPDATE _import_4_11_doctor SET npi = '1588678601' WHERE doctorid = 3
...
SELECT DISTINCT d.firstname ,d.lastname, d.npi, d.[External] FROM dbo._import_4_11_Doctor d WHERE d.PracticeID = @SourcePracticeID
...
SELECT DISTINCT COUNT(DISTINCT i.insurancecompanyid) AS [Insurance Company Records To Be Inserted] FROM _import_4_11_InsuranceCompany i
INNER JOIN dbo.[_import_4_11_InsuranceCompanyPlan] icp ON i.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_4_11_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT ptic.pk_id) AS [Practice to Insurance Company Records To Be Inserted] FROM _import_4_11_PracticetoInsuranceCompany ptic 
INNER JOIN dbo._import_4_11_InsuranceCompany ic ON ptic.InsuranceCompanyId = ic.InsuranceCompanyID AND ptic.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_4_11_InsuranceCompanyPlan] icp ON ic.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_4_11_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT icp.insurancecompanyplanid) AS [Insurance Company Plan Records To Be Inserted] FROM _import_4_11_InsuranceCompanyPlan icp
INNER JOIN dbo._import_4_11_InsuranceCompany ic ON icp.insurancecompanyid = ic.insurancecompanyid
INNER JOIN dbo.[_import_4_11_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID
...
SELECT COUNT(*) AS [Referring Provider Records To Be Inserted] FROM dbo._import_4_11_Doctor d 
...
SELECT COUNT(*) AS [Patients To Be Inserted] FROM dbo._import_4_11_Patient p WHERE p.PracticeID = @SourcePracticeID 
...
SELECT COUNT(*) AS [Patient Alert Records To Be Inserted] FROM dbo._import_4_11_PatientAlert pa 
INNER JOIN dbo._import_4_11_Patient p ON pa.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
...
SELECT COUNT(*) AS [Patient Journal Records To Be Inserted] FROM dbo._import_4_11_PatientJournalNote pjn
INNER JOIN dbo._import_4_11_Patient p ON pjn.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Records To Be Inserted] FROM dbo._import_4_11_PatientCase pc 
INNER JOIN dbo._import_4_11_Patient p ON pc.PatientID = p.PatientID AND pc.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Date Records To Be Inserted] FROM dbo._import_4_11_PatientCaseDate pcd 
INNER JOIN dbo._import_4_11_PatientCase pc ON pcd.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Records To Be Inserted] FROM dbo._import_4_11_InsurancePolicy ip
INNER JOIN dbo._import_4_11_PatientCase pc ON ip.patientcaseid = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Authorization Records To Be Inserted] FROM dbo._import_4_11_InsurancePolicyAuthorization ipa 
INNER JOIN dbo._import_4_11_InsurancePolicy ip ON ipa.InsurancePolicyID = ip.InsurancePolicyID AND ip.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_PatientCase pc ON ip.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Records To Be Inserted] FROM dbo._import_4_11_Appointment a
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Reason Records To Be Inserted] FROM dbo._import_4_11_AppointmentReason ars
...
SELECT COUNT(*) AS [Practice Resource Records To Be Inserted] FROM dbo._import_4_11_PracticeResource prs 
...
SELECT COUNT(*) AS [Appointment to Appointment Reason Records To Be Inserted] FROM dbo._import_4_11_AppointmentToAppointmentReason atar 
INNER JOIN dbo._import_4_11_Appointment a ON atar.AppointmentID = a.AppointmentID
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment to Resource - Doctor Resource Records To Be Inserted] FROM dbo._import_4_11_AppointmentToResource atr
INNER JOIN dbo._import_4_11_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 1 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment to Resource - Practice Resource Records To Be Inserted] FROM dbo._import_4_11_AppointmentToResource atr
INNER JOIN dbo._import_4_11_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 2 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment Recurrence Records To Be Inserted] FROM dbo._import_4_11_AppointmentRecurrence ar 
INNER JOIN dbo._import_4_11_Appointment a ON ar.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Recurrence Exception Records To Be Inserted] FROM dbo._import_4_11_AppointmentRecurrenceException are 
INNER JOIN dbo._import_4_11_Appointment a ON are.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_4_11_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
...
--FROM dbo.[_import_4_11_Doctor] i WHERE i.PracticeID = @SourcePracticeID AND i.DoctorID = 3 AND
...
SELECT DISTINCT
          ...
          d.npi ,  -- NPI - int
		  d.[External]
FROM dbo._import_4_11_Doctor d 
...
FROM dbo.[_import_4_11_InsuranceCompany] i
	INNER JOIN dbo.[_import_4_11_InsuranceCompanyPlan] icp ON
		i.InsuranceCompanyID = icp.InsuranceCompanyID
	INNER JOIN dbo.[_import_4_11_InsurancePolicy] ip ON
...
FROM dbo.InsuranceCompany ic 
	INNER JOIN dbo.[_import_4_11_InsuranceCompany] i ON
...
SELECT 
          ...
          @VendorImportID 
FROM dbo.[_import_4_11_InsuranceCompanyPlan] i
...
--FROM dbo.[_import_4_11_CollectionCategory] i 
...
--FROM dbo.[_import_4_11_Employers] e 
...
INNER JOIN dbo._import_4_11_ServiceLocation osl ON
...
FROM dbo.[_import_4_11_Patient] p
...
FROM dbo.[_import_4_11_PatientCase] pc
...
FROM dbo.[_import_4_11_InsurancePolicy] ip
...
FROM dbo.[_import_4_11_Appointment] i
	INNER JOIN dbo.Patient p ON
...
SELECT DISTINCT
          ...
          GETDATE()  -- ModifiedDate - datetime
FROM dbo.[_import_4_11_AppointmentReason] i
...
SELECT DISTINCT
	atar.AppointmentID ,
	ar.Name
FROM dbo.[_import_4_11_AppointmentReason] ar
INNER JOIN dbo.[_import_4_11_AppointmentToAppointmentReason] atar ON
	ar.AppointmentReasonID = atar.AppointmentReasonID AND
	ar.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_4_11_Appointment] a ON 
...
SELECT DISTINCT
          ...
          CASE WHEN d.DoctorID IS NULL THEN (SELECT DoctorID FROM dbo.Doctor WHERE FirstName = 'Carol' AND LastName = 'Baker-Belscher' AND [External] = 0 AND PracticeID = @TargetPracticeID)
		  ELSE d.DoctorID END, -- ResourceID - int
          GETDATE() , -- ModifiedDate - datetime
          @TargetPracticeID  -- PracticeID - int
FROM dbo.[_import_4_11_AppointmentToResource] i
	INNER JOIN dbo.Appointment a ON
...
SELECT DISTINCT
          ...
          0 , -- ModifiedUserID - int
          i.StartDate  -- StartDate - datetime
FROM dbo.[_import_4_11_AppointmentRecurrence] i 
INNER JOIN dbo.Appointment a ON
	i.AppointmentID = a.[Subject] AND
	a.PracticeID = @TargetPracticeID 
WHERE a.CreatedDate > DATEADD(mi,-2,GETDATE()) 
...
SELECT DISTINCT
          ...
          i.ModifiedDate , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_4_11_AppointmentRecurrenceException] i
INNER JOIN dbo.Appointment a ON 
	i.AppointmentID = a.[subject] AND
	a.PracticeID = @TargetPracticeID 
WHERE a.CreatedDate > DATEADD(mi,-2,GETDATE())
