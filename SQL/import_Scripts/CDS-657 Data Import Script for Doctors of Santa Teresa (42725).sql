...
FROM dbo._import_2_1_PatientDemographics AS IPD
...
INNER JOIN dbo.[_import_2_1_PatientDemographics] AS m ON
...
LEFT JOIN dbo.[_import_2_1_PatientDemographics] as pd ON 
