USE superbill_40977_dev
--USE superbill_40977_prod
GO
...
FROM #tempPolicies AS TP
	JOIN dbo.Patient AS PAT ON PracticeID = @PracticeID AND VendorID = PatientVendorID
	JOIN dbo.PatientCase AS PC ON TP.PatientVendorID = pc.VendorID AND pc.PracticeID = @PracticeID
