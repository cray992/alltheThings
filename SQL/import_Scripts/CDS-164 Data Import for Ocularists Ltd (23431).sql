...
SELECT DISTINCT
          ...
          imp.starttime , -- StartDate - datetime
          imp.endtime , -- EndDate - datetime
...
FROM dbo.[_import_4_1_Appointment] imp
...
INNER JOIN dbo.DateKeyToPractice dk ON
	...
	dk.Dt = (SELECT Dt FROM dbo.DateKeyToPractice WHERE Dt = DATEADD(d , 0, DATEDIFF(d , 0 , imp.starttime)))
