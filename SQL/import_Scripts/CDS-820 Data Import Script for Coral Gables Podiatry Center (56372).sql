...
PRINT ''
PRINT 'Inserting Into Doctor - REMOVE BEFORE PROD...'
...
FROM dbo.[_import_1_1_Doctor] i WHERE i.DoctorID IN (13,10) AND NOT EXISTS (SELECT * FROM dbo.Doctor d 
WHERE i.FirstName = d.FirstName AND i.LastName = d.LastName AND i.NPI = d.NPI)
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          0 , -- ModifiedUserID - int
          PlaceOfServiceCode , -- PlaceOfServiceCode - char(2)
          BillingName , -- BillingName - varchar(128)
          Phone , -- Phone - varchar(10)
          PhoneExt , -- PhoneExt - varchar(10)
          FaxPhone , -- FaxPhone - varchar(10)
          FaxPhoneExt , -- FaxPhoneExt - varchar(10)
          HCFABox32FacilityID , -- HCFABox32FacilityID - varchar(50)
          CLIANumber , -- CLIANumber - varchar(30)
          RevenueCode , -- RevenueCode - varchar(4)
          @VendorImportID , -- VendorImportID - int
          ServiceLocationID , -- VendorID - int
          NPI , -- NPI - varchar(10)
          FacilityIDType , -- FacilityIDType - int
          TimeZoneID , -- TimeZoneID - int
          PayToName , -- PayToName - varchar(60)
          PayToAddressLine1 , -- PayToAddressLine1 - varchar(256)
          PayToAddressLine2 , -- PayToAddressLine2 - varchar(256)
          PayToCity , -- PayToCity - varchar(128)
          PayToState , -- PayToState - varchar(2)
          PayToCountry , -- PayToCountry - varchar(32)
          PayToZipCode , -- PayToZipCode - varchar(9)
          PayToPhone , -- PayToPhone - varchar(10)
          PayToPhoneExt , -- PayToPhoneExt - varchar(10)
          PayToFax , -- PayToFax - varchar(10)
          PayToFaxExt , -- PayToFaxExt - varchar(10)
          EIN , -- EIN - varchar(9)
          BillTypeID  -- BillTypeID - int
FROM dbo._import_1_1_ServiceLocation i 
WHERE NOT EXISTS (SELECT * FROM dbo.ServiceLocation sl WHERE i.Name = sl.Name AND i.AddressLine1 = sl.AddressLine1)
AND i.PracticeID = @SourcePracticeID
...
CREATE TABLE #tempsl
( id INT , NAME VARCHAR(128) , Address1 VARCHAR(128) , oid INT)

INSERT INTO #tempsl
        ( id, NAME, Address1 , oid)
SELECT DISTINCT
		  sl.ServiceLocationID, -- id - int
          osl.Name,  -- NAME - varchar(128)
		  osl.AddressLine1,
		  osl.ServiceLocationID
