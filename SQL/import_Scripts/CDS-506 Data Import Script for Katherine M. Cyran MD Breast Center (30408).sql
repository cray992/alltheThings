...
--FROM [dbo].[_import_3_1_Insurances] as inc 
--WHERE NOT EXISTS (SELECT * FROM dbo.InsuranceCompanyPlan icp 
--				  INNER JOIN dbo.[_import_3_1_Policy] ip ON
...
SELECT DISTINCT
          ...
          1 ,
          refnpi 
FROM dbo.[_import_3_1_ReferringProvider] i
...
FROM dbo.Patient p
INNER JOIN dbo.[_import_3_1_PatDemo] i ON
...
SELECT DISTINCT
         ...
         'Default Case' , -- Name - varchar(128)
          ...
          @VendorImportID  -- VendorImportID - int
FROM [dbo].[_import_3_1_Policy] as pc
