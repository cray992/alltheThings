...
--rollback
--commit
--SELECT defaultservicelocationid,* FROM patient p WHERE p.PracticeID=23
--SELECT * FROM dbo.Patient p WHERE lastname='ACEVEDO' AND firstname='MICHAEL'ORDER BY lastname, p.FirstName



--SELECT * FROM dbo.PatientCase WHERE patientId IN (10649,33310)

--SELECT * FROM dbo.InsurancePolicy WHERE PatientCaseID IN (33310,10703)

--SELECT * FROM patient p WHERE practiceid=11

--UPDATE dp 
--SET dp.DOB = rp.DOB
--FROM superbill_11269_dev_v2.dbo.patient rp 
--INNER JOIN superbill_11269_dev.dbo.Patient dp
...
--SELECT * 
FROM dbo.[ServiceLocation] i WHERE i.PracticeID = @SourcePracticeID AND
NOT EXISTS (SELECT * FROM dbo.ServiceLocation d WHERE d.name = i.name AND d.PracticeID = @TargetPracticeID)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'

CREATE TABLE #tempsl
( id INT , NAME VARCHAR(128), practiceid int)
...
SELECT DISTINCT
	...
	--SELECT p.DefaultServiceLocationID,* FROM dbo.Patient p WHERE practiceid=23
--rollback
	--SELECT *
FROM dbo.[Patient] p
...
--SELECT p.DefaultServiceLocationID,* FROM dbo.Patient p WHERE p.PracticeID=23
...
--SELECT * FROM dbo.ServiceLocation WHERE PracticeID=23


--SELECT * FROM dbo.ServiceLocation WHERE practiceid IN(11,23)
