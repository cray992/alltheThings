...
FROM dbo.Doctor d
INNER JOIN dbo.[_import_3_25_Providers] i ON
...
FROM dbo.[_import_3_25_Providers] i WHERE providertype = 'Referring' 
								 AND NOT EXISTS
...
FROM dbo.[_import_3_25_Patient] i
...
FROM dbo.[_import_3_25_PatientAlert] i
...
FROM dbo.[_import_3_25_PatientJournalNote] AS pjn 
...
FROM dbo.[_import_3_25_PatientCase] as patcase
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_3_25_PatientCaseDate] i
...
SELECT DISTINCT
          ...
          CASE iip.HolderThroughEmployer WHEN '-1' THEN 1 ELSE iip.holderthroughemployer END , -- HolderThroughEmployer - bit
...
FROM dbo.[_import_3_25_InsurancePolicy] AS iip
...
SELECT DISTINCT
          ...
          @VendorImportID  -- VendorImportID - int
FROM dbo.[_import_3_25_InsurancePolicyAuthorization] i
