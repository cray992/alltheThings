...
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD pat_FirstName VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'pat_LastName'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD pat_LastName VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'pat_Middle'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD pat_Middle VARCHAR(64) NULL
END 

UPDATE dbo.[_import_2_2_PatientsGuarantorsandInsur]
...
FROM(
	...
	FROM (
		SELECT id, REPLACE(SUBSTRING(patientname,1, CHARINDEX(',', patientname)), ',', '') AS LastName,
					...
					patientname
					FROM dbo.[_import_2_2_PatientsGuarantorsandInsur]
		)ptStart
	)ptFullName
WHERE ptFullName.ID = dbo.[_import_2_2_PatientsGuarantorsandInsur].ID 
...
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured1First'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD insured1First VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured1Last'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD insured1Last VARCHAR(64) NULL
END 
...
WHERE ptFullName.[1insuredname] <> '' AND ptFullName.ID = dbo.[_import_2_2_PatientsGuarantorsandInsur].ID
...
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured2First'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD insured2First VARCHAR(64) NULL
END 
IF NOT EXISTS(SELECT * FROM sys.columns  WHERE name = N'insured2Last'
	AND OBJECT_ID = OBJECT_ID(N'_import_1_1_PatientGuarantorsandInsur'))
BEGIN	
	ALTER TABLE [_import_2_2_PatientsGuarantorsandInsur] ADD insured2Last VARCHAR(64) NULL
END 
...
WHERE ptFullName.[2insuredname] <> '' AND ptFullName.ID = dbo.[_import_2_2_PatientsGuarantorsandInsur].ID
