...
--SELECT * FROM dbo.InsuranceCompany where createdpracticeid=13
--SELECT *FROM dbo.InsuranceCompanyPlan WHERE PlanName LIKE 'sedgwick%'

--SELECT * FROM dbo.InsuranceCompany where createdpracticeid=12 and insurancecompanyname like 'Blue%'
--SELECT * FROM dbo._import_10_1_InsuranceCOMPANYPLANList

--SELECT *FROM dbo._import_10_1_PatientDemographics WHERE lastname='jones' AND FirstName='gayneisha'
--SELECT VendorID,* FROM patient WHERE lastname='jones' AND FirstName='gayneisha' AND PracticeID=13
--SELECT * FROM dbo.PatientCase WHERE VendorID ='MDSuite-78;UserNumber-'and practiceid=13
--SELECT * FROM dbo.InsurancePolicy WHERE PolicyNumber='W117230420'
...
--*/
----------------Dup Removal----------------
--UPDATE dbo._import_10_1_InsuranceCOMPANYPLANList
--SET planname='Sedgwick CMS'
--WHERE AutoTempID=20

--UPDATE dbo.InsuranceCompany
--SET VendorImportID= 8
--WHERE VendorImportID IS NULL AND CreatedPracticeID=13
...
FROM dbo._import_10_1_Insurancecompanyplanlist i
...
--SELECT * FROM dbo._import_10_1_PatientDemographics
...
--SELECT CreatedPracticeID,* FROM dbo.InsuranceCompany WHERE CreatedPracticeID IN(12,13)
--SELECT DISTINCT _import_10_1_InsuranceCOMPANYPLANList.insurancecompanyname FROM dbo._import_10_1_InsuranceCOMPANYPLANList
...
FROM dbo._import_10_1_patientDemographics P
WHERE
...
FROM dbo._import_10_1_patientdemographics pa
...
SELECT * FROM dbo._import_10_1_patientDemographics p 
...
FinancialClass
, financialclass, 1, 1
FROM dbo._import_10_1_patientDemographics d
...
FROM dbo._import_10_1_patientDemographics pc
INNER JOIN dbo.Patient p ON
...
FROM dbo._import_10_1_patientDemographics ip
INNER JOIN dbo._import_10_1_Insurancecompanyplanlist icpl ON ip.insurancecode1=icpl.insuranceid
...
WHERE InsurancePolicyID IS NULL
...
FROM dbo._import_10_1_patientDemographics ip
INNER JOIN dbo._import_10_1_Insurancecompanyplanlist icpl ON ip.insurancecode2=icpl.insuranceid
INNER JOIN dbo.PatientCase pc ON ip.chartnumber = pc.VendorID AND pc.VendorImportID = @VendorImportID
INNER JOIN dbo.InsuranceCompanyPlan icp ON icpl.planname = icp.PlanName AND CreatedPracticeID=@TargetPracticeID
...
FROM dbo._import_10_1_ReferringDoctors i WHERE --i.PracticeID = @SourcePracticeID  AND
...
FROM dbo._import_10_1_ServiceLocations i
...
PRINT ''
PRINT 'Inserting Into Fee Schedule...'
...
SELECT 
        ...
        AddPercent ,
        AnesthesiaTimeIncrement
FROM dbo.ContractsAndFees_StandardFeeSchedule
WHERE PracticeID=@SourcePracticeID

DECLARE @StandardFeeScheduleID INT=(SELECT StandardFeeScheduleID FROM dbo.ContractsAndFees_StandardFeeSchedule WHERE PracticeID=@TargetPracticeID)
...
SELECT 
@StandardFeeScheduleID, b.ProcedureCodeDictionaryID,c.ProcedureModifierID, CAST(a.standardfee AS MONEY), 0
FROM dbo._import_10_1_StandardFeeSchedule a
...
LEFT JOIN dbo.ContractsAndFees_StandardFee d ON b.ProcedureCodeDictionaryID=d.ProcedureCodeID AND StandardFeeScheduleID=@StandardFeeScheduleID
