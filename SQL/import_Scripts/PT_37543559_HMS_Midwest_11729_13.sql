...
SET @PracticeID = 13
SET @VendorImportID = 20 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_20_13_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_20_13_Patient] pat
...
FROM dbo._import_20_13_PatientNotes pjn
...
LEFT JOIN dbo.[_import_20_13_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_20_13_FeeSchedule] impFS
...
FROM dbo.[_import_20_13_Patient] pa
LEFT JOIN dbo.Patient realP ON	
