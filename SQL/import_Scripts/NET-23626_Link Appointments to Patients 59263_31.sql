...
SELECT DISTINCT
		  ...
		  @VendorImportID
		  --SELECT distinct i.*
FROM dbo._import_20_31_PatientAppointments i 
...
SELECT DISTINCT	
		  ...
		  1, -- AppointmentResourceTypeID - int
			CASE 
				...
				WHEN i.doctorlastname = 'Ortiz' THEN 2214
...
SELECT DISTINCT	
	...
	@VendorImportID
	--SELECT *
	--SELECT * FROM dbo.AppointmentReason WHERE practiceid = 31
FROM dbo._import_20_31_PatientAppointments ip
...
@VendorImportID
--select * 
FROM _import_20_31_PatientAppointments iapt
