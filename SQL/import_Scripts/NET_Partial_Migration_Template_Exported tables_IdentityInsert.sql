...
--ALTER TABLE dbo._import_3_1_CaseInformation ADD planname VARCHAR(50)
...
SELECT DISTINCT ic.insurancecompanyid,
       ...
       0                               -- IsEnrollable - bit
--select * 
FROM dbo._import_3_1_InsuranceCompany ic
...
--SELECT icp.planname,* 
FROM dbo._import_3_1_CaseInformation ip
    INNER JOIN _import_3_1_InsuranceCompanyPlan icp
...
SELECT DISTINCT 
       ...
       @VendorImportID        -- VendorImportID - int
--select * 
FROM dbo._import_3_1_InsuranceCompanyPlan icp
...
--select ci.* 
FROM dbo._import_3_1_CaseInformation ci
...
SELECT 
	...
	--SELECT * 
FROM dbo._import_3_1_inspolicytable ip
