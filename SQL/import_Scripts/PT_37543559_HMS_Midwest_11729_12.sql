...
SET @PracticeID = 12
SET @VendorImportID = 21 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_21_12_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_21_12_Patient] pat
...
FROM dbo._import_21_12_PatientNotes pjn
...
LEFT JOIN dbo.[_import_21_12_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_21_12_FeeSchedule] impFS
...
FROM dbo.[_import_21_12_Patient] pa
LEFT JOIN dbo.Patient realP ON	
