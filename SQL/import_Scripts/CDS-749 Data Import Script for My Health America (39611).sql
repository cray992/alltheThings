--USE superbill_39611_dev
USE superbill_39611_prod
GO
...
SELECT DISTINCT
	...
	1, -- External - bit
	'' -- NPI - varchar(10)
FROM dbo._import_1_1_PatientDemographicsNew AS PD
...
FROM dbo._import_1_1_PatientDemographicsNew pd
...
SELECT DISTINCT
	...
	GETDATE() , -- ModifiedDate - datetime
	0  -- ModifiedUserID - int
FROM dbo._import_1_1_PatientDemographicsNew AS IPD
...
(	SELECT DISTINCT 
	...
	FROM dbo._import_1_1_PatientDemographicsNew
