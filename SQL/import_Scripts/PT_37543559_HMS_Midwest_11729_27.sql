...
SET @PracticeID = 27
SET @VendorImportID = 23 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_23_27_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_23_27_Patient] pat
...
FROM dbo._import_23_27_PatientNotes pjn
...
LEFT JOIN dbo.[_import_23_27_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_23_27_FeeSchedule] impFS
...
FROM dbo.[_import_23_27_Patient] pa
LEFT JOIN dbo.Patient realP ON	
