...
SELECT DISTINCT d.firstname ,d.lastname, d.npi, d.[External] FROM dbo._import_2_32_Doctor d WHERE d.PracticeID = @SourcePracticeID
...
SELECT DISTINCT COUNT(DISTINCT i.insurancecompanyid) AS [Insurance Company Records To Be Inserted] FROM _import_2_32_InsuranceCompany i
INNER JOIN dbo.[_import_2_32_InsuranceCompanyPlan] icp ON i.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_2_32_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT ptic.pk_id) AS [Practice to Insurance Company Records To Be Inserted] FROM _import_2_32_PracticetoInsuranceCompany ptic 
INNER JOIN dbo._import_2_32_InsuranceCompany ic ON ptic.InsuranceCompanyId = ic.InsuranceCompanyID AND ptic.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_2_32_InsuranceCompanyPlan] icp ON ic.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_2_32_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT icp.insurancecompanyplanid) AS [Insurance Company Plan Records To Be Inserted] FROM _import_2_32_InsuranceCompanyPlan icp
INNER JOIN dbo._import_2_32_InsuranceCompany ic ON icp.insurancecompanyid = ic.insurancecompanyid
INNER JOIN dbo.[_import_2_32_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID
...
SELECT COUNT(*) AS [Referring Provider Records To Be Inserted] FROM dbo._import_2_32_Doctor d 
...
SELECT COUNT(*) AS [Patients To Be Inserted] FROM dbo._import_2_32_Patient p WHERE p.PracticeID = @SourcePracticeID 
...
SELECT COUNT(*) AS [Patient Alert Records To Be Inserted] FROM dbo._import_2_32_PatientAlert pa 
INNER JOIN dbo._import_2_32_Patient p ON pa.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
...
SELECT COUNT(*) AS [Patient Journal Records To Be Inserted] FROM dbo._import_2_32_PatientJournalNote pjn
INNER JOIN dbo._import_2_32_Patient p ON pjn.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Records To Be Inserted] FROM dbo._import_2_32_PatientCase pc 
INNER JOIN dbo._import_2_32_Patient p ON pc.PatientID = p.PatientID AND pc.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Date Records To Be Inserted] FROM dbo._import_2_32_PatientCaseDate pcd 
INNER JOIN dbo._import_2_32_PatientCase pc ON pcd.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Records To Be Inserted] FROM dbo._import_2_32_InsurancePolicy ip
INNER JOIN dbo._import_2_32_PatientCase pc ON ip.patientcaseid = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Authorization Records To Be Inserted] FROM dbo._import_2_32_InsurancePolicyAuthorization ipa 
INNER JOIN dbo._import_2_32_InsurancePolicy ip ON ipa.InsurancePolicyID = ip.InsurancePolicyID AND ip.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_PatientCase pc ON ip.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Records To Be Inserted] FROM dbo._import_2_32_Appointment a
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Reason Records To Be Inserted] FROM dbo._import_2_32_AppointmentReason ars
...
SELECT COUNT(*) AS [Practice Resource Records To Be Inserted] FROM dbo._import_2_32_PracticeResource prs 
...
SELECT COUNT(*) AS [Appointment to Appointment Reason Records To Be Inserted] FROM dbo._import_2_32_AppointmentToAppointmentReason atar 
INNER JOIN dbo._import_2_32_Appointment a ON atar.AppointmentID = a.AppointmentID
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment to Resource - Doctor Resource Records To Be Inserted] FROM dbo._import_2_32_AppointmentToResource atr
INNER JOIN dbo._import_2_32_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 1 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment to Resource - Practice Resource Records To Be Inserted] FROM dbo._import_2_32_AppointmentToResource atr
INNER JOIN dbo._import_2_32_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 2 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment Recurrence Records To Be Inserted] FROM dbo._import_2_32_AppointmentRecurrence ar 
INNER JOIN dbo._import_2_32_Appointment a ON ar.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Recurrence Exception Records To Be Inserted] FROM dbo._import_2_32_AppointmentRecurrenceException are 
INNER JOIN dbo._import_2_32_Appointment a ON are.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_2_32_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
...
--			 i.ssn  -- SSN - varchar(9)
--FROM dbo.Patient p 
--INNER JOIN dbo.[_import_2_32_TargetPatientDemographics] i ON p.PatientID = i.id
...
--		ResponsibleZipCode = p.guarantorzip
--FROM _import_2_32_Patient i 
--INNER JOIN dbo._import_2_32_PatientDemographics p ON
--	p.id = i.patientid
...
FROM dbo.[_import_2_32_InsuranceCompany] i
	INNER JOIN dbo.[_import_2_32_InsuranceCompanyPlan] icp ON
		i.InsuranceCompanyID = icp.InsuranceCompanyID
	INNER JOIN dbo.[_import_2_32_InsurancePolicy] ip ON
...
UPDATE dbo.InsuranceCompany
	SET Notes = i.Notes
FROM dbo.InsuranceCompany ic 
	INNER JOIN dbo.[_import_2_32_InsuranceCompany] i ON
...
FROM dbo.[_import_2_32_PracticeToInsuranceCompany] ptic
...
SELECT 
          ...
          @VendorImportID 
FROM dbo.[_import_2_32_InsuranceCompanyPlan] i
	INNER JOIN dbo.InsuranceCompany ic ON 
		i.insurancecompanyid = ic.VendorID AND
		ic.VendorImportID = @VendorImportID
WHERE i.InsuranceCompanyPlanID IN (SELECT InsuranceCompanyPlanID FROM dbo._import_2_32_InsurancePolicy WHERE PracticeID = @SourcePracticeID)
PRINT CAST (@@ROWCOUNT AS VARCHAR(10)) + ' records inserted '
...
FROM dbo.[_import_2_32_Doctor] i WHERE i.PracticeID = @SourcePracticeID AND i.[External] = 1 AND
...
FROM dbo.[_import_2_32_CollectionCategory] i 
WHERE NOT EXISTS (SELECT * FROM dbo.CollectionCategory cc WHERE i.CollectionCategoryName = cc.CollectionCategoryName)
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_2_32_Employers] i
	INNER JOIN dbo.[_import_2_32_Patient] p ON
...
FROM dbo.[_import_2_32_Employers] e 
...
INNER JOIN dbo._import_2_32_ServiceLocation osl ON
...
CREATE TABLE #colcat (PatientID INT , CollectionCategoryName VARCHAR(200))
INSERT INTO #colcat
        ( PatientID ,
          CollectionCategoryName
        )
SELECT    i.PatientID , -- PatientID - int
          cc.CollectionCategoryName  -- CollectionCategoryName - varchar(200)
FROM dbo._import_2_32_Patient i 
INNER JOIN dbo._import_2_32_CollectionCategory cc ON 
	i.CollectionCategoryID = cc.CollectionCategoryID
...
SELECT DISTINCT
          ...
          @VendorImportID , -- VendorImportID - int
          rcc.CollectionCategoryID , -- CollectionCategoryID - int
          p.active , -- Active - bit
...
FROM dbo.[_import_2_32_Patient] p
...
LEFT JOIN #colcat cc ON 
	p.PatientID = cc.PatientID
LEFT JOIN dbo.CollectionCategory rcc ON
	cc.CollectionCategoryName = rcc.CollectionCategoryName
...
FROM dbo.[_import_2_32_PatientAlert] pa
INNER JOIN dbo.Patient p ON 
...
SELECT DISTINCT
          ...
          pjn.NoteTypeCode ,
          pjn.lastnote 
FROM dbo.[_import_2_32_PatientJournalNote] pjn
	INNER JOIN dbo.Patient p ON
...
FROM dbo.[_import_2_32_PatientCase] pc
	INNER JOIN dbo.Patient p ON 
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_2_32_PatientCaseDate] i
...
SELECT    
          ...
          ip.PolicyNumber ,
          ip.GroupNumber ,
          CASE WHEN ISDATE(CAST(ip.PolicyStartDate AS DATETIME)) = 1 THEN ip.policystartdate ELSE NULL END ,
          CASE WHEN ISDATE(CAST(ip.PolicyEndDate AS DATETIME)) = 1 THEN ip.policyenddate ELSE NULL END ,
          ip.CardOnFile ,
...
FROM dbo.[_import_2_32_InsurancePolicy] ip
	INNER JOIN dbo.PatientCase pc ON 
...
SELECT 		
          ...
          @VendorImportID  -- VendorImportID - int
FROM dbo.[_import_2_32_InsurancePolicyAuthorization] i
INNER JOIN dbo.InsurancePolicy ip ON
...
FROM dbo.[_import_2_32_Appointment] i
	INNER JOIN dbo.Patient p ON
	...
	INNER JOIN dbo._import_2_32_AppointmentToResource atr ON 
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          GETDATE()  -- CreatedDate - datetime
FROM dbo.[_import_2_32_PracticeResource] i
...
SELECT DISTINCT
          ...
          GETDATE()  -- ModifiedDate - datetime
FROM dbo.[_import_2_32_AppointmentReason] i
...
SELECT DISTINCT
	atar.AppointmentID ,
	ar.Name
FROM dbo.[_import_2_32_AppointmentReason] ar
INNER JOIN dbo.[_import_2_32_AppointmentToAppointmentReason] atar ON
	ar.AppointmentReasonID = atar.AppointmentReasonID AND
	ar.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_2_32_Appointment] a ON 
...
SELECT DISTINCT
	atr.AppointmentID ,
	pr.ResourceName
FROM dbo.[_import_2_32_AppointmentToResource] atr
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          @TargetPracticeID  -- PracticeID - int
FROM dbo.[_import_2_32_AppointmentToResource] i
	INNER JOIN dbo.Appointment a ON
...
DROP TABLE #tempdoc , #tempemp , #tempsl , #apptreason  , #appttopracres , #appttopracresO , #colcat
