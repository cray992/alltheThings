...
SELECT DISTINCT d.firstname ,d.lastname, d.npi, d.[External] FROM dbo._import_66_33_Doctor d WHERE d.PracticeID = @SourcePracticeID
...
SELECT DISTINCT COUNT(DISTINCT i.insurancecompanyid) AS [Insurance Company Records To Be Inserted] FROM _import_66_33_InsuranceCompany i
INNER JOIN dbo.[_import_66_33_InsuranceCompanyPlan] icp ON i.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_66_33_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT ptic.pk_id) AS [Practice to Insurance Company Records To Be Inserted] FROM _import_66_33_PracticetoInsuranceCompany ptic 
INNER JOIN dbo._import_66_33_InsuranceCompany ic ON ptic.InsuranceCompanyId = ic.InsuranceCompanyID AND ptic.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_66_33_InsuranceCompanyPlan] icp ON ic.InsuranceCompanyID = icp.InsuranceCompanyID
INNER JOIN dbo.[_import_66_33_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID

SELECT COUNT(DISTINCT icp.insurancecompanyplanid) AS [Insurance Company Plan Records To Be Inserted] FROM _import_66_33_InsuranceCompanyPlan icp
INNER JOIN dbo._import_66_33_InsuranceCompany ic ON icp.insurancecompanyid = ic.insurancecompanyid
INNER JOIN dbo.[_import_66_33_InsurancePolicy] ip ON icp.InsuranceCompanyPlanID = ip.InsuranceCompanyPlanID AND ip.PracticeID = @SourcePracticeID
...
SELECT COUNT(*) AS [Referring Provider Records To Be Inserted] FROM dbo._import_66_33_Doctor d 
...
SELECT COUNT(*) AS [Patients To Be Inserted] FROM dbo._import_66_33_Patient p WHERE p.PracticeID = @SourcePracticeID 
...
SELECT COUNT(*) AS [Patient Alert Records To Be Inserted] FROM dbo._import_66_33_PatientAlert pa 
INNER JOIN dbo._import_66_33_Patient p ON pa.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
...
--SELECT COUNT(*) AS [Patient Journal Records To Be Inserted] FROM dbo._import_66_33_PatientJournalNote pjn
--INNER JOIN dbo._import_66_33_Patient p ON pjn.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
--WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Records To Be Inserted] FROM dbo._import_66_33_PatientCase pc 
INNER JOIN dbo._import_66_33_Patient p ON pc.PatientID = p.PatientID AND pc.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Patient Case Date Records To Be Inserted] FROM dbo._import_66_33_PatientCaseDate pcd 
INNER JOIN dbo._import_66_33_PatientCase pc ON pcd.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Records To Be Inserted] FROM dbo._import_66_33_InsurancePolicy ip
INNER JOIN dbo._import_66_33_PatientCase pc ON ip.patientcaseid = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Insurance Policy Authorization Records To Be Inserted] FROM dbo._import_66_33_InsurancePolicyAuthorization ipa 
INNER JOIN dbo._import_66_33_InsurancePolicy ip ON ipa.InsurancePolicyID = ip.InsurancePolicyID AND ip.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_PatientCase pc ON ip.PatientCaseID = pc.PatientCaseID AND pc.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON pc.PatientID = p.PatientID AND p.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Records To Be Inserted] FROM dbo._import_66_33_Appointment a
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Reason Records To Be Inserted] FROM dbo._import_66_33_AppointmentReason ars
...
SELECT COUNT(*) AS [Practice Resource Records To Be Inserted] FROM dbo._import_66_33_PracticeResource prs 
...
SELECT COUNT(*) AS [Appointment to Appointment Reason Records To Be Inserted] FROM dbo._import_66_33_AppointmentToAppointmentReason atar 
INNER JOIN dbo._import_66_33_Appointment a ON atar.AppointmentID = a.AppointmentID
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment to Resource - Doctor Resource Records To Be Inserted] FROM dbo._import_66_33_AppointmentToResource atr
INNER JOIN dbo._import_66_33_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 1 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment to Resource - Practice Resource Records To Be Inserted] FROM dbo._import_66_33_AppointmentToResource atr
INNER JOIN dbo._import_66_33_Appointment a ON atr.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
AND atr.AppointmentResourceTypeID = 2 AND atr.PracticeID = @SourcePracticeID

SELECT COUNT(*) AS [Appointment Recurrence Records To Be Inserted] FROM dbo._import_66_33_AppointmentRecurrence ar 
INNER JOIN dbo._import_66_33_Appointment a ON ar.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 

SELECT COUNT(*) AS [Appointment Recurrence Exception Records To Be Inserted] FROM dbo._import_66_33_AppointmentRecurrenceException are 
INNER JOIN dbo._import_66_33_Appointment a ON are.AppointmentID = a.AppointmentID AND a.PracticeID = @SourcePracticeID
INNER JOIN dbo._import_66_33_Patient p ON a.PatientID = p.PatientID AND a.PracticeID = @SourcePracticeID
WHERE NOT EXISTS (SELECT * FROM dbo.Patient pp WHERE pp.FirstName = p.firstname AND pp.LastName = p.lastname AND pp.DOB = p.dob AND pp.PracticeID = @TargetPracticeID) 
...
UPDATE dbo._import_66_33_Patient 
...
FROM _import_66_33_Patient i 
INNER JOIN dbo._import_66_33_KareoPatDemoTMPrimaryCare p ON
	p.id = i.patientid
...
SELECT DISTINCT
          ...
          d.npi ,  -- NPI - int
		  d.[External]
FROM dbo._import_66_33_Doctor d 
...
FROM dbo.[_import_66_33_InsuranceCompany] i
	INNER JOIN dbo.[_import_66_33_InsuranceCompanyPlan] icp ON
		i.InsuranceCompanyID = icp.InsuranceCompanyID
	INNER JOIN dbo.[_import_66_33_InsurancePolicy] ip ON
...
FROM dbo.InsuranceCompany ic 
	INNER JOIN dbo.[_import_66_33_InsuranceCompany] i ON
...
FROM dbo.[_import_66_33_PracticeToInsuranceCompany] ptic
...
SELECT 
          ...
          @VendorImportID 
FROM dbo.[_import_66_33_InsuranceCompanyPlan] i
	INNER JOIN dbo.InsuranceCompany ic ON 
		i.insurancecompanyid = ic.VendorID AND
		ic.VendorImportID = @VendorImportID
WHERE i.InsuranceCompanyPlanID IN (SELECT InsuranceCompanyPlanID FROM dbo._import_66_33_InsurancePolicy WHERE PracticeID = @SourcePracticeID)
PRINT CAST (@@ROWCOUNT AS VARCHAR(10)) + ' records inserted '
...
FROM dbo.[_import_66_33_Doctor] i WHERE i.PracticeID = @SourcePracticeID --AND i.[External] = 1 
AND NOT EXISTS (SELECT * FROM dbo.Doctor d WHERE d.VendorID = i.DoctorID AND d.PracticeID = @TargetPracticeID)
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'

PRINT ''
PRINT 'Inserting Into Doctor from Practice Name: Justin P Quock, MD...'
INSERT INTO dbo.Doctor
        ( PracticeID ,
          Prefix ,
          FirstName ,
...
SELECT 
          ...
          i.GlobalPayToCountry , -- GlobalPayToCountry - varchar(32)
          i.KareoSpecialtyId  -- KareoSpecialtyId - int
FROM dbo.Doctor i WHERE i.PracticeID = 1 AND i.[External] = 1 
AND NOT EXISTS (SELECT * FROM dbo.Doctor d WHERE (d.FirstName = i.FirstName AND d.LastName = i.LastName AND d.NPI = i.NPI AND d.PracticeID = @TargetPracticeID) OR (d.VendorID = CAST(i.DoctorID AS VARCHAR) AND d.PracticeID = @TargetPracticeID))
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'
...
FROM dbo.[_import_66_33_Employers] e 
INNER JOIN dbo.Employers oe ON
	oe.EmployerName = e.EmployerName

UPDATE dbo._import_66_33_ServiceLocation
	SET Name = 'Ming Li Tsang, MD' ,
		AddressLine1 = '909 Hyde Street'
WHERE ServiceLocationID = 329 AND PracticeID = @TargetPracticeID
...
FROM dbo._import_66_33_ServiceLocation i
...
SELECT DISTINCT
		  ...
		  Osl.Name ,
          osl.AddressLine1 -- NAME - varchar(128)
FROM dbo.ServiceLocation sl 
INNER JOIN dbo._import_66_33_ServiceLocation osl ON
...
FROM dbo.[_import_66_33_Patient] p
...
FROM dbo.[_import_66_33_PatientAlert] pa
...
SELECT DISTINCT
          ...
          pjn.NoteTypeCode ,
          pjn.lastnote 
FROM dbo.[_import_66_33_PatientJournalNote] pjn
	INNER JOIN dbo.Patient p ON
...
FROM dbo.[_import_66_33_PatientCase] pc
	INNER JOIN dbo.Patient p ON 
...
FROM dbo.[_import_66_33_InsurancePolicy] ip
...
WHERE pc.PracticeID = @TargetPracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
SELECT 		
          ...
          @VendorImportID  -- VendorImportID - int
FROM dbo.[_import_66_33_InsurancePolicyAuthorization] i
...
FROM dbo.[_import_66_33_Appointment] i
	INNER JOIN dbo.Patient p ON
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          GETDATE()  -- CreatedDate - datetime
FROM dbo.[_import_66_33_PracticeResource] i
...
SELECT DISTINCT
          ...
          GETDATE()  -- ModifiedDate - datetime
FROM dbo.[_import_66_33_AppointmentReason] i
...
SELECT DISTINCT
	atar.AppointmentID ,
	ar.Name
FROM dbo.[_import_66_33_AppointmentReason] ar
INNER JOIN dbo.[_import_66_33_AppointmentToAppointmentReason] atar ON
	ar.AppointmentReasonID = atar.AppointmentReasonID AND
	ar.PracticeID = @SourcePracticeID
INNER JOIN dbo.[_import_66_33_Appointment] a ON 
...
SELECT DISTINCT
          ...
          GETDATE() , -- ModifiedDate - datetime
          @TargetPracticeID  -- PracticeID - int
FROM dbo.[_import_66_33_AppointmentToResource] i
	INNER JOIN dbo.Appointment a ON
...
SELECT DISTINCT
          ...
          0 , -- ModifiedUserID - int
          i.StartDate  -- StartDate - datetime
FROM dbo.[_import_66_33_AppointmentRecurrence] i 
INNER JOIN dbo.Appointment a ON
	i.AppointmentID = a.[Subject] AND
	a.PracticeID = @TargetPracticeID 
WHERE a.CreatedDate > DATEADD(mi,-5,GETDATE()) 
...
SELECT DISTINCT
          ...
          i.ModifiedDate , -- ModifiedDate - datetime
          0  -- ModifiedUserID - int
FROM dbo.[_import_66_33_AppointmentRecurrenceException] i
INNER JOIN dbo.Appointment a ON 
	i.AppointmentID = a.[subject] AND
	a.PracticeID = @TargetPracticeID 
WHERE a.CreatedDate > DATEADD(mi,-5,GETDATE())
...
FROM dbo.Appointment a 
	INNER JOIN dbo._import_66_33_Appointment i ON 
		a.[Subject] = i.AppointmentID AND 
		i.AppointmentType = 'O'
