--USE superbill_53204_dev
USE superbill_53204_prod
go
...
WHERE CreatedPracticeID = 1 AND VendorID IS NULL
...
FROM dbo._import_2_2_InsuranceCOMPANYPLANList ICP 
INNER JOIN dbo.InsuranceCompany IC ON 
...
/*
==========================================================================================================================================
CREATE INSURANCE COMPANIES FROM [_import_2_2_InsuranceCOMPANYPLANList]
==========================================================================================================================================
*/	
...
FROM dbo._import_2_2_InsuranceCOMPANYPLANList AS IICL
...
FROM dbo._import_2_2_PatientDemographics AS PD
...
FROM dbo._import_2_2_PatientDemographics pd
