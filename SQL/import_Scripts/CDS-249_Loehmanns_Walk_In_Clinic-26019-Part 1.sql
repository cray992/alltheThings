...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_Insurances]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Insurance Company Plan...'
      ...
      SELECT DISTINCT
                    ...
                    @VendorImportID  -- VendorImportID - int
      FROM dbo._import_4_1_Insurances AS impIns
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_ReferringPhys]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Referring Doctor...'
      ...
      SELECT DISTINCT
                    ...
                    1  -- External - bit
      FROM dbo._import_4_1_ReferringPhys AS impRph
      WHERE impRph.[firstname] <> '' AND impRph.[lastname] <> ''
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
END 

-- Patients (only if table exists)
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_PatientData]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Patient...'
      ...
      LEFT OUTER JOIN dbo._import_4_1_Providers AS impPro ON
      ...
      LEFT OUTER JOIN dbo._import_4_1_CaseInformation AS impCas ON
            impCas.[chartnumber] = impPat.[chartnumber]
      LEFT OUTER JOIN dbo._import_4_1_PatientData AS guar ON
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_CaseInformation]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into PatientCaseDate - First Consulted...'
      ...
      SELECT DISTINCT
                    ...
                    GETDATE() , -- ModifiedDate - datetime
                    0  -- ModifiedUserID - int
      FROM dbo._import_4_1_CaseInformation AS impCas
...
PRINT 'Inserting into Primary Insurance Policy...'
      ...
      INNER JOIN 
            ...
            FROM dbo._import_4_1_PatientData) AS holder ON
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_StandardFeeSchedule]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_4_1_StandardFeeSchedule AS Impsfs
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_import_4_1_Appointments]') AND type in (N'U'))
BEGIN
...
PRINT 'Inserting into Appointment To Resource...'
      ...
      INNER JOIN dbo._import_4_1_Providers AS impPro ON
...
PRINT 'Inserting into Patient Case for Balance Forward...'
      ...
      INNER JOIN dbo._import_4_1_PatientData AS impPat ON
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      FROM dbo._import_4_1_PatientData impPat
