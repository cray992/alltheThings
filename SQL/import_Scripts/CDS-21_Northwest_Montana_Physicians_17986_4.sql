...
FROM dbo.[_import_1_4_VictorHouserPatientDemogra] ic
WHERE ic.insname <> ''
...
FROM dbo.[_import_1_4_VictorHouserPatientDemogra] pat
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' Records Inserted' 
...
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' Records Inserted'
 ...
 SELECT    pc.PatientCaseID , -- PatientCaseID - int
           ...
           @VendorImportID  -- VendorImportID - int
FROM dbo.[_import_1_4_VictorHouserPatientDemogra] ip 
