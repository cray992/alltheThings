...
------------------------------------
--SELECT * FROM dbo.Appointment WHERE practiceid=2 AND StartDate>'1990-01-12 06:30:00.000'
--SELECT * FROM dbo.Patient WHERE LastName='abbott' AND FirstName='hannah'
--UPDATE a SET
...
SELECT DISTINCT
		 -- p.PatientID,
		  ...
		  --SELECT * 
FROM dbo._import_13_2_AppointmentData2 i 
	--INNER JOIN dbo.Patient p ON 
...
--SELECT * FROM dbo._import_12_2_AppointmentData1
...
SELECT DISTINCT	
          ...
          @targetpracticeid  -- PracticeID - int
	--SELECT * 
FROM dbo._import_12_2_AppointmentData1 i
...
SELECT DISTINCT	
    ...
    GETDATE() -- ModifiedDate - datetime
	--SELECT * 
FROM dbo._import_12_2_AppointmentData1 ip
...
--FROM dbo._import_12_2_AppointmentData1 a 
...
SELECT DISTINCT 
    ...
    2          -- PracticeID - int
	 ...
	 --SELECT *
FROM dbo._import_12_2_AppointmentData1 imp
	INNER JOIN dbo.Patient p ON 
