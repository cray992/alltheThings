USE superbill_25687_dev
--USE superbill_25687_prod
go
...
PRINT 'Inserting into Patient Case...'
      ...
      FROM dbo.Patient AS realP
		LEFT JOIN dbo.[_import_2_1_CaseInformation] AS impCas ON
...
PRINT 'Inserting into Appointment To Resource...'
      ...
      INNER JOIN dbo.Appointment AS realapp ON
            ...
            realapp.[StartDate] = DATEADD(hh , - 3, impApp.[startdate])
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      LEFT JOIN dbo._import_2_1_Providers AS impPro ON
               impPro.code = impPat.assignedprovider
