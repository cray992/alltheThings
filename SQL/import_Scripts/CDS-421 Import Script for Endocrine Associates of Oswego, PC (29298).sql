...
--SELECT DISTINCT insuredplanname1 FROM dbo.[_import_2_1_PatDemoIns] pd WHERE NOT EXISTS (SELECT * FROM dbo.[_import_2_1_InsuranceList] il
--WHERE il.payorname = pd.insuredplanname1)
...
SELECT  DISTINCT
     ...
     --   '' , -- Notes - text
      ...
      /*  '' , -- ContactFirstName - varchar(64)
          ...
          CASE WHEN LEN(phonenumber) > 10 THEN LEFT(SUBSTRING(phonenumber,11,LEN(phonenumber)),10) ELSE NULL END , -- PhoneExt - varchar(10)
       /* '' , -- Fax - varchar(10)
          '' , -- FaxExt - varchar(10) */
