USE superbill_29786_dev
--USE superbill_29786_prod
go
...
SELECT DISTINCT
         ...
         -- p.EmployerID , -- EmployerID - int
          ...
          CASE WHEN p.primarycarephysicianid <> '' THEN 1 ELSE NULL END , -- PrimaryCarePhysicianID - int
...
FROM dbo.[_import_1_1_Patient] p WHERE p.primaryproviderid = 1
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
SET IDENTITY_INSERT dbo.Patient OFF
--SELECT COUNT(*) FROM dbo.[_import_1_1_Patient] WHERE primaryproviderid = 1
...
SELECT DISTINCT
		  ...
		  LEFT(pjn.CreatedDate, CHARINDEX('.' , pjn.CreatedDate) -1) ,
          -50 ,
          GETDATE() ,
          -50 ,
          pjn.PatientID ,
