...
VALUES  ( 
          ...
          '2013-11-01 07:00:00' , -- EffectiveStartDate - datetime
          'F' , -- SourceType - char(1)
          'Import File' , -- SourceFileName - varchar(256)
          21 , -- EClaimsNoResponseTrigger - int
          60 , -- PaperClaimsNoResponseTrigger - int
...
FROM dbo.[_import_1_1_Sheet1] AS imp
