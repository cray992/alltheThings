...
--UPDATE dp 
--SET dp.DOB = rp.DOB
--FROM superbill_62559_restore.dbo.patient rp 
--INNER JOIN superbill_62559_dev.dbo.Patient dp
...
SELECT DISTINCT
		  ...
		  20
		  --SELECT distinct i.*
FROM _import_45_61_PatientAppointments i 
...
SELECT DISTINCT	
		 ...
		 20-- @VendorImportID
	--SELECT i.*
FROM _import_42_61_PatientAppointments i 
	INNER JOIN dbo._import_44_61_PatientDemographics d ON 
		d.chartnumber = i.chartnumber
	INNER JOIN dbo.Patient p ON 
		d.lastname = p.LastName AND 
...
SELECT DISTINCT	
	...
	@VendorImportID
	--SELECT *
FROM _import_42_61_PatientAppointments ip
...
@VendorImportID
--select * 
FROM _import_42_61_PatientAppointments iapt
