...
DELETE FROM dbo.PatientAlert WHERE PracticeID = @PracticeID AND VendorImportID = @VendorImportID
PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Alert records deleted'
*/


--UPDATE dbo.[_import_3_4_Providers]
--SET firstname = 'M. Sharif' , 
--	lastname = 'Badri' , 
--	middleinitial = ''
--WHERE code = 'MSB'
...
PRINT 'Inserting into Insurance Company...'
      ...
      FROM dbo._import_3_4_Insurances
...
PRINT 'Inserting into Insurance Company Plan...'
      ...
      SELECT DISTINCT
                    ...
                    @VendorImportID  -- VendorImportID - int
      FROM dbo._import_3_4_Insurances AS impIns
...
PRINT 'Inserting into Referring Doctor...'
      ...
      SELECT DISTINCT
                    ...
                    1  -- External - bit
      FROM dbo._import_3_4_ReferringPhys AS impRph
...
PRINT 'Inserting into Patient...'
      ...
      FROM dbo._import_3_4_PatientData AS impPat
      LEFT OUTER JOIN dbo._import_3_4_Providers AS impPro ON
...
FROM dbo.[_import_3_4_CaseInformation] AS impCas
...
INSERT INTO dbo.InsurancePolicy
      ...
      INNER JOIN 
            ...
            FROM dbo._import_3_4_PatientData) AS holder ON
...
PRINT 'Inserting into Standard Fee...'
      ...
      FROM dbo._import_3_4_StandardFeeSchedule AS Impsfs
...
--      FROM dbo.[_import_3_4_Appointment] AS impApp
...
--	  INNER JOIN dbo._import_3_4_Providers AS impPro ON
...
PRINT 'Inserting into Patient Case for Balance Forward...'
      ...
      INNER JOIN dbo._import_3_4_PatientData AS impPat ON
...
WHERE Name = 'Balance Forward' AND PracticeID = @PracticeID AND VendorImportID = @VendorImportID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
PRINT 'Inserting into Encounter for Balance Forward...'
      ...
      FROM dbo._import_3_4_PatientData impPat
      ...
      LEFT JOIN dbo._import_3_4_Providers AS impPro ON
               impPro.code = impPat.assignedprovider
...
INNER JOIN dbo.[_import_3_4_CaseInformation] impCas ON
	impCas.chartnumber = pat.VendorID
INNER JOIN dbo.[_import_3_4_PatientData] impPat ON
...
impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_3_4_CaseInformation] WHERE
...
--	impPat.chartnumber = impCas.guarantor
--WHERE impCas.chartnumber <> '' AND pat.PracticeID = @PracticeID AND pat.VendorImportID = @VendorImportID AND 
--impCas.chartnumber = (SELECT TOP 1 impCas.chartnumber FROM dbo.[_import_3_4_CaseInformation] WHERE impCas.studentstatus <> '' AND impCas.employmentstatus = '' ORDER BY impCas.chartnumber DESC)
--PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records updated'

PRINT ''
PRINT 'Creating Self Pay Patient Cases...'
INSERT INTO dbo.PatientCase
        ( PatientID ,
          Name ,
          Active ,
...
LEFT JOIN dbo.PatientCase pc ON
	...
	pc.VendorImportID = @VendorImportID
WHERE pc.PatientID IS NULL AND p.PracticeID = @PracticeID
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
