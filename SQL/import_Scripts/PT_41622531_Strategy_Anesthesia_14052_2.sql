...
SELECT DISTINCT
	...
	,13
FROM dbo.[_import_2_2_PatientsGuarantorsandInsur] ic
WHERE ic.[1payername] <> ''
...
SELECT DISTINCT
	...
	,13
FROM dbo.[_import_2_2_PatientsGuarantorsandInsur] ic
WHERE ic.[2payername] NOT IN (SELECT [1payername] FROM dbo.[_import_2_2_PatientsGuarantorsandInsur]) 
	AND ic.[2payername] <> ''
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
SELECT
          ...
          @VendorImportID , -- VendorImportID - int
          1  -- Active - bit
FROM dbo.[_import_2_2_PatientsGuarantorsandInsur] pat
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
FROM dbo.[_import_2_2_PatientsGuarantorsandInsur] ip
