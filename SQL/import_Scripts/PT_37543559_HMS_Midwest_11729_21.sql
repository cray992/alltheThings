...
SET @PracticeID = 21
SET @VendorImportID = 15 -- Vendor import record created through import tool
...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_15_21_referral ref
...
SELECT DISTINCT
	...
	,1
FROM dbo.[_import_15_21_Patient] pat
...
FROM dbo._import_15_21_PatientNotes pjn
...
LEFT JOIN dbo.[_import_15_21_Patient] pat ON 
...
PRINT 'Inserting records into ContractFeeSchedule (Standard)...'
	...
	SELECT
		...
		,0
		,0
	FROM dbo.[_import_15_21_FeeSchedule] impFS
...
FROM dbo.[_import_15_21_Patient] pa
LEFT JOIN dbo.Patient realP ON	
