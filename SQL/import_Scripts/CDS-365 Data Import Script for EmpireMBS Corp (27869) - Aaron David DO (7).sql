...
DECLARE @PracticeID7 INT
DECLARE @Practice7VendorImportID INT

SET @PracticeID7 = 7
SET @Practice7VendorImportID = 7

PRINT ''
PRINT ''
PRINT 'PracticeID = ' + CAST(@PracticeID7 AS VARCHAR(10))
PRINT 'VendorImportID = ' + CAST(@Practice7VendorImportID AS VARCHAR(10))

--DELETE FROM dbo.InsurancePolicy WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Policy records deleted'
--DELETE FROM dbo.InsuranceCompanyPlan WHERE VendorImportID = @Practice7VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company Plan records deleted'
--DELETE FROM dbo.InsuranceCompany WHERE VendorImportID = @Practice7VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company records deleted'
--DELETE FROM dbo.PatientCaseDate WHERE PatientCaseID IN (SELECT PatientCaseID FROM dbo.PatientCase WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case Date records deleted'
--DELETE FROM dbo.PatientCase WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case records deleted'
--DELETE FROM dbo.PatientAlert WHERE PatientID IN (SELECT PatientID FROM dbo.Patient WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Alert records deleted'
--DELETE FROM dbo.Patient WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient records deleted'
--DELETE FROM dbo.Doctor WHERE PracticeID = @PracticeID7 AND VendorImportID = @Practice7VendorImportID
...
SELECT DISTINCT
		 ...
		 (CASE WHEN i.insurancetelephonerelations = '' THEN '' ELSE 'Phone Relations: ' + i.insurancetelephonerelations END) , -- Notes - text
          ...
          @PracticeID7 , -- CreatedPracticeID - int
          ...
          @Practice7VendorImportID , -- VendorImportID - int
          1 , -- NDCFormat - int
          1 , -- UseFacilityID - bit
          'U' , -- AnesthesiaType - varchar(1)
          18  -- InstitutionalBillingFormID - int
FROM dbo.[_import_7_7_InsuranceMaster] i
...
WHERE VendorImportID = @Practice7VendorImportID 
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
FROM dbo.[_import_7_7_ReferringMaster]
...
FROM dbo.[_import_7_7_AaronDavidDO7]  i
	LEFT JOIN dbo.Doctor rd ON
		i.patientreferringcode = rd.VendorID AND
		rd.VendorImportID = @Practice7VendorImportID
...
FROM dbo.[_import_7_7_AaronDavidDO7] i
	INNER JOIN dbo.Patient p ON
		...
		p.VendorImportID = @Practice7VendorImportID
...
FROM dbo.[_import_7_7_PolicyMaster] i
	INNER JOIN dbo.PatientCase pc ON
		i.policyaccountnumber = pc.VendorID AND
		pc.VendorImportID = @Practice7VendorImportID
	INNER JOIN dbo.InsuranceCompanyPlan icp ON
		i.policyinsurancecode = icp.VendorID AND
		icp.CreatedPracticeID = @PracticeID7
...
UPDATE dbo.PatientCase 
      ...
      WHERE pc.VendorImportID = @Practice7VendorImportID AND
