...
DECLARE @PracticeID6 INT
DECLARE @Practice6VendorImportID INT

SET @PracticeID6 = 6
SET @Practice6VendorImportID = 6

PRINT ''
PRINT ''
PRINT 'PracticeID = ' + CAST(@PracticeID6 AS VARCHAR(10))
PRINT 'VendorImportID = ' + CAST(@Practice6VendorImportID AS VARCHAR(10))

--DELETE FROM dbo.InsurancePolicy WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Policy records deleted'
--DELETE FROM dbo.InsuranceCompanyPlan WHERE VendorImportID = @Practice6VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company Plan records deleted'
--DELETE FROM dbo.InsuranceCompany WHERE VendorImportID = @Practice6VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Insurance Company records deleted'
--DELETE FROM dbo.PatientCaseDate WHERE PatientCaseID IN (SELECT PatientCaseID FROM dbo.PatientCase WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case Date records deleted'
--DELETE FROM dbo.PatientCase WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Case records deleted'
--DELETE FROM dbo.PatientAlert WHERE PatientID IN (SELECT PatientID FROM dbo.Patient WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID)
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient Alert records deleted'
--DELETE FROM dbo.Patient WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID
--PRINT '    ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' Patient records deleted'
--DELETE FROM dbo.Doctor WHERE PracticeID = @PracticeID6 AND VendorImportID = @Practice6VendorImportID
...
SELECT DISTINCT
		 ...
		 (CASE WHEN i.insurancetelephonerelations = '' THEN '' ELSE 'Phone Relations: ' + i.insurancetelephonerelations END) , -- Notes - text
          ...
          @PracticeID6 , -- CreatedPracticeID - int
          ...
          @Practice6VendorImportID , -- VendorImportID - int
          1 , -- NDCFormat - int
          1 , -- UseFacilityID - bit
          'U' , -- AnesthesiaType - varchar(1)
          18  -- InstitutionalBillingFormID - int
FROM dbo.[_import_6_6_InsuranceMaster] i
...
WHERE VendorImportID = @Practice6VendorImportID 
PRINT CAST(@@ROWCOUNT AS VARCHAR) + ' records inserted'
...
FROM dbo.[_import_6_6_ReferringMaster]
...
FROM dbo.[_import_6_6_WomensHealthCareofGardenCi] i
	LEFT JOIN dbo.Doctor rd ON
		i.patientreferringcode = rd.VendorID AND
		rd.VendorImportID = @Practice6VendorImportID
...
FROM dbo.[_import_6_6_WomensHealthCareofGardenCi] i
	INNER JOIN dbo.Patient p ON
		...
		p.VendorImportID = @Practice6VendorImportID
...
FROM dbo.[_import_6_6_PolicyMaster] i
	INNER JOIN dbo.PatientCase pc ON
		i.policyaccountnumber = pc.VendorID AND
		pc.VendorImportID = @Practice6VendorImportID
	INNER JOIN dbo.InsuranceCompanyPlan icp ON
		i.policyinsurancecode = icp.VendorID AND
		icp.CreatedPracticeID = @PracticeID6
...
UPDATE dbo.PatientCase 
      ...
      WHERE pc.VendorImportID = @Practice6VendorImportID AND
