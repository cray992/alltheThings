...
/*
-- sp_rename 'zz_import_Bocare_East', 'zz_import_Bocare_East_20091128'
...
select *
into patient_20091128
from patient

select *
into patientCase_20091128
from patientCase pc



select vendorImportID, practiceID, count(*) from patient group by  vendorImportID, practiceID
...
*/
	...
	from patient where vendorImportID is not null
...
select @practiceID=2, @vendorImportID=6
