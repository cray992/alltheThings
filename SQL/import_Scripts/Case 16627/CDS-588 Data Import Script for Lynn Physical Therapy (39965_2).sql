...
SELECT    @PracticeID , -- PracticeID - int
          ...
          ref.npi ,
          1  -- External - bit
FROM dbo._import_2_2_referral ref
WHERE ref.id <> ''
...
SELECT DISTINCT
	...
	,0
	,pat.cellphone
FROM dbo.[_import_2_2_Patient] pat
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
FROM dbo._import_2_2_PatientNotes pjn
...
INNER JOIN dbo.[_import_2_2_Policy] i ON 
...
LEFT JOIN dbo.[_import_2_2_Patient] h ON
	p.id = h.id
PRINT CAST(@@ROWCOUNT AS VARCHAR(10)) + ' records inserted'
...
INSERT INTO dbo.ContractsAndFees_StandardFee
	...
	FROM dbo.[_import_2_2_FeeSchedule] impSFS
...
FROM dbo.[_import_2_2_Patient] pa
