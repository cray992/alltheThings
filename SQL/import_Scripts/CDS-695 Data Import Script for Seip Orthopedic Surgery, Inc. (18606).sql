...
SET @SourcePracticeID = 26
SET @VendorImportID = 1

SET NOCOUNT ON 

PRINT 'Source PracticeID = ' + CAST(@SourcePracticeID AS VARCHAR(10))
PRINT 'Target PracticeID = ' + CAST(@TargetPracticeID AS VARCHAR(10))
...
--Hard Coding VendorID for DoctorID 634 due to name mismatch between source and target
UPDATE dbo.Doctor SET VendorID = 640 WHERE DoctorID = 634
