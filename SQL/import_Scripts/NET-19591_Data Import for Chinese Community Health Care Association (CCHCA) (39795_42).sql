...
FROM _import_84_44_InsuranceCOMPANYPLANList ICP 
...
FROM dbo._import_84_44_InsuranceCOMPANYPLANList i
INNER JOIN dbo.InsuranceCompany ic ON 
...
SELECT DISTINCT
	...
	insuranceid,  -- VendorID - varchar(50) --FIX
	@VendorImportID -- VendorImportID - int
FROM dbo._import_84_44_InsuranceCOMPANYPLANList ICP 
INNER JOIN dbo.InsuranceCompany IC ON 
...
/*
==========================================================================================================================================
CREATE INSURANCE COMPANIES FROM [_import_84_44_InsuranceCOMPANYPLANList]
==========================================================================================================================================
*/	
...
FROM dbo._import_84_44_InsuranceCOMPANYPLANList AS IICL
...
FROM dbo._import_84_44_ReferringDoctors AS RP 
...
FROM dbo._import_84_44_PatientDemographics AS PD
...
FROM dbo._import_84_44_PatientDemographics pd
...
(	SELECT DISTINCT 
	...
	FROM dbo._import_84_44_PatientDemographics
...
PRINT 'Inserting Into Appointment...'
	...
	FROM dbo._import_84_44_PatientAppointments PA
