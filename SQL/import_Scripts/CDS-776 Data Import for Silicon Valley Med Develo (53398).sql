USE superbill_53398_dev
--USE superbill_53398_prod
GO
...
UPDATE dbo.Doctor 
SET NPI = '1730258229'
WHERE FirstName = 'Richard' AND LastName = 'Ornelas' AND ActiveDoctor = 1 AND [External] = 0
...
LEFT JOIN dbo.PayerScenario ps ON ps.PayerScenarioID = i.PayerScenarioID
...
FROM dbo.[_import_1_1_PatientCaseDate] i
	INNER JOIN dbo.PatientCase pc ON
		i.PatientCaseID = pc.PatientCaseID AND 
