...
PRINT ''
PRINT 'Inserting Into InsuranceCompanyPlan 1 of 3...'
...
FROM dbo._import_76_37_InsuranceCOMPANYPLANList ICP 
...
FROM dbo._import_76_37_InsuranceCOMPANYPLANList i
INNER JOIN dbo.InsuranceCompany ic ON 
...
PRINT ''
PRINT 'Inserting Into Insurance Company 1 of 2...'
...
PRINT ''
PRINT 'Inserting Into InsuranceCompanyPlan 2 of 3...'
INSERT INTO dbo.InsuranceCompanyPlan
( 
	PlanName , AddressLine1 , AddressLine2 , City , State , Country , ZipCode , ContactFirstName , ContactLastName , 
	Phone , PhoneExt , Notes , CreatedDate , CreatedUserID , ModifiedDate , ModifiedUserID , ReviewCode , CreatedPracticeID , 
...
/*
==========================================================================================================================================
CREATE INSURANCE COMPANIES FROM [_import_76_37_InsuranceCOMPANYPLANList]
==========================================================================================================================================
*/	

-- Create the remaining insurance companie records that did not name match on existing records
PRINT ''
PRINT 'Inserting Into InsuranceCompany 2 of 2...'
INSERT INTO dbo.InsuranceCompany
(
...
FROM dbo._import_76_37_InsuranceCOMPANYPLANList AS IICL
...
PRINT ''
PRINT 'Inserting Into InsuranceCompanyPlan 3 of 3...'
INSERT INTO dbo.InsuranceCompanyPlan
( 
	PlanName , AddressLine1 , AddressLine2 , City , State , Country , ZipCode , ContactFirstName , ContactLastName , 
	Phone , PhoneExt , Notes , CreatedDate , CreatedUserID , ModifiedDate , ModifiedUserID , ReviewCode , CreatedPracticeID , 
...
FROM dbo._import_76_37_ReferringDoctors AS RP 
...
FROM dbo._import_76_37_PatientDemographics AS PD
...
FROM dbo._import_76_37_PatientDemographics pd
...
(	SELECT DISTINCT 
	...
	FROM dbo._import_76_37_PatientDemographics
...
PRINT 'Inserting Into Appointment...'
	...
	FROM dbo._import_76_37_PatientAppointments PA
